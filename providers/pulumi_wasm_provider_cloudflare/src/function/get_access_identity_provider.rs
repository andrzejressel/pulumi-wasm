...
use crate::bindings::exports::pulumi::cloudflare::get_access_identity_provider;
...
impl get_access_identity_provider::Guest for Component {
    fn invoke(
        ...
        let request = ResourceInvokeRequest {
            token: "cloudflare:index/getAccessIdentityProvider:getAccessIdentityProvider".into(),
            object: vec![
