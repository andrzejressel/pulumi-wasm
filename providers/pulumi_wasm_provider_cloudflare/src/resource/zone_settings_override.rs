...
impl zone_settings_override::Guest for Component {
    fn invoke(
        name: String,
        args: zone_settings_override::Args
        ...
        let request = RegisterResourceRequest {
            ...
            results: vec![
                ResultField { name: "initialSettings".into() },
                ResultField { name: "initialSettingsReadAt".into() },
                ResultField { name: "readonlySettings".into() },
                ResultField { name: "settings".into() },
                ResultField { name: "zoneId".into() },
                ResultField { name: "zoneStatus".into() },
                ResultField { name: "zoneType".into() },
            ],
        };
