    ...
    fn invoke(name: String, args: web_analytics_rule::Args) -> web_analytics_rule::Res {
        ...
        let request = RegisterResourceRequest {
            ...
            object: vec![
                ...
                ObjectField { name: "inclusive".into(), value: args.inclusive },
                ObjectField { name: "isPaused".into(), value: args.is_paused },
                ObjectField { name: "paths".into(), value: args.paths },
                ObjectField { name: "rulesetId".into(), value: args.ruleset_id },
            ],
            results: vec![
                ResultField { name: "accountId".into() },
                ResultField { name: "host".into() },
                ResultField { name: "inclusive".into() },
                ResultField { name: "isPaused".into() },
                ResultField { name: "paths".into() },
