    ...
    fn invoke(
        ...
        let request = RegisterResourceRequest {
            ...
            object: vec![
                ...
                ObjectField { name: "enabledOriginCommands".into(), value: args.enabled_origin_commands },
            ...
            results: vec![
                ...
                ResultField { name: "enabledOriginCommands".into() },
        ...
        waiting_room::Res {
            ...
            enabled_origin_commands: hashmap.remove("enabledOriginCommands").unwrap(),
