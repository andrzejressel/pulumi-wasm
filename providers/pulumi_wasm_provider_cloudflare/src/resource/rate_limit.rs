    ...
    fn invoke(
        ...
        let request = RegisterResourceRequest {
            ...
            object: vec![
                ...
                ObjectField { name: "bypassUrlPatterns".into(), value: args.bypass_url_patterns },
                ObjectField { name: "correlate".into(), value: args.correlate },
                ObjectField { name: "description".into(), value: args.description },
                ObjectField { name: "disabled".into(), value: args.disabled },
                ObjectField { name: "match".into(), value: args.match_ },
                ObjectField { name: "period".into(), value: args.period },
                ObjectField { name: "threshold".into(), value: args.threshold },
                ObjectField { name: "zoneId".into(), value: args.zone_id },
            ],
            results: vec![
                ResultField { name: "action".into() },
                ResultField { name: "bypassUrlPatterns".into() },
                ResultField { name: "correlate".into() },
                ResultField { name: "description".into() },
                ResultField { name: "disabled".into() },
                ResultField { name: "match".into() },
                ResultField { name: "period".into() },
                ResultField { name: "threshold".into() },
