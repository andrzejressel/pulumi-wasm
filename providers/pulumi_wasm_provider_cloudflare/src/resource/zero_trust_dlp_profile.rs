...
use crate::bindings::exports::pulumi::cloudflare::zero_trust_dlp_profile;
use crate::bindings::component::pulumi_wasm::register_interface::{ObjectField, register, RegisterResourceRequest, ResultField};
use crate::Component;

impl zero_trust_dlp_profile::Guest for Component {
    fn invoke(name: String, args: zero_trust_dlp_profile::Args) -> zero_trust_dlp_profile::Res {
