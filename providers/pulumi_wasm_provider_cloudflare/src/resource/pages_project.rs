    ...
    fn invoke(
        ...
        let request = RegisterResourceRequest {
            ...
            object: vec![
                ...
                ObjectField { name: "buildConfig".into(), value: args.build_config },
                ObjectField { name: "deploymentConfigs".into(), value: args.deployment_configs },
                ObjectField { name: "name".into(), value: args.name },
                ObjectField { name: "productionBranch".into(), value: args.production_branch },
                ObjectField { name: "source".into(), value: args.source },
            ],
            results: vec![
                ResultField { name: "accountId".into() },
                ResultField { name: "buildConfig".into() },
                ResultField { name: "createdOn".into() },
                ResultField { name: "deploymentConfigs".into() },
                ResultField { name: "domains".into() },
                ResultField { name: "name".into() },
                ResultField { name: "productionBranch".into() },
