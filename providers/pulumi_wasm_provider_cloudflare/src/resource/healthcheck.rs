...
impl healthcheck::Guest for Component {
    fn invoke(
        ...
        let request = RegisterResourceRequest {
            ...
            name,
            object: vec![
                ObjectField { name: "address".into(), value: args.address },
                ObjectField { name: "allowInsecure".into(), value: args.allow_insecure },
                ObjectField { name: "checkRegions".into(), value: args.check_regions },
                ObjectField { name: "consecutiveFails".into(), value: args.consecutive_fails },
                ObjectField { name: "consecutiveSuccesses".into(), value: args.consecutive_successes },
            ...
            results: vec![
                ResultField { name: "address".into() },
                ResultField { name: "allowInsecure".into() },
                ResultField { name: "checkRegions".into() },
                ResultField { name: "consecutiveFails".into() },
                ResultField { name: "consecutiveSuccesses".into() },
