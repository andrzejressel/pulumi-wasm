    ...
    fn invoke(
        ...
        let request = RegisterResourceRequest {
            ...
            object: vec![
                ...
                ObjectField { name: "eventEndTime".into(), value: args.event_end_time },
                ObjectField { name: "eventStartTime".into(), value: args.event_start_time },
                ObjectField { name: "name".into(), value: args.name },
                ObjectField { name: "newUsersPerMinute".into(), value: args.new_users_per_minute },
                ObjectField { name: "prequeueStartTime".into(), value: args.prequeue_start_time },
                ...
                ObjectField { name: "shuffleAtEventStart".into(), value: args.shuffle_at_event_start },
            ...
            results: vec![
                ...
                ResultField { name: "eventEndTime".into() },
                ResultField { name: "eventStartTime".into() },
                ResultField { name: "modifiedOn".into() },
                ResultField { name: "name".into() },
                ResultField { name: "newUsersPerMinute".into() },
                ResultField { name: "prequeueStartTime".into() },
                ResultField { name: "queueingMethod".into() },
                ResultField { name: "sessionDuration".into() },
                ResultField { name: "shuffleAtEventStart".into() },
