...
use crate::bindings::exports::pulumi::cloudflare::magic_wan_static_route;
use crate::bindings::component::pulumi_wasm::register_interface::{ObjectField, register, RegisterResourceRequest, ResultField};
use crate::Component;

impl magic_wan_static_route::Guest for Component {
    fn invoke(name: String, args: magic_wan_static_route::Args) -> magic_wan_static_route::Res {
