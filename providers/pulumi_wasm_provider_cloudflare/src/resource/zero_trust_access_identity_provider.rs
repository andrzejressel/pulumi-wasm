...
use crate::bindings::exports::pulumi::cloudflare::zero_trust_access_identity_provider;
use crate::bindings::component::pulumi_wasm::register_interface::{ObjectField, register, RegisterResourceRequest, ResultField};
use crate::Component;

impl zero_trust_access_identity_provider::Guest for Component {
    fn invoke(name: String, args: zero_trust_access_identity_provider::Args) -> zero_trust_access_identity_provider::Res {
        pulumi_wasm_common::setup_logger();
        let request = RegisterResourceRequest {
            type_: "cloudflare:index/zeroTrustAccessIdentityProvider:ZeroTrustAccessIdentityProvider".into(),
            name,
            object: vec![
