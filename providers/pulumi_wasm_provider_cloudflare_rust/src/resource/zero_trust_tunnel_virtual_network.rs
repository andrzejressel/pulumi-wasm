...
pub fn create(
    ...
    let result = crate::bindings::pulumi::cloudflare::zero_trust_tunnel_virtual_network::invoke(
        name,
        &crate::bindings::pulumi::cloudflare::zero_trust_tunnel_virtual_network::Args {
