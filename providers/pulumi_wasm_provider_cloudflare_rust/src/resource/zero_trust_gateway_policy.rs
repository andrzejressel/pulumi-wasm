...
pub struct ZeroTrustGatewayPolicyArgs {
    ...
    #[builder(into, default = ::pulumi_wasm_rust::Output::empty())]
    pub rule_settings: pulumi_wasm_rust::Output<Option<crate::types::ZeroTrustGatewayPolicyRuleSettings>>,
...
pub struct ZeroTrustGatewayPolicyResult {
    ...
    pub precedence: pulumi_wasm_rust::Output<i32>,
    /// Additional rule settings.
    pub rule_settings: pulumi_wasm_rust::Output<crate::types::ZeroTrustGatewayPolicyRuleSettings>,
    /// The wirefilter expression to be used for traffic matching.
