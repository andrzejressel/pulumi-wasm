...
///
pub fn create(name: &str, args: ZeroTrustAccessPolicyArgs) -> ZeroTrustAccessPolicyResult {

    let result = crate::bindings::pulumi::cloudflare::zero_trust_access_policy::invoke(name, &crate::bindings::pulumi::cloudflare::zero_trust_access_policy::Args {
