...
pub fn create(
    ...
    let result = crate::bindings::pulumi::cloudflare::zero_trust_tunnel_cloudflared_config::invoke(
        name,
        &crate::bindings::pulumi::cloudflare::zero_trust_tunnel_cloudflared_config::Args {
