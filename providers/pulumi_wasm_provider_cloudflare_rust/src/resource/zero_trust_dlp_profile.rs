...
pub struct ZeroTrustDlpProfileArgs {
    ...
    pub context_awareness: pulumi_wasm_rust::Output<Option<crate::types::ZeroTrustDlpProfileContextAwareness>>,
    /// Brief summary of the profile and its intended use.
    #[builder(into, default)]
    pub description: pulumi_wasm_rust::Output<Option<String>>,
    /// List of entries to apply to the profile.
    #[builder(into)]
    pub entries: pulumi_wasm_rust::Output<Vec<crate::types::ZeroTrustDlpProfileEntry>>,
...
pub struct ZeroTrustDlpProfileResult {
    ...
    pub allowed_match_count: pulumi_wasm_rust::Output<i32>,
    /// Scan the context of predefined entries to only return matches surrounded by keywords.
    pub context_awareness: pulumi_wasm_rust::Output<crate::types::ZeroTrustDlpProfileContextAwareness>,
    /// Brief summary of the profile and its intended use.
    pub description: pulumi_wasm_rust::Output<Option<String>>,
    /// List of entries to apply to the profile.
    pub entries: pulumi_wasm_rust::Output<Vec<crate::types::ZeroTrustDlpProfileEntry>>,
