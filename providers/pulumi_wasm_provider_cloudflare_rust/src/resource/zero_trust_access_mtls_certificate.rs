...
pub fn create(
    ...
    let result = crate::bindings::pulumi::cloudflare::zero_trust_access_mtls_certificate::invoke(
        name,
        &crate::bindings::pulumi::cloudflare::zero_trust_access_mtls_certificate::Args {
