...
pub struct ZeroTrustAccessPolicyInclude {
    ...
    pub r#auth_contexts: Box<Option<Vec<crate::types::ZeroTrustAccessPolicyIncludeAuthContext>>>,
    ...
    #[builder(into, default = Box::new(None))]
    #[serde(rename = "azures")]
    pub r#azures: Box<Option<Vec<crate::types::ZeroTrustAccessPolicyIncludeAzure>>>,
    ...
    pub r#external_evaluations: Box<Option<Vec<crate::types::ZeroTrustAccessPolicyIncludeExternalEvaluation>>>,
    ...
    pub r#githubs: Box<Option<Vec<crate::types::ZeroTrustAccessPolicyIncludeGithub>>>,
    ...
    pub r#gsuites: Box<Option<Vec<crate::types::ZeroTrustAccessPolicyIncludeGsuite>>>,
    ...
    #[builder(into, default = Box::new(None))]
    #[serde(rename = "oktas")]
    pub r#oktas: Box<Option<Vec<crate::types::ZeroTrustAccessPolicyIncludeOkta>>>,
    /// Matches a SAML group. Requires a SAML identity provider.
    #[builder(into, default = Box::new(None))]
    #[serde(rename = "samls")]
    pub r#samls: Box<Option<Vec<crate::types::ZeroTrustAccessPolicyIncludeSaml>>>,
