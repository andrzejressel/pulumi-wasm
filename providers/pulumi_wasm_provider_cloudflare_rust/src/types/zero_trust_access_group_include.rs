...
pub struct ZeroTrustAccessGroupInclude {
    ...
    pub r#auth_contexts: Box<Option<Vec<crate::types::ZeroTrustAccessGroupIncludeAuthContext>>>,
    ...
    #[builder(into, default)]
    #[serde(rename = "azures")]
    pub r#azures: Box<Option<Vec<crate::types::ZeroTrustAccessGroupIncludeAzure>>>,
    ...
    pub r#external_evaluations: Box<Option<Vec<crate::types::ZeroTrustAccessGroupIncludeExternalEvaluation>>>,
    ...
    pub r#githubs: Box<Option<Vec<crate::types::ZeroTrustAccessGroupIncludeGithub>>>,
    ...
    pub r#gsuites: Box<Option<Vec<crate::types::ZeroTrustAccessGroupIncludeGsuite>>>,
    ...
    #[builder(into, default)]
    #[serde(rename = "oktas")]
    pub r#oktas: Box<Option<Vec<crate::types::ZeroTrustAccessGroupIncludeOkta>>>,
    /// Matches a SAML group. Requires a SAML identity provider.
    #[builder(into, default)]
    #[serde(rename = "samls")]
    pub r#samls: Box<Option<Vec<crate::types::ZeroTrustAccessGroupIncludeSaml>>>,
