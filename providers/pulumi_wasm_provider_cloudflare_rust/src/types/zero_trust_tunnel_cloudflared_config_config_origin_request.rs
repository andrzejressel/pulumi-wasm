...
pub struct ZeroTrustTunnelCloudflaredConfigConfigOriginRequest {
    ...
    #[serde(rename = "access")]
    pub r#access: Box<Option<crate::types::ZeroTrustTunnelCloudflaredConfigConfigOriginRequestAccess>>,
    /// Runs as jump host.
    #[builder(into, default = Box::new(None))]
    ...
    pub r#ip_rules: Box<Option<Vec<crate::types::ZeroTrustTunnelCloudflaredConfigConfigOriginRequestIpRule>>>,
