...
pub struct ZeroTrustAccessApplicationSaasApp {
    ...
    pub r#custom_attributes: Box<Option<Vec<crate::types::ZeroTrustAccessApplicationSaasAppCustomAttribute>>>,
    /// Custom claim mapped from IDPs.
    #[builder(into, default)]
    #[serde(rename = "customClaims")]
    pub r#custom_claims: Box<Option<Vec<crate::types::ZeroTrustAccessApplicationSaasAppCustomClaim>>>,
    ...
    pub r#hybrid_and_implicit_options: Box<Option<crate::types::ZeroTrustAccessApplicationSaasAppHybridAndImplicitOptions>>,
    ...
    pub r#refresh_token_options: Box<Option<Vec<crate::types::ZeroTrustAccessApplicationSaasAppRefreshTokenOption>>>,
