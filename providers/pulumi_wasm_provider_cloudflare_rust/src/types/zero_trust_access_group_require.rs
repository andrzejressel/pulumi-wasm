...
pub struct ZeroTrustAccessGroupRequire {
    ...
    pub r#auth_contexts: Box<Option<Vec<crate::types::ZeroTrustAccessGroupRequireAuthContext>>>,
    ...
    #[builder(into, default)]
    #[serde(rename = "azures")]
    pub r#azures: Box<Option<Vec<crate::types::ZeroTrustAccessGroupRequireAzure>>>,
    ...
    pub r#external_evaluations: Box<Option<Vec<crate::types::ZeroTrustAccessGroupRequireExternalEvaluation>>>,
    ...
    pub r#githubs: Box<Option<Vec<crate::types::ZeroTrustAccessGroupRequireGithub>>>,
    ...
    pub r#gsuites: Box<Option<Vec<crate::types::ZeroTrustAccessGroupRequireGsuite>>>,
    ...
    #[builder(into, default)]
    #[serde(rename = "oktas")]
    pub r#oktas: Box<Option<Vec<crate::types::ZeroTrustAccessGroupRequireOkta>>>,
    /// Matches a SAML group. Requires a SAML identity provider.
    #[builder(into, default)]
    #[serde(rename = "samls")]
    pub r#samls: Box<Option<Vec<crate::types::ZeroTrustAccessGroupRequireSaml>>>,
