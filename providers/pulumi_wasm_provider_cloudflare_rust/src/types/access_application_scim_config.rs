...
pub struct AccessApplicationScimConfig {
    ...
    pub r#authentication: Box<Option<crate::types::AccessApplicationScimConfigAuthentication>>,
    ...
    pub r#mappings: Box<Option<Vec<crate::types::AccessApplicationScimConfigMapping>>>,
