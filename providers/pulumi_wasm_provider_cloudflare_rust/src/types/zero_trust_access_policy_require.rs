...
pub struct ZeroTrustAccessPolicyRequire {
    ...
    pub r#auth_contexts: Box<Option<Vec<crate::types::ZeroTrustAccessPolicyRequireAuthContext>>>,
    ...
    #[builder(into, default = Box::new(None))]
    #[serde(rename = "azures")]
    pub r#azures: Box<Option<Vec<crate::types::ZeroTrustAccessPolicyRequireAzure>>>,
    ...
    pub r#external_evaluations: Box<Option<Vec<crate::types::ZeroTrustAccessPolicyRequireExternalEvaluation>>>,
    ...
    pub r#githubs: Box<Option<Vec<crate::types::ZeroTrustAccessPolicyRequireGithub>>>,
    ...
    pub r#gsuites: Box<Option<Vec<crate::types::ZeroTrustAccessPolicyRequireGsuite>>>,
    ...
    #[builder(into, default = Box::new(None))]
    #[serde(rename = "oktas")]
    pub r#oktas: Box<Option<Vec<crate::types::ZeroTrustAccessPolicyRequireOkta>>>,
    /// Matches a SAML group. Requires a SAML identity provider.
    #[builder(into, default = Box::new(None))]
    #[serde(rename = "samls")]
    pub r#samls: Box<Option<Vec<crate::types::ZeroTrustAccessPolicyRequireSaml>>>,
