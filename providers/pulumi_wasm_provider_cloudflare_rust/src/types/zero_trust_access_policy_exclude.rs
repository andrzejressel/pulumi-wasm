...
pub struct ZeroTrustAccessPolicyExclude {
    ...
    pub r#auth_contexts: Box<Option<Vec<crate::types::ZeroTrustAccessPolicyExcludeAuthContext>>>,
    ...
    #[builder(into, default = Box::new(None))]
    #[serde(rename = "azures")]
    pub r#azures: Box<Option<Vec<crate::types::ZeroTrustAccessPolicyExcludeAzure>>>,
    ...
    pub r#external_evaluations: Box<Option<Vec<crate::types::ZeroTrustAccessPolicyExcludeExternalEvaluation>>>,
    ...
    pub r#githubs: Box<Option<Vec<crate::types::ZeroTrustAccessPolicyExcludeGithub>>>,
    ...
    pub r#gsuites: Box<Option<Vec<crate::types::ZeroTrustAccessPolicyExcludeGsuite>>>,
    ...
    #[builder(into, default = Box::new(None))]
    #[serde(rename = "oktas")]
    pub r#oktas: Box<Option<Vec<crate::types::ZeroTrustAccessPolicyExcludeOkta>>>,
    /// Matches a SAML group. Requires a SAML identity provider.
    #[builder(into, default = Box::new(None))]
    #[serde(rename = "samls")]
    pub r#samls: Box<Option<Vec<crate::types::ZeroTrustAccessPolicyExcludeSaml>>>,
