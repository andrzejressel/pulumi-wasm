...
pub struct ZeroTrustTunnelCloudflaredConfigConfigIngressRuleOriginRequest {
    ...
    #[serde(rename = "access")]
    pub r#access: Box<Option<crate::types::ZeroTrustTunnelCloudflaredConfigConfigIngressRuleOriginRequestAccess>>,
    /// Runs as jump host.
    #[builder(into, default = Box::new(None))]
    ...
    pub r#ip_rules: Box<Option<Vec<crate::types::ZeroTrustTunnelCloudflaredConfigConfigIngressRuleOriginRequestIpRule>>>,
