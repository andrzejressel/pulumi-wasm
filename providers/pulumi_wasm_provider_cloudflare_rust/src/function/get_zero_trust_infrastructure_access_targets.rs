...
pub struct GetZeroTrustInfrastructureAccessTargetsResult {
    ...
    /// A date and time after a target was modified to filter on.
    pub modified_after: pulumi_wasm_rust::Output<Option<String>>,
    pub targets: pulumi_wasm_rust::Output<Vec<crate::types::GetZeroTrustInfrastructureAccessTargetsTarget>>,
    /// The private virtual network identifier for the target.
    pub virtual_network_id: pulumi_wasm_rust::Output<Option<String>>,
}
...
pub fn invoke(
    ...
    let result = crate::bindings::pulumi::cloudflare::get_zero_trust_infrastructure_access_targets::invoke(
        &crate::bindings::pulumi::cloudflare::get_zero_trust_infrastructure_access_targets::Args {
