        ...
        pub mod register_interface {
            ...
            pub fn invoke(request: &ResourceInvokeRequest<'_>) -> ResourceInvokeResult {
                unsafe {
                    ...
                    wit_import(ptr1.cast_mut(), len1, result4, len4, result7, len7, ptr8);
                ...
                output: super::super::super::component::pulumi_wasm::output_interface::Output::from_handle(l14 as u32),
              }
                        };
                        result15.push(e15);
                    }
                    ...
                    ResourceInvokeResult { fields: result15 }
                }
            }
        }
    }
