...
pub struct GetPoolUserAccount {
    ...
    pub r#linux_user_configurations: Box<Vec<super::super::types::batch::GetPoolUserAccountLinuxUserConfiguration>>,
    ...
    pub r#windows_user_configurations: Box<Vec<super::super::types::batch::GetPoolUserAccountWindowsUserConfiguration>>,
}
