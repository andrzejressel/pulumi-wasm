pub mod get_testable_permissions {
    ...
    pub struct GetTestablePermissionsArgs {
        ...
        pub custom_support_level: pulumi_wasm_rust::InputOrOutput<Option<String>>,
        ...
        #[builder(into)]
        pub full_resource_name: pulumi_wasm_rust::InputOrOutput<String>,
        ...
        #[builder(into, default)]
        pub stages: pulumi_wasm_rust::InputOrOutput<Option<Vec<String>>>,
    }
    #[allow(dead_code)]
