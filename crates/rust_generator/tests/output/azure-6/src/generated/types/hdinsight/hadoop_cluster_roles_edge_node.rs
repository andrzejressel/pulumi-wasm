...
pub struct HadoopClusterRolesEdgeNode {
    ...
    pub r#https_endpoints: Box<Option<Vec<super::super::types::hdinsight::HadoopClusterRolesEdgeNodeHttpsEndpoint>>>,
    /// A `install_script_action` block as defined below.
    #[builder(into)]
    #[serde(rename = "installScriptActions")]
    pub r#install_script_actions: Box<Vec<super::super::types::hdinsight::HadoopClusterRolesEdgeNodeInstallScriptAction>>,
    ...
    pub r#uninstall_script_actions: Box<Option<Vec<super::super::types::hdinsight::HadoopClusterRolesEdgeNodeUninstallScriptAction>>>,
