...
pub mod user_pool_client {
    ...
    pub struct UserPoolClientArgs {
        ...
        pub access_token_validity: pulumi_wasm_rust::InputOrOutput<Option<i32>>,
        ...
        #[builder(into, default)]
        pub allowed_oauth_flows: pulumi_wasm_rust::InputOrOutput<Option<Vec<String>>>,
        ...
        #[builder(into, default)]
        pub allowed_oauth_flows_user_pool_client: pulumi_wasm_rust::InputOrOutput<
            Option<bool>,
        >,
        ...
        #[builder(into, default)]
        pub allowed_oauth_scopes: pulumi_wasm_rust::InputOrOutput<Option<Vec<String>>>,
        /// Configuration block for Amazon Pinpoint analytics that collects metrics for this user pool. See details below.
        #[builder(into, default)]
        pub analytics_configuration: pulumi_wasm_rust::InputOrOutput<
        ...
        #[builder(into, default)]
        pub auth_session_validity: pulumi_wasm_rust::InputOrOutput<Option<i32>>,
        ...
        #[builder(into, default)]
        pub callback_urls: pulumi_wasm_rust::InputOrOutput<Option<Vec<String>>>,
        /// Default redirect URI and must be included in the list of callback URLs.
        #[builder(into, default)]
        pub default_redirect_uri: pulumi_wasm_rust::InputOrOutput<Option<String>>,
        /// Enables the propagation of additional user context data.
        #[builder(into, default)]
        pub enable_propagate_additional_user_context_data: pulumi_wasm_rust::InputOrOutput<
            Option<bool>,
        >,
        /// Enables or disables token revocation.
        #[builder(into, default)]
        pub enable_token_revocation: pulumi_wasm_rust::InputOrOutput<Option<bool>>,
        ...
        #[builder(into, default)]
        pub explicit_auth_flows: pulumi_wasm_rust::InputOrOutput<Option<Vec<String>>>,
        /// Boolean flag indicating whether an application secret should be generated.
        #[builder(into, default)]
        pub generate_secret: pulumi_wasm_rust::InputOrOutput<Option<bool>>,
        /// Time limit, between 5 minutes and 1 day, after which the ID token is no longer valid and cannot be used. By default, the unit is hours. The unit can be overridden by a value in `token_validity_units.id_token`.
        #[builder(into, default)]
        pub id_token_validity: pulumi_wasm_rust::InputOrOutput<Option<i32>>,
        ...
        #[builder(into, default)]
        pub logout_urls: pulumi_wasm_rust::InputOrOutput<Option<Vec<String>>>,
        /// Name of the application client.
        #[builder(into, default)]
        pub name: pulumi_wasm_rust::InputOrOutput<Option<String>>,
        /// Setting determines the errors and responses returned by Cognito APIs when a user does not exist in the user pool during authentication, account confirmation, and password recovery.
        #[builder(into, default)]
        pub prevent_user_existence_errors: pulumi_wasm_rust::InputOrOutput<
            Option<String>,
        >,
        /// List of user pool attributes that the application client can read from.
        #[builder(into, default)]
        pub read_attributes: pulumi_wasm_rust::InputOrOutput<Option<Vec<String>>>,
        /// Time limit, between 60 minutes and 10 years, after which the refresh token is no longer valid and cannot be used. By default, the unit is days. The unit can be overridden by a value in `token_validity_units.refresh_token`.
        #[builder(into, default)]
        pub refresh_token_validity: pulumi_wasm_rust::InputOrOutput<Option<i32>>,
        ...
        #[builder(into, default)]
        pub supported_identity_providers: pulumi_wasm_rust::InputOrOutput<
            Option<Vec<String>>,
        >,
        /// Configuration block for representing the validity times in units. See details below. Detailed below.
        #[builder(into, default)]
        pub token_validity_units: pulumi_wasm_rust::InputOrOutput<
        ...
        #[builder(into, default)]
        pub write_attributes: pulumi_wasm_rust::InputOrOutput<Option<Vec<String>>>,
    }
    #[allow(dead_code)]
    ...
    pub fn create(
        ...
        let explicit_auth_flows_binding = args
            ...
            .get_output(context)
            .get_inner();
        let generate_secret_binding = args
            .generate_secret
            .get_output(context)
            .get_inner();
        ...
        UserPoolClientResult {
            ...
            analytics_configuration: pulumi_wasm_rust::__private::into_domain(
                o.extract_field("analyticsConfiguration"),
            ),
            auth_session_validity: pulumi_wasm_rust::__private::into_domain(
                o.extract_field("authSessionValidity"),
            ),
