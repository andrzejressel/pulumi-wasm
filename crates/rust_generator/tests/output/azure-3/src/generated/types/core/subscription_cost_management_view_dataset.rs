...
pub struct SubscriptionCostManagementViewDataset {
    ...
    pub r#aggregations: Box<Vec<super::super::types::core::SubscriptionCostManagementViewDatasetAggregation>>,
    ...
    pub r#groupings: Box<Option<Vec<super::super::types::core::SubscriptionCostManagementViewDatasetGrouping>>>,
    ...
    pub r#sortings: Box<Option<Vec<super::super::types::core::SubscriptionCostManagementViewDatasetSorting>>>,
}
