...
pub mod kubernetes_fleet_manager {
    ...
    pub fn create(
        ...
        let hub_profile_binding_1 = args.hub_profile.get_output(context);
        let hub_profile_binding = hub_profile_binding_1.get_inner();
        ...
        KubernetesFleetManagerResult {
            hub_profile: pulumi_gestalt_rust::__private::into_domain(
