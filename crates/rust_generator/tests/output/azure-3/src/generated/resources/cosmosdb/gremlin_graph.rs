...
pub mod gremlin_graph {
    ...
    pub fn create(
        ...
        let index_policy_binding_1 = args.index_policy.get_output(context);
        let index_policy_binding = index_policy_binding_1.get_inner();
        let name_binding_1 = args.name.get_output(context);
        let name_binding = name_binding_1.get_inner();
        let partition_key_path_binding_1 = args.partition_key_path.get_output(context);
        let partition_key_path_binding = partition_key_path_binding_1.get_inner();
