...
pub mod project {
    ...
    pub fn create(
        ...
        let source_platform_binding_1 = args.source_platform.get_output(context);
        let source_platform_binding = source_platform_binding_1.get_inner();
        let tags_binding_1 = args.tags.get_output(context);
        let tags_binding = tags_binding_1.get_inner();
        let target_platform_binding_1 = args.target_platform.get_output(context);
        let target_platform_binding = target_platform_binding_1.get_inner();
