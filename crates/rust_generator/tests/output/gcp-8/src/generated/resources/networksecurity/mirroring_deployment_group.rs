...
pub mod mirroring_deployment_group {
    ...
    pub fn create(
        ...
        let mirroring_deployment_group_id_binding_1 = args
            .mirroring_deployment_group_id
            .get_output(context);
        let mirroring_deployment_group_id_binding = mirroring_deployment_group_id_binding_1
            .get_inner();
        ...
        MirroringDeploymentGroupResult {
            ...
            mirroring_deployment_group_id: pulumi_gestalt_rust::__private::into_domain(
