...
pub mod mirroring_endpoint_group_association {
    ...
    pub fn create(
        ...
        let mirroring_endpoint_group_binding_1 = args
            .mirroring_endpoint_group
            .get_output(context);
        let mirroring_endpoint_group_binding = mirroring_endpoint_group_binding_1
            .get_inner();
        let mirroring_endpoint_group_association_id_binding_1 = args
            .mirroring_endpoint_group_association_id
            .get_output(context);
        let mirroring_endpoint_group_association_id_binding = mirroring_endpoint_group_association_id_binding_1
            .get_inner();
        ...
        MirroringEndpointGroupAssociationResult {
            ...
            locations_details: pulumi_gestalt_rust::__private::into_domain(
                o.extract_field("locationsDetails"),
            ),
            mirroring_endpoint_group: pulumi_gestalt_rust::__private::into_domain(
                o.extract_field("mirroringEndpointGroup"),
            ),
            mirroring_endpoint_group_association_id: pulumi_gestalt_rust::__private::into_domain(
