...
pub mod mirroring_deployment {
    ...
    pub fn create(
        ...
        let mirroring_deployment_group_binding = mirroring_deployment_group_binding_1
            .get_inner();
        let mirroring_deployment_id_binding_1 = args
            .mirroring_deployment_id
            .get_output(context);
        let mirroring_deployment_id_binding = mirroring_deployment_id_binding_1
            .get_inner();
        ...
        let request = register_interface::RegisterResourceRequest {
            ...
            object: Vec::from([
                ...
                register_interface::ObjectField {
                    ...
                    value: &mirroring_deployment_id_binding,
                },
                register_interface::ObjectField {
                    name: "project".into(),
        ...
        MirroringDeploymentResult {
            ...
            mirroring_deployment_id: pulumi_gestalt_rust::__private::into_domain(
                o.extract_field("mirroringDeploymentId"),
            ),
