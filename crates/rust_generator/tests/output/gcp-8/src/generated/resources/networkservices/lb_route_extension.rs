...
pub mod lb_route_extension {
    ...
    pub fn create(
        ...
        let extension_chains_binding_1 = args.extension_chains.get_output(context);
        let extension_chains_binding = extension_chains_binding_1.get_inner();
        let forwarding_rules_binding_1 = args.forwarding_rules.get_output(context);
        let forwarding_rules_binding = forwarding_rules_binding_1.get_inner();
