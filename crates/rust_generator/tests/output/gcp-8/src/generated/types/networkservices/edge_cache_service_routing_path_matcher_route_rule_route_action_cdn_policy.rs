...
pub struct EdgeCacheServiceRoutingPathMatcherRouteRuleRouteActionCdnPolicy {
    ...
    pub r#client_ttl: Box<Option<String>>,
    ...
    #[builder(into, default)]
    #[serde(rename = "maxTtl")]
    pub r#max_ttl: Box<Option<String>>,
    ...
    pub r#negative_caching_policy: Box<Option<std::collections::HashMap<String, String>>>,
    /// The EdgeCacheKeyset containing the set of public keys used to validate signed requests at the edge.
    #[builder(into, default)]
    #[serde(rename = "signedRequestKeyset")]
    pub r#signed_request_keyset: Box<Option<String>>,
    ...
    pub r#signed_request_maximum_expiration_ttl: Box<Option<String>>,
    ...
    pub r#signed_request_mode: Box<Option<String>>,
