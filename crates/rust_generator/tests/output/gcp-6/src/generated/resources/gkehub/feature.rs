...
pub mod feature {
    ...
    pub fn create(
        ...
        let fleet_default_member_config_binding_1 = args
            .fleet_default_member_config
            .get_output(context);
        let fleet_default_member_config_binding = fleet_default_member_config_binding_1
            .get_inner();
        ...
        FeatureResult {
            ...
            fleet_default_member_config: pulumi_gestalt_rust::__private::into_domain(
            ...
            resource_states: pulumi_gestalt_rust::__private::into_domain(
