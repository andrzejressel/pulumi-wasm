...
pub mod cluster {
    ...
    pub fn create(
        ...
        let streaming_capacity_binding_1 = args.streaming_capacity.get_output(context);
        let streaming_capacity_binding = streaming_capacity_binding_1.get_inner();
        ...
        ClusterResult {
            ...
            streaming_capacity: pulumi_gestalt_rust::__private::into_domain(
                o.extract_field("streamingCapacity"),
            ),
