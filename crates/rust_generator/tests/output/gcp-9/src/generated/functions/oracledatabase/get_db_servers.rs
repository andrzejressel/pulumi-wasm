...
pub mod get_db_servers {
    ...
    pub fn invoke(
        ...
        let cloud_exadata_infrastructure_binding_1 = args
            .cloud_exadata_infrastructure
            .get_output(context);
        let cloud_exadata_infrastructure_binding = cloud_exadata_infrastructure_binding_1
            .get_inner();
        ...
        GetDbServersResult {
            cloud_exadata_infrastructure: pulumi_gestalt_rust::__private::into_domain(
