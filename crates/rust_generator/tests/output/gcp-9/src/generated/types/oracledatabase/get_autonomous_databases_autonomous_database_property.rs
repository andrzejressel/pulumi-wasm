...
pub struct GetAutonomousDatabasesAutonomousDatabaseProperty {
    ...
    pub r#apex_details: Box<Vec<super::super::types::oracledatabase::GetAutonomousDatabasesAutonomousDatabasePropertyApexDetail>>,
    ...
    pub r#connection_strings: Box<Vec<super::super::types::oracledatabase::GetAutonomousDatabasesAutonomousDatabasePropertyConnectionString>>,
    ...
    pub r#connection_urls: Box<Vec<super::super::types::oracledatabase::GetAutonomousDatabasesAutonomousDatabasePropertyConnectionUrl>>,
    /// The list of customer contacts.
    #[builder(into)]
    #[serde(rename = "customerContacts")]
    pub r#customer_contacts: Box<Vec<super::super::types::oracledatabase::GetAutonomousDatabasesAutonomousDatabasePropertyCustomerContact>>,
    ...
    pub r#local_standby_dbs: Box<Vec<super::super::types::oracledatabase::GetAutonomousDatabasesAutonomousDatabasePropertyLocalStandbyDb>>,
    ...
    pub r#scheduled_operation_details: Box<Vec<super::super::types::oracledatabase::GetAutonomousDatabasesAutonomousDatabasePropertyScheduledOperationDetail>>,
