...
pub struct GetAutonomousDatabasesAutonomousDatabasePropertyConnectionString {
    ...
    pub r#all_connection_strings: Box<Vec<super::super::types::oracledatabase::GetAutonomousDatabasesAutonomousDatabasePropertyConnectionStringAllConnectionString>>,
    ...
    pub r#profiles: Box<Vec<super::super::types::oracledatabase::GetAutonomousDatabasesAutonomousDatabasePropertyConnectionStringProfile>>,
}
