...
pub struct GetCloudVmClusterProperty {
    ...
    pub r#diagnostics_data_collection_options: Box<Vec<super::super::types::oracledatabase::GetCloudVmClusterPropertyDiagnosticsDataCollectionOption>>,
    ...
    pub r#time_zones: Box<Vec<super::super::types::oracledatabase::GetCloudVmClusterPropertyTimeZone>>,
}
