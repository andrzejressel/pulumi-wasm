...
pub mod nfs_file_share {
    ...
    pub struct NfsFileShareArgs {
        ...
        #[builder(into)]
        pub client_lists: pulumi_wasm_rust::InputOrOutput<Vec<String>>,
        ...
        #[builder(into, default)]
        pub nfs_file_share_defaults: pulumi_wasm_rust::InputOrOutput<
        ...
        #[builder(into, default)]
        pub squash: pulumi_wasm_rust::InputOrOutput<Option<String>>,
