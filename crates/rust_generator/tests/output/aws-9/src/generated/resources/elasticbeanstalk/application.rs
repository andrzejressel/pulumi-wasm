...
pub mod application {
    ...
    pub fn create(
        ...
        let appversion_lifecycle_binding_1 = args
            .appversion_lifecycle
            .get_output(context);
        let appversion_lifecycle_binding = appversion_lifecycle_binding_1.get_inner();
        ...
        ApplicationResult {
            appversion_lifecycle: pulumi_gestalt_rust::__private::into_domain(
