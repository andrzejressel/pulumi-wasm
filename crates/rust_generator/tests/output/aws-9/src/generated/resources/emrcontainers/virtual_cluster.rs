...
pub mod virtual_cluster {
    ...
    pub fn create(
        ...
        let container_provider_binding_1 = args.container_provider.get_output(context);
        let container_provider_binding = container_provider_binding_1.get_inner();
        ...
        VirtualClusterResult {
            ...
            container_provider: pulumi_gestalt_rust::__private::into_domain(
                o.extract_field("containerProvider"),
            ),
