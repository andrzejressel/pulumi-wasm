...
pub struct FunctionAppSlotSiteConfig {
    ...
    pub r#ip_restrictions: Box<Option<Vec<super::super::types::appservice::FunctionAppSlotSiteConfigIpRestriction>>>,
    ...
    pub r#scm_ip_restrictions: Box<Option<Vec<super::super::types::appservice::FunctionAppSlotSiteConfigScmIpRestriction>>>,
