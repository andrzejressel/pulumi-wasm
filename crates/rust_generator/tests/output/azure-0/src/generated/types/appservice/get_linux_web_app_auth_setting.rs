...
pub struct GetLinuxWebAppAuthSetting {
    ...
    pub r#active_directories: Box<Vec<super::super::types::appservice::GetLinuxWebAppAuthSettingActiveDirectory>>,
    ...
    pub r#facebooks: Box<Vec<super::super::types::appservice::GetLinuxWebAppAuthSettingFacebook>>,
    /// A `github` block as defined below.
    #[builder(into)]
    #[serde(rename = "githubs")]
    pub r#githubs: Box<Vec<super::super::types::appservice::GetLinuxWebAppAuthSettingGithub>>,
    /// A `google` block as defined below.
    #[builder(into)]
    #[serde(rename = "googles")]
    pub r#googles: Box<Vec<super::super::types::appservice::GetLinuxWebAppAuthSettingGoogle>>,
    ...
    pub r#microsofts: Box<Vec<super::super::types::appservice::GetLinuxWebAppAuthSettingMicrosoft>>,
    ...
    pub r#twitters: Box<Vec<super::super::types::appservice::GetLinuxWebAppAuthSettingTwitter>>,
