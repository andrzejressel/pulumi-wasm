...
pub struct LinuxWebAppSiteConfig {
    ...
    pub r#ip_restrictions: Box<Option<Vec<super::super::types::appservice::LinuxWebAppSiteConfigIpRestriction>>>,
    #[builder(into, default)]
    ...
    pub r#scm_ip_restrictions: Box<Option<Vec<super::super::types::appservice::LinuxWebAppSiteConfigScmIpRestriction>>>,
