...
pub struct SlotSiteConfig {
    ...
    pub r#ip_restrictions: Box<Option<Vec<super::super::types::appservice::SlotSiteConfigIpRestriction>>>,
    ...
    pub r#scm_ip_restrictions: Box<Option<Vec<super::super::types::appservice::SlotSiteConfigScmIpRestriction>>>,
