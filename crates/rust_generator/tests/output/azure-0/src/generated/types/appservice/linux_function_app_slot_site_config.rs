...
pub struct LinuxFunctionAppSlotSiteConfig {
    ...
    pub r#ip_restrictions: Box<Option<Vec<super::super::types::appservice::LinuxFunctionAppSlotSiteConfigIpRestriction>>>,
    ...
    pub r#scm_ip_restrictions: Box<Option<Vec<super::super::types::appservice::LinuxFunctionAppSlotSiteConfigScmIpRestriction>>>,
