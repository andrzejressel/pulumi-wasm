...
pub struct WindowsWebAppSiteConfig {
    ...
    pub r#handler_mappings: Box<Option<Vec<super::super::types::appservice::WindowsWebAppSiteConfigHandlerMapping>>>,
    ...
    pub r#ip_restrictions: Box<Option<Vec<super::super::types::appservice::WindowsWebAppSiteConfigIpRestriction>>>,
    #[builder(into, default)]
    ...
    pub r#scm_ip_restrictions: Box<Option<Vec<super::super::types::appservice::WindowsWebAppSiteConfigScmIpRestriction>>>,
    ...
    pub r#virtual_applications: Box<Option<Vec<super::super::types::appservice::WindowsWebAppSiteConfigVirtualApplication>>>,
