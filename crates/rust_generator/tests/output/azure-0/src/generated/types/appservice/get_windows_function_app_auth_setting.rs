...
pub struct GetWindowsFunctionAppAuthSetting {
    ...
    pub r#active_directories: Box<Vec<super::super::types::appservice::GetWindowsFunctionAppAuthSettingActiveDirectory>>,
    ...
    pub r#facebooks: Box<Vec<super::super::types::appservice::GetWindowsFunctionAppAuthSettingFacebook>>,
    /// A `github` block as defined below.
    #[builder(into)]
    #[serde(rename = "githubs")]
    pub r#githubs: Box<Vec<super::super::types::appservice::GetWindowsFunctionAppAuthSettingGithub>>,
    /// A `google` block as defined below.
    #[builder(into)]
    #[serde(rename = "googles")]
    pub r#googles: Box<Vec<super::super::types::appservice::GetWindowsFunctionAppAuthSettingGoogle>>,
    ...
    pub r#microsofts: Box<Vec<super::super::types::appservice::GetWindowsFunctionAppAuthSettingMicrosoft>>,
    ...
    pub r#twitters: Box<Vec<super::super::types::appservice::GetWindowsFunctionAppAuthSettingTwitter>>,
