...
pub struct GetLinuxWebAppAuthSettingsV2 {
    ...
    pub r#active_directory_v_2_s: Box<Vec<super::super::types::appservice::GetLinuxWebAppAuthSettingsV2ActiveDirectoryV2>>,
    /// An `apple_v2` block as defined below.
    #[builder(into)]
    #[serde(rename = "appleV2s")]
    pub r#apple_v_2_s: Box<Vec<super::super::types::appservice::GetLinuxWebAppAuthSettingsV2AppleV2>>,
    ...
    pub r#azure_static_web_app_v_2_s: Box<Vec<super::super::types::appservice::GetLinuxWebAppAuthSettingsV2AzureStaticWebAppV2>>,
    ...
    pub r#custom_oidc_v_2_s: Box<Vec<super::super::types::appservice::GetLinuxWebAppAuthSettingsV2CustomOidcV2>>,
    ...
    pub r#facebook_v_2_s: Box<Vec<super::super::types::appservice::GetLinuxWebAppAuthSettingsV2FacebookV2>>,
    ...
    pub r#github_v_2_s: Box<Vec<super::super::types::appservice::GetLinuxWebAppAuthSettingsV2GithubV2>>,
    /// A `google_v2` block as defined below.
    #[builder(into)]
    #[serde(rename = "googleV2s")]
    pub r#google_v_2_s: Box<Vec<super::super::types::appservice::GetLinuxWebAppAuthSettingsV2GoogleV2>>,
    ...
    #[builder(into)]
    #[serde(rename = "logins")]
    pub r#logins: Box<Vec<super::super::types::appservice::GetLinuxWebAppAuthSettingsV2Login>>,
    /// A `microsoft_v2` block as defined below.
    #[builder(into)]
    #[serde(rename = "microsoftV2s")]
    pub r#microsoft_v_2_s: Box<Vec<super::super::types::appservice::GetLinuxWebAppAuthSettingsV2MicrosoftV2>>,
    ...
    pub r#twitter_v_2_s: Box<Vec<super::super::types::appservice::GetLinuxWebAppAuthSettingsV2TwitterV2>>,
