...
pub struct GetWindowsWebAppAuthSetting {
    ...
    pub r#active_directories: Box<Vec<super::super::types::appservice::GetWindowsWebAppAuthSettingActiveDirectory>>,
    ...
    pub r#facebooks: Box<Vec<super::super::types::appservice::GetWindowsWebAppAuthSettingFacebook>>,
    /// A `github` block as defined below.
    #[builder(into)]
    #[serde(rename = "githubs")]
    pub r#githubs: Box<Vec<super::super::types::appservice::GetWindowsWebAppAuthSettingGithub>>,
    /// A `google` block as defined below.
    #[builder(into)]
    #[serde(rename = "googles")]
    pub r#googles: Box<Vec<super::super::types::appservice::GetWindowsWebAppAuthSettingGoogle>>,
    ...
    pub r#microsofts: Box<Vec<super::super::types::appservice::GetWindowsWebAppAuthSettingMicrosoft>>,
    ...
    pub r#twitters: Box<Vec<super::super::types::appservice::GetWindowsWebAppAuthSettingTwitter>>,
