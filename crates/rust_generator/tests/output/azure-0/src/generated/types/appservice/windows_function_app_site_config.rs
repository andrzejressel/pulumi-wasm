...
pub struct WindowsFunctionAppSiteConfig {
    ...
    pub r#ip_restrictions: Box<Option<Vec<super::super::types::appservice::WindowsFunctionAppSiteConfigIpRestriction>>>,
    ...
    pub r#scm_ip_restrictions: Box<Option<Vec<super::super::types::appservice::WindowsFunctionAppSiteConfigScmIpRestriction>>>,
