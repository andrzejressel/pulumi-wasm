...
pub struct WindowsFunctionAppSlotSiteConfig {
    ...
    pub r#ip_restrictions: Box<Option<Vec<super::super::types::appservice::WindowsFunctionAppSlotSiteConfigIpRestriction>>>,
    ...
    pub r#scm_ip_restrictions: Box<Option<Vec<super::super::types::appservice::WindowsFunctionAppSlotSiteConfigScmIpRestriction>>>,
