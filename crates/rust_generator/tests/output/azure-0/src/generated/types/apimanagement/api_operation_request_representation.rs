...
pub struct ApiOperationRequestRepresentation {
    ...
    pub r#examples: Box<Option<Vec<super::super::types::apimanagement::ApiOperationRequestRepresentationExample>>>,
    ...
    pub r#form_parameters: Box<Option<Vec<super::super::types::apimanagement::ApiOperationRequestRepresentationFormParameter>>>,
