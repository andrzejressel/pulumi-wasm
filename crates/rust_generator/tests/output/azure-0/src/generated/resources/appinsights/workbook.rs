...
pub mod workbook {
    ...
    pub fn create(
        ...
        let data_json_binding_1 = args.data_json.get_output(context);
        let data_json_binding = data_json_binding_1.get_inner();
        ...
        let source_id_binding_1 = args.source_id.get_output(context);
        let source_id_binding = source_id_binding_1.get_inner();
