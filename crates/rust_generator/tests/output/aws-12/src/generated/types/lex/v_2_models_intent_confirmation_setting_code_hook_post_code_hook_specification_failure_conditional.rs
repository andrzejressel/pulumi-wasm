...
pub struct V2ModelsIntentConfirmationSettingCodeHookPostCodeHookSpecificationFailureConditional {
    ...
    pub r#conditional_branches: Box<Option<Vec<super::super::types::lex::V2ModelsIntentConfirmationSettingCodeHookPostCodeHookSpecificationFailureConditionalConditionalBranch>>>,
