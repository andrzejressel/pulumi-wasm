...
pub struct GetNetworkServicePccRuleQosPolicy {
    ...
    pub r#guaranteed_bit_rates: Box<Vec<super::super::types::mobile::GetNetworkServicePccRuleQosPolicyGuaranteedBitRate>>,
    ...
    pub r#maximum_bit_rates: Box<Vec<super::super::types::mobile::GetNetworkServicePccRuleQosPolicyMaximumBitRate>>,
