...
pub mod network_slice {
    ...
    pub fn create(
        ...
        let single_network_slice_selection_assistance_information_binding_1 = args
            .single_network_slice_selection_assistance_information
            .get_output(context);
        let single_network_slice_selection_assistance_information_binding = single_network_slice_selection_assistance_information_binding_1
            .get_inner();
        ...
        NetworkSliceResult {
            ...
            single_network_slice_selection_assistance_information: pulumi_gestalt_rust::__private::into_domain(
