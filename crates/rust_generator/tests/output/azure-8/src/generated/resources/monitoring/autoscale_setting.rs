...
pub mod autoscale_setting {
    ...
    pub fn create(
        ...
        let notification_binding_1 = args.notification.get_output(context);
        let notification_binding = notification_binding_1.get_inner();
        let predictive_binding_1 = args.predictive.get_output(context);
        let predictive_binding = predictive_binding_1.get_inner();
        let profiles_binding_1 = args.profiles.get_output(context);
        let profiles_binding = profiles_binding_1.get_inner();
        ...
        AutoscaleSettingResult {
            ...
            predictive: pulumi_gestalt_rust::__private::into_domain(
