...
pub mod network {
    ...
    pub fn create(
        ...
        let mobile_country_code_binding_1 = args.mobile_country_code.get_output(context);
        let mobile_country_code_binding = mobile_country_code_binding_1.get_inner();
        let mobile_network_code_binding_1 = args.mobile_network_code.get_output(context);
        let mobile_network_code_binding = mobile_network_code_binding_1.get_inner();
