...
pub mod virtual_machine_group {
    ...
    pub fn create(
        ...
        let sql_image_offer_binding_1 = args.sql_image_offer.get_output(context);
        let sql_image_offer_binding = sql_image_offer_binding_1.get_inner();
        let sql_image_sku_binding_1 = args.sql_image_sku.get_output(context);
        let sql_image_sku_binding = sql_image_sku_binding_1.get_inner();
        let tags_binding_1 = args.tags.get_output(context);
        let tags_binding = tags_binding_1.get_inner();
        let wsfc_domain_profile_binding_1 = args.wsfc_domain_profile.get_output(context);
        let wsfc_domain_profile_binding = wsfc_domain_profile_binding_1.get_inner();
        ...
        VirtualMachineGroupResult {
            ...
            sql_image_offer: pulumi_gestalt_rust::__private::into_domain(
                o.extract_field("sqlImageOffer"),
            ),
            sql_image_sku: pulumi_gestalt_rust::__private::into_domain(
                o.extract_field("sqlImageSku"),
            ),
            tags: pulumi_gestalt_rust::__private::into_domain(o.extract_field("tags")),
            wsfc_domain_profile: pulumi_gestalt_rust::__private::into_domain(
