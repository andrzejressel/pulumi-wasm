...
pub struct InstanceFromMachineImageNetworkInterface {
    ...
    pub r#access_configs: Box<Option<Vec<super::super::types::compute::InstanceFromMachineImageNetworkInterfaceAccessConfig>>>,
    /// An array of alias IP ranges for this network interface.
    #[builder(into, default)]
    #[serde(rename = "aliasIpRanges")]
    pub r#alias_ip_ranges: Box<Option<Vec<super::super::types::compute::InstanceFromMachineImageNetworkInterfaceAliasIpRange>>>,
    ...
    pub r#ipv_6_access_configs: Box<Option<Vec<super::super::types::compute::InstanceFromMachineImageNetworkInterfaceIpv6AccessConfig>>>,
