...
pub struct RegionNetworkFirewallPolicyRuleMatch {
    ...
    pub r#layer_4_configs: Box<Vec<super::super::types::compute::RegionNetworkFirewallPolicyRuleMatchLayer4Config>>,
    ...
    pub r#src_secure_tags: Box<Option<Vec<super::super::types::compute::RegionNetworkFirewallPolicyRuleMatchSrcSecureTag>>>,
