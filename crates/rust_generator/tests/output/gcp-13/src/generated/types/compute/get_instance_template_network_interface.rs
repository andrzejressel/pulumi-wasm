...
pub struct GetInstanceTemplateNetworkInterface {
    ...
    pub r#access_configs: Box<Vec<super::super::types::compute::GetInstanceTemplateNetworkInterfaceAccessConfig>>,
    /// An
    /// array of alias IP ranges for this network interface. Can only be specified for network
    /// interfaces on subnet-mode networks. Structure documented below.
    #[builder(into)]
    #[serde(rename = "aliasIpRanges")]
    pub r#alias_ip_ranges: Box<Vec<super::super::types::compute::GetInstanceTemplateNetworkInterfaceAliasIpRange>>,
    ...
    pub r#ipv_6_access_configs: Box<Vec<super::super::types::compute::GetInstanceTemplateNetworkInterfaceIpv6AccessConfig>>,
