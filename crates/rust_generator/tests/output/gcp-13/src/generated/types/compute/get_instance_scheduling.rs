...
pub struct GetInstanceScheduling {
    ...
    pub r#local_ssd_recovery_timeouts: Box<Vec<super::super::types::compute::GetInstanceSchedulingLocalSsdRecoveryTimeout>>,
    ...
    pub r#max_run_durations: Box<Vec<super::super::types::compute::GetInstanceSchedulingMaxRunDuration>>,
    #[builder(into)]
    ...
    pub r#node_affinities: Box<Vec<super::super::types::compute::GetInstanceSchedulingNodeAffinity>>,
    ...
    pub r#on_instance_stop_actions: Box<Vec<super::super::types::compute::GetInstanceSchedulingOnInstanceStopAction>>,
