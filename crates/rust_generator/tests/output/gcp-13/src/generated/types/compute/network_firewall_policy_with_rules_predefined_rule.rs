...
pub struct NetworkFirewallPolicyWithRulesPredefinedRule {
    ...
    pub r#matches: Box<Option<Vec<super::super::types::compute::NetworkFirewallPolicyWithRulesPredefinedRuleMatch>>>,
    /// (Output)
    ...
    pub r#target_secure_tags: Box<Option<Vec<super::super::types::compute::NetworkFirewallPolicyWithRulesPredefinedRuleTargetSecureTag>>>,
    /// (Output)
