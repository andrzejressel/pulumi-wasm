...
pub struct GetInstanceTemplateScheduling {
    ...
    pub r#local_ssd_recovery_timeouts: Box<Vec<super::super::types::compute::GetInstanceTemplateSchedulingLocalSsdRecoveryTimeout>>,
    ...
    pub r#max_run_durations: Box<Vec<super::super::types::compute::GetInstanceTemplateSchedulingMaxRunDuration>>,
    ...
    pub r#node_affinities: Box<Vec<super::super::types::compute::GetInstanceTemplateSchedulingNodeAffinity>>,
    ...
    pub r#on_instance_stop_actions: Box<Vec<super::super::types::compute::GetInstanceTemplateSchedulingOnInstanceStopAction>>,
