...
pub struct RegionNetworkFirewallPolicyWithRulesPredefinedRuleMatch {
    ...
    pub r#layer_4_configs: Box<Option<Vec<super::super::types::compute::RegionNetworkFirewallPolicyWithRulesPredefinedRuleMatchLayer4Config>>>,
    ...
    pub r#src_secure_tags: Box<Option<Vec<super::super::types::compute::RegionNetworkFirewallPolicyWithRulesPredefinedRuleMatchSrcSecureTag>>>,
    /// Names of Network Threat Intelligence lists.
