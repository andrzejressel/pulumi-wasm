...
pub struct NetworkFirewallPolicyWithRulesRuleMatch {
    ...
    pub r#layer_4_configs: Box<Vec<super::super::types::compute::NetworkFirewallPolicyWithRulesRuleMatchLayer4Config>>,
    ...
    pub r#src_secure_tags: Box<Option<Vec<super::super::types::compute::NetworkFirewallPolicyWithRulesRuleMatchSrcSecureTag>>>,
    /// Names of Network Threat Intelligence lists.
