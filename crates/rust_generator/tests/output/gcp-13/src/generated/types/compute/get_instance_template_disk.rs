...
pub struct GetInstanceTemplateDisk {
    ...
    pub r#disk_encryption_keys: Box<Vec<super::super::types::compute::GetInstanceTemplateDiskDiskEncryptionKey>>,
    ...
    pub r#source_image_encryption_keys: Box<Vec<super::super::types::compute::GetInstanceTemplateDiskSourceImageEncryptionKey>>,
    ...
    pub r#source_snapshot_encryption_keys: Box<Vec<super::super::types::compute::GetInstanceTemplateDiskSourceSnapshotEncryptionKey>>,
