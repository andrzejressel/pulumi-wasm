...
pub struct UrlMapHeaderAction {
    ...
    pub r#request_headers_to_adds: Box<Option<Vec<super::super::types::compute::UrlMapHeaderActionRequestHeadersToAdd>>>,
    ...
    pub r#response_headers_to_adds: Box<Option<Vec<super::super::types::compute::UrlMapHeaderActionResponseHeadersToAdd>>>,
