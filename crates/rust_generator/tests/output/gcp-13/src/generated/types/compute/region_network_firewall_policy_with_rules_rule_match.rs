...
pub struct RegionNetworkFirewallPolicyWithRulesRuleMatch {
    ...
    pub r#layer_4_configs: Box<Vec<super::super::types::compute::RegionNetworkFirewallPolicyWithRulesRuleMatchLayer4Config>>,
    ...
    pub r#src_secure_tags: Box<Option<Vec<super::super::types::compute::RegionNetworkFirewallPolicyWithRulesRuleMatchSrcSecureTag>>>,
    /// Names of Network Threat Intelligence lists.
