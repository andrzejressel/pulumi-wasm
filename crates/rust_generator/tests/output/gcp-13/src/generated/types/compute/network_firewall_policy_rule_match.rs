...
pub struct NetworkFirewallPolicyRuleMatch {
    ...
    pub r#layer_4_configs: Box<Vec<super::super::types::compute::NetworkFirewallPolicyRuleMatchLayer4Config>>,
    ...
    pub r#src_secure_tags: Box<Option<Vec<super::super::types::compute::NetworkFirewallPolicyRuleMatchSrcSecureTag>>>,
