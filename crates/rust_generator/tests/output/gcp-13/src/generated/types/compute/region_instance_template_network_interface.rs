...
pub struct RegionInstanceTemplateNetworkInterface {
    ...
    pub r#access_configs: Box<Option<Vec<super::super::types::compute::RegionInstanceTemplateNetworkInterfaceAccessConfig>>>,
    /// An
    /// array of alias IP ranges for this network interface. Can only be specified for network
    /// interfaces on subnet-mode networks. Structure documented below.
    #[builder(into, default)]
    #[serde(rename = "aliasIpRanges")]
    pub r#alias_ip_ranges: Box<Option<Vec<super::super::types::compute::RegionInstanceTemplateNetworkInterfaceAliasIpRange>>>,
    ...
    pub r#ipv_6_access_configs: Box<Option<Vec<super::super::types::compute::RegionInstanceTemplateNetworkInterfaceIpv6AccessConfig>>>,
