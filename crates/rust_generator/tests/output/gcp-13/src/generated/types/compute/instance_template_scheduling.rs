...
pub struct InstanceTemplateScheduling {
    ...
    pub r#local_ssd_recovery_timeouts: Box<Option<Vec<super::super::types::compute::InstanceTemplateSchedulingLocalSsdRecoveryTimeout>>>,
    ...
    pub r#node_affinities: Box<Option<Vec<super::super::types::compute::InstanceTemplateSchedulingNodeAffinity>>>,
