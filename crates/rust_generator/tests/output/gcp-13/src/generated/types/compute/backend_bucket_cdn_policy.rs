...
pub struct BackendBucketCdnPolicy {
    ...
    pub r#bypass_cache_on_request_headers: Box<Option<Vec<super::super::types::compute::BackendBucketCdnPolicyBypassCacheOnRequestHeader>>>,
    ...
    pub r#negative_caching_policies: Box<Option<Vec<super::super::types::compute::BackendBucketCdnPolicyNegativeCachingPolicy>>>,
    /// If true then Cloud CDN will combine multiple concurrent cache fill requests into a small number of requests to the origin.
    #[builder(into, default)]
    #[serde(rename = "requestCoalescing")]
    pub r#request_coalescing: Box<Option<bool>>,
