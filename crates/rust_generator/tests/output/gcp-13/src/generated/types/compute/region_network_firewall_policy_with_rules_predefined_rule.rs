...
pub struct RegionNetworkFirewallPolicyWithRulesPredefinedRule {
    ...
    pub r#matches: Box<Option<Vec<super::super::types::compute::RegionNetworkFirewallPolicyWithRulesPredefinedRuleMatch>>>,
    /// (Output)
    ...
    pub r#target_secure_tags: Box<Option<Vec<super::super::types::compute::RegionNetworkFirewallPolicyWithRulesPredefinedRuleTargetSecureTag>>>,
    /// (Output)
