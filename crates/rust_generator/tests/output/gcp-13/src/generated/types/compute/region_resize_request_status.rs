...
pub struct RegionResizeRequestStatus {
    ...
    #[serde(rename = "errors")]
    pub r#errors: Box<Option<Vec<super::super::types::compute::RegionResizeRequestStatusError>>>,
    /// (Output)
    ...
    pub r#last_attempts: Box<Option<Vec<super::super::types::compute::RegionResizeRequestStatusLastAttempt>>>,
}
