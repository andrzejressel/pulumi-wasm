...
pub mod memcached_layer {
    ...
    pub fn create(
        ...
        let allocated_memory_binding_1 = args.allocated_memory.get_output(context);
        let allocated_memory_binding = allocated_memory_binding_1.get_inner();
        ...
        MemcachedLayerResult {
            allocated_memory: pulumi_gestalt_rust::__private::into_domain(
                o.extract_field("allocatedMemory"),
            ),
