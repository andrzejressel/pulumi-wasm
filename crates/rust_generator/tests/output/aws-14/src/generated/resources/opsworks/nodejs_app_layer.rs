...
pub mod nodejs_app_layer {
    ...
    pub fn create(
        ...
        let nodejs_version_binding_1 = args.nodejs_version.get_output(context);
        let nodejs_version_binding = nodejs_version_binding_1.get_inner();
        ...
        NodejsAppLayerResult {
            ...
            nodejs_version: pulumi_gestalt_rust::__private::into_domain(
                o.extract_field("nodejsVersion"),
            ),
