...
pub mod mysql_layer {
    ...
    pub fn create(
        ...
        let root_password_on_all_instances_binding_1 = args
            .root_password_on_all_instances
            .get_output(context);
        let root_password_on_all_instances_binding = root_password_on_all_instances_binding_1
            .get_inner();
        ...
        let request = register_interface::RegisterResourceRequest {
            ...
            object: Vec::from([
                ...
                register_interface::ObjectField {
                    ...
                    value: &root_password_on_all_instances_binding,
                },
                register_interface::ObjectField {
                    name: "stackId".into(),
        ...
        MysqlLayerResult {
            ...
            root_password_on_all_instances: pulumi_gestalt_rust::__private::into_domain(
                o.extract_field("rootPasswordOnAllInstances"),
            ),
