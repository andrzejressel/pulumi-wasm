        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: healthcheck_method_binding.get_id(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "healthcheckUrl".into(),
                    value: healthcheck_url_binding.get_id(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: stats_enabled_binding.get_id(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "statsPassword".into(),
                    value: stats_password_binding.get_id(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "statsUrl".into(),
                    value: stats_url_binding.get_id(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "statsUser".into(),
                    value: stats_user_binding.get_id(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
