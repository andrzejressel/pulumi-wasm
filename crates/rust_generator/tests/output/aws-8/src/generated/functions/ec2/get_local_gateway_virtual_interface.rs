...
pub mod get_local_gateway_virtual_interface {
    ...
    pub fn invoke(
        ...
        GetLocalGatewayVirtualInterfaceResult {
            ...
            local_address: pulumi_gestalt_rust::__private::into_domain(
                o.extract_field("localAddress"),
            ),
            local_bgp_asn: pulumi_gestalt_rust::__private::into_domain(
            ...
            peer_bgp_asn: pulumi_gestalt_rust::__private::into_domain(
