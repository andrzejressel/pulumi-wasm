...
pub mod traffic_mirror_filter {
    ...
    pub fn create(
        ...
        let network_services_binding_1 = args.network_services.get_output(context);
        let network_services_binding = network_services_binding_1.get_inner();
        ...
        TrafficMirrorFilterResult {
            ...
            network_services: pulumi_gestalt_rust::__private::into_domain(
