...
pub struct NetworkInsightsAnalysisForwardPathComponentOutboundHeader {
    ...
    pub r#destination_port_ranges: Box<Option<Vec<super::super::types::ec2::NetworkInsightsAnalysisForwardPathComponentOutboundHeaderDestinationPortRange>>>,
    #[builder(into, default)]
    ...
    pub r#source_port_ranges: Box<Option<Vec<super::super::types::ec2::NetworkInsightsAnalysisForwardPathComponentOutboundHeaderSourcePortRange>>>,
}
