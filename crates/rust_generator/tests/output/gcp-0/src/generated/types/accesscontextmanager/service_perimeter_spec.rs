...
pub struct ServicePerimeterSpec {
    ...
    pub r#egress_policies: Box<Option<Vec<super::super::types::accesscontextmanager::ServicePerimeterSpecEgressPolicy>>>,
    ...
    pub r#ingress_policies: Box<Option<Vec<super::super::types::accesscontextmanager::ServicePerimeterSpecIngressPolicy>>>,
