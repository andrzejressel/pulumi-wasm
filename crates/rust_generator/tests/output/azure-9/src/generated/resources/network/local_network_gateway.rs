...
pub mod local_network_gateway {
    ...
    pub fn create(
        ...
        let gateway_address_binding_1 = args.gateway_address.get_output(context);
        let gateway_address_binding = gateway_address_binding_1.get_inner();
        let gateway_fqdn_binding_1 = args.gateway_fqdn.get_output(context);
        let gateway_fqdn_binding = gateway_fqdn_binding_1.get_inner();
