...
pub mod snapshot_policy {
    ...
    pub fn create(
        ...
        let daily_schedule_binding_1 = args.daily_schedule.get_output(context);
        let daily_schedule_binding = daily_schedule_binding_1.get_inner();
        let enabled_binding_1 = args.enabled.get_output(context);
        let enabled_binding = enabled_binding_1.get_inner();
        let hourly_schedule_binding_1 = args.hourly_schedule.get_output(context);
        let hourly_schedule_binding = hourly_schedule_binding_1.get_inner();
        let location_binding_1 = args.location.get_output(context);
        let location_binding = location_binding_1.get_inner();
        let monthly_schedule_binding_1 = args.monthly_schedule.get_output(context);
        let monthly_schedule_binding = monthly_schedule_binding_1.get_inner();
        ...
        let weekly_schedule_binding_1 = args.weekly_schedule.get_output(context);
        let weekly_schedule_binding = weekly_schedule_binding_1.get_inner();
