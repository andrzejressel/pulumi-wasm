...
pub mod image {
    ...
    pub fn create(
        ...
        let source_virtual_machine_id_binding_1 = args
            .source_virtual_machine_id
            .get_output(context);
        let source_virtual_machine_id_binding = source_virtual_machine_id_binding_1
            .get_inner();
        let tags_binding_1 = args.tags.get_output(context);
        let tags_binding = tags_binding_1.get_inner();
        let zone_resilient_binding_1 = args.zone_resilient.get_output(context);
        let zone_resilient_binding = zone_resilient_binding_1.get_inner();
