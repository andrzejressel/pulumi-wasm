...
pub mod ledger {
    ...
    pub fn create(
        ...
        let azuread_based_service_principals_binding_1 = args
            .azuread_based_service_principals
            .get_output(context);
        let azuread_based_service_principals_binding = azuread_based_service_principals_binding_1
            .get_inner();
        let certificate_based_security_principals_binding_1 = args
            .certificate_based_security_principals
            .get_output(context);
        let certificate_based_security_principals_binding = certificate_based_security_principals_binding_1
            .get_inner();
        let ledger_type_binding_1 = args.ledger_type.get_output(context);
        let ledger_type_binding = ledger_type_binding_1.get_inner();
