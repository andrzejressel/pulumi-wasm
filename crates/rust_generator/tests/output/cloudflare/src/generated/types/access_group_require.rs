...
pub struct AccessGroupRequire {
    ...
    pub r#auth_contexts: Box<Option<Vec<super::types::AccessGroupRequireAuthContext>>>,
    ...
    #[builder(into, default)]
    #[serde(rename = "azures")]
    pub r#azures: Box<Option<Vec<super::types::AccessGroupRequireAzure>>>,
    ...
    pub r#githubs: Box<Option<Vec<super::types::AccessGroupRequireGithub>>>,
    ...
    pub r#gsuites: Box<Option<Vec<super::types::AccessGroupRequireGsuite>>>,
    ...
    #[builder(into, default)]
    #[serde(rename = "oktas")]
    pub r#oktas: Box<Option<Vec<super::types::AccessGroupRequireOkta>>>,
    /// Matches a SAML group. Requires a SAML identity provider.
    #[builder(into, default)]
    #[serde(rename = "samls")]
    pub r#samls: Box<Option<Vec<super::types::AccessGroupRequireSaml>>>,
