...
pub struct AccessApplicationSaasApp {
    ...
    pub r#custom_attributes: Box<Option<Vec<super::types::AccessApplicationSaasAppCustomAttribute>>>,
    /// Custom claim mapped from IDPs.
    #[builder(into, default)]
    #[serde(rename = "customClaims")]
    pub r#custom_claims: Box<Option<Vec<super::types::AccessApplicationSaasAppCustomClaim>>>,
    ...
    pub r#refresh_token_options: Box<Option<Vec<super::types::AccessApplicationSaasAppRefreshTokenOption>>>,
