...
pub struct ZeroTrustAccessPolicyRequire {
    ...
    pub r#auth_contexts: Box<Option<Vec<super::types::ZeroTrustAccessPolicyRequireAuthContext>>>,
    ...
    #[builder(into, default)]
    #[serde(rename = "azures")]
    pub r#azures: Box<Option<Vec<super::types::ZeroTrustAccessPolicyRequireAzure>>>,
    ...
    pub r#external_evaluations: Box<Option<Vec<super::types::ZeroTrustAccessPolicyRequireExternalEvaluation>>>,
    ...
    pub r#githubs: Box<Option<Vec<super::types::ZeroTrustAccessPolicyRequireGithub>>>,
    ...
    pub r#gsuites: Box<Option<Vec<super::types::ZeroTrustAccessPolicyRequireGsuite>>>,
    ...
    #[builder(into, default)]
    #[serde(rename = "oktas")]
    pub r#oktas: Box<Option<Vec<super::types::ZeroTrustAccessPolicyRequireOkta>>>,
    /// Matches a SAML group. Requires a SAML identity provider.
    #[builder(into, default)]
    #[serde(rename = "samls")]
    pub r#samls: Box<Option<Vec<super::types::ZeroTrustAccessPolicyRequireSaml>>>,
