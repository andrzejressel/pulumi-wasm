...
pub struct AccessGroupInclude {
    ...
    pub r#auth_contexts: Box<Option<Vec<super::types::AccessGroupIncludeAuthContext>>>,
    ...
    #[builder(into, default)]
    #[serde(rename = "azures")]
    pub r#azures: Box<Option<Vec<super::types::AccessGroupIncludeAzure>>>,
    ...
    pub r#githubs: Box<Option<Vec<super::types::AccessGroupIncludeGithub>>>,
    ...
    pub r#gsuites: Box<Option<Vec<super::types::AccessGroupIncludeGsuite>>>,
    ...
    #[builder(into, default)]
    #[serde(rename = "oktas")]
    pub r#oktas: Box<Option<Vec<super::types::AccessGroupIncludeOkta>>>,
    /// Matches a SAML group. Requires a SAML identity provider.
    #[builder(into, default)]
    #[serde(rename = "samls")]
    pub r#samls: Box<Option<Vec<super::types::AccessGroupIncludeSaml>>>,
