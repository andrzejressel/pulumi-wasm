...
pub struct ZeroTrustAccessGroupExclude {
    ...
    pub r#auth_contexts: Box<Option<Vec<super::types::ZeroTrustAccessGroupExcludeAuthContext>>>,
    ...
    #[builder(into, default)]
    #[serde(rename = "azures")]
    pub r#azures: Box<Option<Vec<super::types::ZeroTrustAccessGroupExcludeAzure>>>,
    ...
    pub r#external_evaluations: Box<Option<Vec<super::types::ZeroTrustAccessGroupExcludeExternalEvaluation>>>,
    ...
    pub r#githubs: Box<Option<Vec<super::types::ZeroTrustAccessGroupExcludeGithub>>>,
    ...
    pub r#gsuites: Box<Option<Vec<super::types::ZeroTrustAccessGroupExcludeGsuite>>>,
    ...
    #[builder(into, default)]
    #[serde(rename = "oktas")]
    pub r#oktas: Box<Option<Vec<super::types::ZeroTrustAccessGroupExcludeOkta>>>,
    /// Matches a SAML group. Requires a SAML identity provider.
    #[builder(into, default)]
    #[serde(rename = "samls")]
    pub r#samls: Box<Option<Vec<super::types::ZeroTrustAccessGroupExcludeSaml>>>,
