...
pub struct ZeroTrustAccessGroupRequire {
    ...
    pub r#auth_contexts: Box<Option<Vec<super::types::ZeroTrustAccessGroupRequireAuthContext>>>,
    ...
    #[builder(into, default)]
    #[serde(rename = "azures")]
    pub r#azures: Box<Option<Vec<super::types::ZeroTrustAccessGroupRequireAzure>>>,
    ...
    pub r#external_evaluations: Box<Option<Vec<super::types::ZeroTrustAccessGroupRequireExternalEvaluation>>>,
    ...
    pub r#githubs: Box<Option<Vec<super::types::ZeroTrustAccessGroupRequireGithub>>>,
    ...
    pub r#gsuites: Box<Option<Vec<super::types::ZeroTrustAccessGroupRequireGsuite>>>,
    ...
    #[builder(into, default)]
    #[serde(rename = "oktas")]
    pub r#oktas: Box<Option<Vec<super::types::ZeroTrustAccessGroupRequireOkta>>>,
    /// Matches a SAML group. Requires a SAML identity provider.
    #[builder(into, default)]
    #[serde(rename = "samls")]
    pub r#samls: Box<Option<Vec<super::types::ZeroTrustAccessGroupRequireSaml>>>,
