...
pub struct ZeroTrustAccessPolicyInclude {
    ...
    pub r#auth_contexts: Box<Option<Vec<super::types::ZeroTrustAccessPolicyIncludeAuthContext>>>,
    ...
    #[builder(into, default)]
    #[serde(rename = "azures")]
    pub r#azures: Box<Option<Vec<super::types::ZeroTrustAccessPolicyIncludeAzure>>>,
    ...
    pub r#external_evaluations: Box<Option<Vec<super::types::ZeroTrustAccessPolicyIncludeExternalEvaluation>>>,
    ...
    pub r#githubs: Box<Option<Vec<super::types::ZeroTrustAccessPolicyIncludeGithub>>>,
    ...
    pub r#gsuites: Box<Option<Vec<super::types::ZeroTrustAccessPolicyIncludeGsuite>>>,
    ...
    #[builder(into, default)]
    #[serde(rename = "oktas")]
    pub r#oktas: Box<Option<Vec<super::types::ZeroTrustAccessPolicyIncludeOkta>>>,
    /// Matches a SAML group. Requires a SAML identity provider.
    #[builder(into, default)]
    #[serde(rename = "samls")]
    pub r#samls: Box<Option<Vec<super::types::ZeroTrustAccessPolicyIncludeSaml>>>,
