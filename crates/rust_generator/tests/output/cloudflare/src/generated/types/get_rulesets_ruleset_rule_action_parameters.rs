...
pub struct GetRulesetsRulesetRuleActionParameters {
    ...
    pub r#autominifies: Box<Option<Vec<super::types::GetRulesetsRulesetRuleActionParametersAutominify>>>,
    ...
    pub r#headers: Box<Option<Vec<super::types::GetRulesetsRulesetRuleActionParametersHeader>>>,
    ...
    pub r#responses: Box<Option<Vec<super::types::GetRulesetsRulesetRuleActionParametersResponse>>>,
