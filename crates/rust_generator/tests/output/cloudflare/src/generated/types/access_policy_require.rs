...
pub struct AccessPolicyRequire {
    ...
    pub r#auth_contexts: Box<Option<Vec<super::types::AccessPolicyRequireAuthContext>>>,
    ...
    #[builder(into, default)]
    #[serde(rename = "azures")]
    pub r#azures: Box<Option<Vec<super::types::AccessPolicyRequireAzure>>>,
    ...
    pub r#githubs: Box<Option<Vec<super::types::AccessPolicyRequireGithub>>>,
    ...
    pub r#gsuites: Box<Option<Vec<super::types::AccessPolicyRequireGsuite>>>,
    ...
    #[builder(into, default)]
    #[serde(rename = "oktas")]
    pub r#oktas: Box<Option<Vec<super::types::AccessPolicyRequireOkta>>>,
    /// Matches a SAML group. Requires a SAML identity provider.
    #[builder(into, default)]
    #[serde(rename = "samls")]
    pub r#samls: Box<Option<Vec<super::types::AccessPolicyRequireSaml>>>,
