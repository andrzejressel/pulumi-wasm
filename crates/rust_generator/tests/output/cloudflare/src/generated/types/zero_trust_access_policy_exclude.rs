...
pub struct ZeroTrustAccessPolicyExclude {
    ...
    pub r#auth_contexts: Box<Option<Vec<super::types::ZeroTrustAccessPolicyExcludeAuthContext>>>,
    ...
    #[builder(into, default)]
    #[serde(rename = "azures")]
    pub r#azures: Box<Option<Vec<super::types::ZeroTrustAccessPolicyExcludeAzure>>>,
    ...
    pub r#external_evaluations: Box<Option<Vec<super::types::ZeroTrustAccessPolicyExcludeExternalEvaluation>>>,
    ...
    pub r#githubs: Box<Option<Vec<super::types::ZeroTrustAccessPolicyExcludeGithub>>>,
    ...
    pub r#gsuites: Box<Option<Vec<super::types::ZeroTrustAccessPolicyExcludeGsuite>>>,
    ...
    #[builder(into, default)]
    #[serde(rename = "oktas")]
    pub r#oktas: Box<Option<Vec<super::types::ZeroTrustAccessPolicyExcludeOkta>>>,
    /// Matches a SAML group. Requires a SAML identity provider.
    #[builder(into, default)]
    #[serde(rename = "samls")]
    pub r#samls: Box<Option<Vec<super::types::ZeroTrustAccessPolicyExcludeSaml>>>,
