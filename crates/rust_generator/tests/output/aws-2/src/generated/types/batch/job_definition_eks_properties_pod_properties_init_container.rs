...
pub struct JobDefinitionEksPropertiesPodPropertiesInitContainer {
    ...
    #[builder(into, default)]
    #[serde(rename = "envs")]
    pub r#envs: Box<Option<Vec<super::super::types::batch::JobDefinitionEksPropertiesPodPropertiesInitContainerEnv>>>,
    ...
    pub r#volume_mounts: Box<Option<Vec<super::super::types::batch::JobDefinitionEksPropertiesPodPropertiesInitContainerVolumeMount>>>,
}
