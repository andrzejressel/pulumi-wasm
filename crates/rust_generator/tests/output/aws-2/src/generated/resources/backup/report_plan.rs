...
pub mod report_plan {
    ...
    pub fn create(
        ...
        let report_delivery_channel_binding_1 = args
            .report_delivery_channel
            .get_output(context);
        let report_delivery_channel_binding = report_delivery_channel_binding_1
            .get_inner();
        let report_setting_binding_1 = args.report_setting.get_output(context);
        let report_setting_binding = report_setting_binding_1.get_inner();
