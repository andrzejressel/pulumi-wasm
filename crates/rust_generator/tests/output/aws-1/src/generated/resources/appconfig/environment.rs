...
pub mod environment {
    ...
    pub fn create(
        ...
        let monitors_binding_1 = args.monitors.get_output(context);
        let monitors_binding = monitors_binding_1.get_inner();
        ...
        EnvironmentResult {
            ...
            monitors: pulumi_gestalt_rust::__private::into_domain(
