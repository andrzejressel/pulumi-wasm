...
pub struct ClusterNodePoolNetworkConfig {
    ...
    pub r#additional_node_network_configs: Box<Option<Vec<super::super::types::container::ClusterNodePoolNetworkConfigAdditionalNodeNetworkConfig>>>,
    /// We specify the additional pod networks for this node pool using this list. Each pod network corresponds to an additional alias IP range for the node
    #[builder(into, default)]
    #[serde(rename = "additionalPodNetworkConfigs")]
    pub r#additional_pod_network_configs: Box<Option<Vec<super::super::types::container::ClusterNodePoolNetworkConfigAdditionalPodNetworkConfig>>>,
