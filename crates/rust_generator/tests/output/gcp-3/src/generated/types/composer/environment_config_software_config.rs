...
pub struct EnvironmentConfigSoftwareConfig {
    ...
    pub r#airflow_config_overrides: Box<Option<std::collections::HashMap<String, String>>>,
    ...
    pub r#env_variables: Box<Option<std::collections::HashMap<String, String>>>,
    ...
    pub r#pypi_packages: Box<Option<std::collections::HashMap<String, String>>>,
