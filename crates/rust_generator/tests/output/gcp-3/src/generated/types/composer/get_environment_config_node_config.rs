...
pub struct GetEnvironmentConfigNodeConfig {
    ...
    pub r#composer_internal_ipv_4_cidr_block: Box<String>,
    ...
    pub r#composer_network_attachment: Box<String>,
    ...
    pub r#enable_ip_masq_agent: Box<bool>,
    /// Configuration for controlling how IPs are allocated in the GKE cluster. Cannot be updated.
    #[builder(into)]
    #[serde(rename = "ipAllocationPolicies")]
    pub r#ip_allocation_policies: Box<Vec<super::super::types::composer::GetEnvironmentConfigNodeConfigIpAllocationPolicy>>,
