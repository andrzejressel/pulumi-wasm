...
pub struct ClusterNodePoolNodeConfig {
    ...
    pub r#effective_taints: Box<Option<Vec<super::super::types::container::ClusterNodePoolNodeConfigEffectiveTaint>>>,
    ...
    pub r#guest_accelerators: Box<Option<Vec<super::super::types::container::ClusterNodePoolNodeConfigGuestAccelerator>>>,
    ...
    pub r#secondary_boot_disks: Box<Option<Vec<super::super::types::container::ClusterNodePoolNodeConfigSecondaryBootDisk>>>,
    ...
    #[builder(into, default)]
    #[serde(rename = "taints")]
    pub r#taints: Box<Option<Vec<super::super::types::container::ClusterNodePoolNodeConfigTaint>>>,
