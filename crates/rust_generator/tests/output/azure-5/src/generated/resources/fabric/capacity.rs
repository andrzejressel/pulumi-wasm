...
pub mod capacity {
    ...
    pub fn create(
        ...
        let administration_members_binding_1 = args
            .administration_members
            .get_output(context);
        let administration_members_binding = administration_members_binding_1
            .get_inner();
        ...
        CapacityResult {
            administration_members: pulumi_gestalt_rust::__private::into_domain(
