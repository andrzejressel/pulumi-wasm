...
pub mod workgroup {
    ...
    pub struct WorkgroupArgs {
        ...
        pub base_capacity: pulumi_wasm_rust::InputOrOutput<Option<i32>>,
        /// An array of parameters to set for more control over a serverless database. See `Config Parameter` below.
        #[builder(into, default)]
        pub config_parameters: pulumi_wasm_rust::InputOrOutput<
            Option<
        ...
        #[builder(into, default)]
        pub max_capacity: pulumi_wasm_rust::InputOrOutput<Option<i32>>,
