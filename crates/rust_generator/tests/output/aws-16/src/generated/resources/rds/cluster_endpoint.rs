...
pub mod cluster_endpoint {
    ...
    pub fn create(
        ...
        let custom_endpoint_type_binding_1 = args
            .custom_endpoint_type
            .get_output(context);
        let custom_endpoint_type_binding = custom_endpoint_type_binding_1.get_inner();
        ...
        ClusterEndpointResult {
            ...
            custom_endpoint_type: pulumi_gestalt_rust::__private::into_domain(
