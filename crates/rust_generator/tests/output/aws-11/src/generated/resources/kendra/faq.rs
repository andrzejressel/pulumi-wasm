...
pub mod faq {
    ...
    pub fn create(
        ...
        let file_format_binding_1 = args.file_format.get_output(context);
        let file_format_binding = file_format_binding_1.get_inner();
        ...
        let s3_path_binding_1 = args.s3_path.get_output(context);
        let s3_path_binding = s3_path_binding_1.get_inner();
