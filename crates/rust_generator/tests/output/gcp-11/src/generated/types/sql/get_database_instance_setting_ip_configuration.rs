...
pub struct GetDatabaseInstanceSettingIpConfiguration {
    ...
    pub r#authorized_networks: Box<Vec<super::super::types::sql::GetDatabaseInstanceSettingIpConfigurationAuthorizedNetwork>>,
    ...
    pub r#psc_configs: Box<Vec<super::super::types::sql::GetDatabaseInstanceSettingIpConfigurationPscConfig>>,
