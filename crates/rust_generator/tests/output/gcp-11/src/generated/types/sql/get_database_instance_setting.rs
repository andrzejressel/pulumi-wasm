...
pub struct GetDatabaseInstanceSetting {
    ...
    pub r#active_directory_configs: Box<Vec<super::super::types::sql::GetDatabaseInstanceSettingActiveDirectoryConfig>>,
    #[builder(into)]
    #[serde(rename = "advancedMachineFeatures")]
    pub r#advanced_machine_features: Box<Vec<super::super::types::sql::GetDatabaseInstanceSettingAdvancedMachineFeature>>,
    ...
    pub r#backup_configurations: Box<Vec<super::super::types::sql::GetDatabaseInstanceSettingBackupConfiguration>>,
    ...
    pub r#data_cache_configs: Box<Vec<super::super::types::sql::GetDatabaseInstanceSettingDataCacheConfig>>,
    #[builder(into)]
    #[serde(rename = "databaseFlags")]
    pub r#database_flags: Box<Vec<super::super::types::sql::GetDatabaseInstanceSettingDatabaseFlag>>,
    ...
    pub r#deny_maintenance_periods: Box<Vec<super::super::types::sql::GetDatabaseInstanceSettingDenyMaintenancePeriod>>,
    ...
    pub r#insights_configs: Box<Vec<super::super::types::sql::GetDatabaseInstanceSettingInsightsConfig>>,
    #[builder(into)]
    #[serde(rename = "ipConfigurations")]
    pub r#ip_configurations: Box<Vec<super::super::types::sql::GetDatabaseInstanceSettingIpConfiguration>>,
    #[builder(into)]
    #[serde(rename = "locationPreferences")]
    pub r#location_preferences: Box<Vec<super::super::types::sql::GetDatabaseInstanceSettingLocationPreference>>,
    /// Declares a one-hour maintenance window when an Instance can automatically restart to apply updates. The maintenance window is specified in UTC time.
    #[builder(into)]
    #[serde(rename = "maintenanceWindows")]
    pub r#maintenance_windows: Box<Vec<super::super::types::sql::GetDatabaseInstanceSettingMaintenanceWindow>>,
    #[builder(into)]
    #[serde(rename = "passwordValidationPolicies")]
    pub r#password_validation_policies: Box<Vec<super::super::types::sql::GetDatabaseInstanceSettingPasswordValidationPolicy>>,
    ...
    pub r#sql_server_audit_configs: Box<Vec<super::super::types::sql::GetDatabaseInstanceSettingSqlServerAuditConfig>>,
