...
pub mod ai_feature_group {
    ...
    pub fn create(
        ...
        let big_query_binding_1 = args.big_query.get_output(context);
        let big_query_binding = big_query_binding_1.get_inner();
        ...
        AiFeatureGroupResult {
            big_query: pulumi_gestalt_rust::__private::into_domain(
