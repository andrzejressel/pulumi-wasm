...
pub mod entry_type {
    ...
    pub fn create(
        ...
        EntryTypeResult {
            ...
            entry_type_id: pulumi_gestalt_rust::__private::into_domain(
            ...
            required_aspects: pulumi_gestalt_rust::__private::into_domain(
                o.extract_field("requiredAspects"),
            ),
            system: pulumi_gestalt_rust::__private::into_domain(
                o.extract_field("system"),
            ),
            type_aliases: pulumi_gestalt_rust::__private::into_domain(
