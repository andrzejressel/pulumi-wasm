...
pub mod aspect_type {
    ...
    pub fn create(
        ...
        let aspect_type_id_binding_1 = args.aspect_type_id.get_output(context);
        let aspect_type_id_binding = aspect_type_id_binding_1.get_inner();
        ...
        let metadata_template_binding_1 = args.metadata_template.get_output(context);
        let metadata_template_binding = metadata_template_binding_1.get_inner();
        ...
        AspectTypeResult {
            ...
            metadata_template: pulumi_gestalt_rust::__private::into_domain(
                o.extract_field("metadataTemplate"),
            ),
