...
pub struct WorkflowTemplatePlacementManagedClusterConfigWorkerConfig {
    ...
    pub r#accelerators: Box<Option<Vec<super::super::types::dataproc::WorkflowTemplatePlacementManagedClusterConfigWorkerConfigAccelerator>>>,
    ...
    pub r#managed_group_configs: Box<Option<Vec<super::super::types::dataproc::WorkflowTemplatePlacementManagedClusterConfigWorkerConfigManagedGroupConfig>>>,
