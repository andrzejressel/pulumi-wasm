...
pub struct DomainDefaultSpaceSettingsJupyterLabAppSettings {
    ...
    pub r#code_repositories: Box<Option<Vec<super::super::types::sagemaker::DomainDefaultSpaceSettingsJupyterLabAppSettingsCodeRepository>>>,
    ...
    pub r#custom_images: Box<Option<Vec<super::super::types::sagemaker::DomainDefaultSpaceSettingsJupyterLabAppSettingsCustomImage>>>,
