...
pub mod resolver_config {
    ...
    pub fn create(
        ...
        let autodefined_reverse_flag_binding_1 = args
            .autodefined_reverse_flag
            .get_output(context);
        let autodefined_reverse_flag_binding = autodefined_reverse_flag_binding_1
            .get_inner();
        ...
        ResolverConfigResult {
            autodefined_reverse_flag: pulumi_gestalt_rust::__private::into_domain(
                o.extract_field("autodefinedReverseFlag"),
            ),
