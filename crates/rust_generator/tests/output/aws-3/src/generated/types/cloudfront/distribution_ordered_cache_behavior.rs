...
pub struct DistributionOrderedCacheBehavior {
    ...
    pub r#function_associations: Box<Option<Vec<super::super::types::cloudfront::DistributionOrderedCacheBehaviorFunctionAssociation>>>,
    /// A config block that triggers a lambda function with specific actions (maximum 4).
    #[builder(into, default)]
    #[serde(rename = "lambdaFunctionAssociations")]
    pub r#lambda_function_associations: Box<Option<Vec<super::super::types::cloudfront::DistributionOrderedCacheBehaviorLambdaFunctionAssociation>>>,
