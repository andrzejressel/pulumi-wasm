...
pub struct WebAclRuleStatementRateBasedStatementScopeDownStatementSizeConstraintStatement {
    ...
    pub r#text_transformations: Box<Vec<super::super::types::wafv2::WebAclRuleStatementRateBasedStatementScopeDownStatementSizeConstraintStatementTextTransformation>>,
}
