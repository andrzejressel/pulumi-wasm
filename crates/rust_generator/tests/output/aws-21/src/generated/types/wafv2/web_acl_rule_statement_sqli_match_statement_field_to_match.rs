...
pub struct WebAclRuleStatementSqliMatchStatementFieldToMatch {
    ...
    pub r#header_orders: Box<Option<Vec<super::super::types::wafv2::WebAclRuleStatementSqliMatchStatementFieldToMatchHeaderOrder>>>,
    /// Inspect the request headers. See `headers` below for details.
    #[builder(into, default)]
    #[serde(rename = "headers")]
    pub r#headers: Box<Option<Vec<super::super::types::wafv2::WebAclRuleStatementSqliMatchStatementFieldToMatchHeader>>>,
