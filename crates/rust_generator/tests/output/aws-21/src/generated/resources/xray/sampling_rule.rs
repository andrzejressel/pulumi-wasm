...
pub mod sampling_rule {
    ...
    pub struct SamplingRuleArgs {
        ...
        #[builder(into)]
        pub fixed_rate: pulumi_wasm_rust::InputOrOutput<f64>,
        ...
        #[builder(into)]
        pub reservoir_size: pulumi_wasm_rust::InputOrOutput<i32>,
        ...
        #[builder(into)]
        pub service_type: pulumi_wasm_rust::InputOrOutput<String>,
        ...
        #[builder(into)]
        pub url_path: pulumi_wasm_rust::InputOrOutput<String>,
        /// The version of the sampling rule format (`1` )
        #[builder(into)]
        pub version: pulumi_wasm_rust::InputOrOutput<i32>,
    }
    #[allow(dead_code)]
