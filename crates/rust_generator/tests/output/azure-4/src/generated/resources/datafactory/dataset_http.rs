...
pub mod dataset_http {
    ...
    pub fn create(
        ...
        let relative_url_binding = args.relative_url.get_output(context).get_inner();
        let request_body_binding = args.request_body.get_output(context).get_inner();
        let request_method_binding = args.request_method.get_output(context).get_inner();
