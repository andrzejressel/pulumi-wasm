...
pub mod trigger_blob_event {
    ...
    pub fn create(
        ...
        let blob_path_begins_with_binding_1 = args
            .blob_path_begins_with
            .get_output(context);
        let blob_path_begins_with_binding = blob_path_begins_with_binding_1.get_inner();
        let blob_path_ends_with_binding_1 = args.blob_path_ends_with.get_output(context);
        let blob_path_ends_with_binding = blob_path_ends_with_binding_1.get_inner();
        ...
        let ignore_empty_blobs_binding_1 = args.ignore_empty_blobs.get_output(context);
        let ignore_empty_blobs_binding = ignore_empty_blobs_binding_1.get_inner();
