...
pub mod attestor_iam_binding {
    ...
    pub fn create(
        ...
        let attestor_binding_1 = args.attestor.get_output(context);
        let attestor_binding = attestor_binding_1.get_inner();
        ...
        AttestorIamBindingResult {
            attestor: pulumi_gestalt_rust::__private::into_domain(
