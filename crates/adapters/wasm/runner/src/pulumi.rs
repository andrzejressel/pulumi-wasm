...
use log::info;
use prost::Message;
use pulumi_gestalt_core_grpc::pulumi_state::PulumiState;
use pulumi_gestalt_core_proto::grpc::ResourceInvokeRequest;
use pulumi_gestalt_adapter_wasm_wit::bindings_runner as runner;
