    ...
    pub mod component {
        pub mod pulumi_gestalt {
            ...
            pub mod pulumi_engine {
                ...
                unsafe impl _rt::WasmResource for Engine {
                    ...
                    unsafe fn drop(_handle: u32) {
                        ...
                        {
                            #[link(
                                wasm_import_module = "[export]component:pulumi-gestalt/pulumi-engine@25.2.21-f32b1b7"
                            )]
                            extern "C" {
                ...
                #[doc(hidden)]
                macro_rules! __export_component_pulumi_gestalt_pulumi_engine_25_2_21_f32b1b7_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[export_name =
                        "component:pulumi-gestalt/pulumi-engine@25.2.21-f32b1b7#[constructor]engine"]
                        ...
                        "component:pulumi-gestalt/pulumi-engine@25.2.21-f32b1b7#[dtor]engine"]
                ...
                #[doc(hidden)]
                pub(crate) use __export_component_pulumi_gestalt_pulumi_engine_25_2_21_f32b1b7_cabi;
            }
            #[allow(dead_code, clippy::all)]
            pub mod output_interface {
                ...
                unsafe impl _rt::WasmResource for Output {
                    ...
                    unsafe fn drop(_handle: u32) {
                        ...
                        {
                            #[link(
                                wasm_import_module = "[export]component:pulumi-gestalt/output-interface@25.2.21-f32b1b7"
                            )]
                            extern "C" {
                ...
                #[doc(hidden)]
                macro_rules! __export_component_pulumi_gestalt_output_interface_25_2_21_f32b1b7_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[export_name =
                        "component:pulumi-gestalt/output-interface@25.2.21-f32b1b7#[constructor]output"]
                        ...
                        * mut u8, arg2 : usize, arg3 : i32,) -> i32 {
                        ...
                        #[export_name =
                        "component:pulumi-gestalt/output-interface@25.2.21-f32b1b7#[method]output.map"]
                        ...
                        "component:pulumi-gestalt/output-interface@25.2.21-f32b1b7#[method]output.clone"]
                        ...
                        "component:pulumi-gestalt/output-interface@25.2.21-f32b1b7#combine"]
                        unsafe extern "C" fn export_combine(arg0 : * mut u8, arg1 :
                        usize,) -> i32 { $($path_to_types)*:: _export_combine_cabi::<$ty
                        > (arg0, arg1) } #[export_name =
                        "component:pulumi-gestalt/output-interface@25.2.21-f32b1b7#[method]register-output.extract-field"]
                        unsafe extern "C" fn
                        ...
                        "component:pulumi-gestalt/output-interface@25.2.21-f32b1b7#[dtor]output"]
                        #[allow(non_snake_case)] unsafe extern "C" fn dtor(rep : * mut
                        u8) { $($path_to_types)*:: Output::dtor::< <$ty as
                        $($path_to_types)*:: Guest >::Output > (rep) } }; const _ : () =
                        { #[doc(hidden)] #[export_name =
                        "component:pulumi-gestalt/output-interface@25.2.21-f32b1b7#[dtor]register-output"]
                        #[allow(non_snake_case)] unsafe extern "C" fn dtor(rep : * mut
                ...
                #[doc(hidden)]
                pub(crate) use __export_component_pulumi_gestalt_output_interface_25_2_21_f32b1b7_cabi;
            }
            #[allow(dead_code, clippy::all)]
            pub mod register_interface {
                ...
                #[doc(hidden)]
                macro_rules! __export_component_pulumi_gestalt_register_interface_25_2_21_f32b1b7_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[export_name =
                        "component:pulumi-gestalt/register-interface@25.2.21-f32b1b7#register"]
                        ...
                        "component:pulumi-gestalt/register-interface@25.2.21-f32b1b7#invoke"]
                ...
                #[doc(hidden)]
                pub(crate) use __export_component_pulumi_gestalt_register_interface_25_2_21_f32b1b7_cabi;
            }
            #[allow(dead_code, clippy::all)]
            pub mod stack_interface {
                ...
                #[doc(hidden)]
                macro_rules! __export_component_pulumi_gestalt_stack_interface_25_2_21_f32b1b7_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[export_name =
                        "component:pulumi-gestalt/stack-interface@25.2.21-f32b1b7#add-export"]
                        ...
                        #[export_name =
                        "component:pulumi-gestalt/stack-interface@25.2.21-f32b1b7#finish"]
                        ...
                        "cabi_post_component:pulumi-gestalt/stack-interface@25.2.21-f32b1b7#finish"]
                        unsafe extern "C" fn _post_return_finish(arg0 : * mut u8,) {
                        $($path_to_types)*:: __post_return_finish::<$ty > (arg0) } };
                    };
                }
                #[doc(hidden)]
                pub(crate) use __export_component_pulumi_gestalt_stack_interface_25_2_21_f32b1b7_cabi;
                #[repr(align(4))]
...
macro_rules! __export_pulumi_gestalt_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*::
        exports::component::pulumi_gestalt::pulumi_engine::__export_component_pulumi_gestalt_pulumi_engine_25_2_21_f32b1b7_cabi!($ty
        with_types_in $($path_to_types_root)*::
        exports::component::pulumi_gestalt::pulumi_engine); $($path_to_types_root)*::
        exports::component::pulumi_gestalt::output_interface::__export_component_pulumi_gestalt_output_interface_25_2_21_f32b1b7_cabi!($ty
        with_types_in $($path_to_types_root)*::
        exports::component::pulumi_gestalt::output_interface); $($path_to_types_root)*::
        exports::component::pulumi_gestalt::register_interface::__export_component_pulumi_gestalt_register_interface_25_2_21_f32b1b7_cabi!($ty
        with_types_in $($path_to_types_root)*::
        exports::component::pulumi_gestalt::register_interface);
        $($path_to_types_root)*::
        exports::component::pulumi_gestalt::stack_interface::__export_component_pulumi_gestalt_stack_interface_25_2_21_f32b1b7_cabi!($ty
        with_types_in $($path_to_types_root)*::
...
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.36.0:component:pulumi-gestalt@25.2.21-f32b1b7:pulumi-gestalt:encoded world"]
#[doc(hidden)]
...
ructor]engine\x01\x02\x04\06component:pulumi-gestalt/pulumi-engine@25.2.21-f32b1\
b7\x05\x02\x02\x03\0\x02\x06engine\x01B\x13\x02\x03\x02\x01\x03\x04\0\x06engine\x03\
...
\x04\09component:pulumi-gestalt/output-interface@25.2.21-f32b1b7\x05\x04\x02\x03\
...
estalt/register-interface@25.2.21-f32b1b7\x05\x07\x01B\x11\x02\x03\x02\x01\x03\x04\
...
nish\x01\x0e\x04\08component:pulumi-gestalt/stack-interface@25.2.21-f32b1b7\x05\x08\
\x04\07component:pulumi-gestalt/pulumi-gestalt@25.2.21-f32b1b7\x04\0\x0b\x14\x01\
