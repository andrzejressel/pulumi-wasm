...
pub mod aspect_type {
    ...
    pub struct AspectTypeArgs {
        ...
        pub aspect_type_id: pulumi_wasm_rust::InputOrOutput<Option<String>>,
        ...
        #[builder(into, default)]
        pub metadata_template: pulumi_wasm_rust::InputOrOutput<Option<String>>,
    ...
    pub fn create(
        ...
        let metadata_template_binding = args
            .metadata_template
            .get_output(context)
            .get_inner();
