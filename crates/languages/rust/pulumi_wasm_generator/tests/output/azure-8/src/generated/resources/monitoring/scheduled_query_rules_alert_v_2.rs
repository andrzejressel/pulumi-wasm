...
pub mod scheduled_query_rules_alert_v_2 {
    ...
    pub struct ScheduledQueryRulesAlertV2Args {
        ...
        #[builder(into)]
        pub evaluation_frequency: pulumi_wasm_rust::InputOrOutput<String>,
        ...
        #[builder(into, default)]
        pub mute_actions_after_alert_duration: pulumi_wasm_rust::InputOrOutput<
            Option<String>,
        >,
        ...
        #[builder(into, default)]
        pub query_time_range_override: pulumi_wasm_rust::InputOrOutput<Option<String>>,
        ...
        #[builder(into, default)]
        pub target_resource_types: pulumi_wasm_rust::InputOrOutput<Option<Vec<String>>>,
        ...
        #[builder(into)]
        pub window_duration: pulumi_wasm_rust::InputOrOutput<String>,
        ...
        #[builder(into, default)]
        pub workspace_alerts_storage_enabled: pulumi_wasm_rust::InputOrOutput<
            Option<bool>,
        >,
    }
    #[allow(dead_code)]
