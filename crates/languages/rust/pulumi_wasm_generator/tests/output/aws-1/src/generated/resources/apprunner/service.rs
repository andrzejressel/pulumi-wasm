...
pub mod service {
    ...
    pub struct ServiceArgs {
        ...
        pub auto_scaling_configuration_arn: pulumi_wasm_rust::InputOrOutput<
            Option<String>,
        >,
        ...
        #[builder(into, default)]
        pub health_check_configuration: pulumi_wasm_rust::InputOrOutput<
        ...
        #[builder(into, default)]
        pub observability_configuration: pulumi_wasm_rust::InputOrOutput<
        ...
        #[builder(into)]
        pub source_configuration: pulumi_wasm_rust::InputOrOutput<
