...
pub mod thing_group_membership {
    ...
    pub struct ThingGroupMembershipArgs {
        ...
        pub override_dynamic_group: pulumi_wasm_rust::InputOrOutput<Option<bool>>,
        /// The name of the group to which you are adding a thing.
        #[builder(into)]
        pub thing_group_name: pulumi_wasm_rust::InputOrOutput<String>,
        /// The name of the thing to add to a group.
        #[builder(into)]
        pub thing_name: pulumi_wasm_rust::InputOrOutput<String>,
    }
    #[allow(dead_code)]
