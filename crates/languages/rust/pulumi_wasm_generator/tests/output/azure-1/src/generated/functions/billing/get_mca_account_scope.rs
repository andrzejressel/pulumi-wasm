pub mod get_mca_account_scope {
    ...
    pub struct GetMcaAccountScopeArgs {
        ...
        #[builder(into)]
        pub billing_profile_name: pulumi_wasm_rust::InputOrOutput<String>,
        /// The Invoice Section Name in the above Billing Profile.
        #[builder(into)]
        pub invoice_section_name: pulumi_wasm_rust::InputOrOutput<String>,
    }
    #[allow(dead_code)]
    ...
    pub fn invoke(
        ...
        let billing_account_name_binding = args
            ...
            .get_output(context)
            .get_inner();
        let billing_profile_name_binding = args
            .billing_profile_name
            .get_output(context)
            .get_inner();
        let invoice_section_name_binding = args
