...
pub mod endpoint_configuration {
    ...
    pub struct EndpointConfigurationArgs {
        ...
        pub async_inference_config: pulumi_wasm_rust::InputOrOutput<
            Option<
        ...
        #[builder(into, default)]
        pub data_capture_config: pulumi_wasm_rust::InputOrOutput<
            Option<
        ...
        #[builder(into)]
        pub production_variants: pulumi_wasm_rust::InputOrOutput<
        ...
        #[builder(into, default)]
        pub shadow_production_variants: pulumi_wasm_rust::InputOrOutput<
            Option<
                Vec<
