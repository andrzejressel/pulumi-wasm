...
pub mod resolver_firewall_rule {
    ...
    pub struct ResolverFirewallRuleArgs {
        ...
        pub block_override_dns_type: pulumi_wasm_rust::InputOrOutput<Option<String>>,
        /// The custom DNS record to send back in response to the query.
        #[builder(into, default)]
        pub block_override_domain: pulumi_wasm_rust::InputOrOutput<Option<String>>,
        /// The recommended amount of time, in seconds, for the DNS resolver or web browser to cache the provided override record. Minimum value of 0. Maximum value of 604800.
        #[builder(into, default)]
        pub block_override_ttl: pulumi_wasm_rust::InputOrOutput<Option<i32>>,
        /// The way that you want DNS Firewall to block the request. Valid values: `NODATA`, `NXDOMAIN`, `OVERRIDE`.
        #[builder(into, default)]
        pub block_response: pulumi_wasm_rust::InputOrOutput<Option<String>>,
        ...
        #[builder(into, default)]
        pub firewall_domain_redirection_action: pulumi_wasm_rust::InputOrOutput<
            Option<String>,
        >,
        ...
        #[builder(into, default)]
        pub q_type: pulumi_wasm_rust::InputOrOutput<Option<String>>,
    }
    #[allow(dead_code)]
