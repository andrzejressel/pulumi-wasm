...
pub mod notebook_instance {
    ...
    pub struct NotebookInstanceArgs {
        ...
        pub accelerator_types: pulumi_wasm_rust::InputOrOutput<Option<Vec<String>>>,
        /// An array of up to three Git repositories to associate with the notebook instance.
        /// These can be either the names of Git repositories stored as resources in your account, or the URL of Git repositories in [AWS CodeCommit](https://docs.aws.amazon.com/codecommit/latest/userguide/welcome.html) or in any other Git repository. These repositories are cloned at the same level as the default repository of your notebook instance.
        #[builder(into, default)]
        pub additional_code_repositories: pulumi_wasm_rust::InputOrOutput<
            Option<Vec<String>>,
        >,
        /// The Git repository associated with the notebook instance as its default code repository. This can be either the name of a Git repository stored as a resource in your account, or the URL of a Git repository in [AWS CodeCommit](https://docs.aws.amazon.com/codecommit/latest/userguide/welcome.html) or in any other Git repository.
        #[builder(into, default)]
        pub default_code_repository: pulumi_wasm_rust::InputOrOutput<Option<String>>,
        /// Set to `Disabled` to disable internet access to notebook. Requires `security_groups` and `subnet_id` to be set. Supported values: `Enabled` (Default) or `Disabled`. If set to `Disabled`, the notebook instance will be able to access resources only in your VPC, and will not be able to connect to Amazon SageMaker training and endpoint services unless your configure a NAT Gateway in your VPC.
        #[builder(into, default)]
        pub direct_internet_access: pulumi_wasm_rust::InputOrOutput<Option<String>>,
        ...
        #[builder(into, default)]
        pub instance_metadata_service_configuration: pulumi_wasm_rust::InputOrOutput<
            Option<
        ...
        #[builder(into, default)]
        pub lifecycle_config_name: pulumi_wasm_rust::InputOrOutput<Option<String>>,
        ...
        #[builder(into, default)]
        pub platform_identifier: pulumi_wasm_rust::InputOrOutput<Option<String>>,
        /// The ARN of the IAM role to be used by the notebook instance which allows SageMaker to call other services on your behalf.
        #[builder(into)]
        pub role_arn: pulumi_wasm_rust::InputOrOutput<String>,
        /// Whether root access is `Enabled` or `Disabled` for users of the notebook instance. The default value is `Enabled`.
        #[builder(into, default)]
        pub root_access: pulumi_wasm_rust::InputOrOutput<Option<String>>,
        ...
        #[builder(into, default)]
        pub volume_size: pulumi_wasm_rust::InputOrOutput<Option<i32>>,
    }
    #[allow(dead_code)]
