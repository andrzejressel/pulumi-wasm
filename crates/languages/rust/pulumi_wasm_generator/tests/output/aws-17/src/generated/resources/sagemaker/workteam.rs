...
pub mod workteam {
    ...
    pub struct WorkteamArgs {
        ...
        #[builder(into)]
        pub member_definitions: pulumi_wasm_rust::InputOrOutput<
            Vec<super::super::types::sagemaker::WorkteamMemberDefinition>,
        >,
        /// Configures notification of workers regarding available or expiring work items. see Notification Configuration details below.
        #[builder(into, default)]
        pub notification_configuration: pulumi_wasm_rust::InputOrOutput<
        ...
        #[builder(into, default)]
        pub worker_access_configuration: pulumi_wasm_rust::InputOrOutput<
            Option<super::super::types::sagemaker::WorkteamWorkerAccessConfiguration>,
        >,
        /// The name of the workforce.
        #[builder(into, default)]
        pub workforce_name: pulumi_wasm_rust::InputOrOutput<Option<String>>,
        /// The name of the Workteam (must be unique).
        #[builder(into)]
        pub workteam_name: pulumi_wasm_rust::InputOrOutput<String>,
    }
    #[allow(dead_code)]
    ...
    pub fn create(
        ...
        let member_definitions_binding = args
            .member_definitions
            .get_output(context)
            .get_inner();
        ...
        let workteam_name_binding = args.workteam_name.get_output(context).get_inner();
