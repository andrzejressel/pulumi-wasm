...
pub struct ClusterMasterInstanceFleetInstanceTypeConfig {
    ...
    pub r#configurations: Box<Option<Vec<super::super::types::emr::ClusterMasterInstanceFleetInstanceTypeConfigConfiguration>>>,
    /// Configuration block(s) for EBS volumes attached to each instance in the instance group. Detailed below.
    #[builder(into, default)]
    #[serde(rename = "ebsConfigs")]
    pub r#ebs_configs: Box<Option<Vec<super::super::types::emr::ClusterMasterInstanceFleetInstanceTypeConfigEbsConfig>>>,
