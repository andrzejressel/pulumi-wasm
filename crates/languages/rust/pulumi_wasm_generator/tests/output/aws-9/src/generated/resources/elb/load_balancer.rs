...
pub mod load_balancer {
    ...
    pub struct LoadBalancerArgs {
        ...
        #[builder(into, default)]
        pub connection_draining: pulumi_wasm_rust::InputOrOutput<Option<bool>>,
        /// The time in seconds to allow for connections to drain. Default: `300`
        #[builder(into, default)]
        pub connection_draining_timeout: pulumi_wasm_rust::InputOrOutput<Option<i32>>,
        /// Enable cross-zone load balancing. Default: `true`
        #[builder(into, default)]
        pub cross_zone_load_balancing: pulumi_wasm_rust::InputOrOutput<Option<bool>>,
        ...
        #[builder(into)]
        pub listeners: pulumi_wasm_rust::InputOrOutput<
        ...
        #[builder(into, default)]
        pub source_security_group: pulumi_wasm_rust::InputOrOutput<Option<String>>,
    ...
    pub struct LoadBalancerResult {
        ...
        /// Boolean to enable connection draining. Default: `false`
        pub connection_draining: pulumi_wasm_rust::Output<Option<bool>>,
        /// The time in seconds to allow for connections to drain. Default: `300`
        pub connection_draining_timeout: pulumi_wasm_rust::Output<Option<i32>>,
        /// Enable cross-zone load balancing. Default: `true`
        pub cross_zone_load_balancing: pulumi_wasm_rust::Output<Option<bool>>,
        /// Determines how the load balancer handles requests that might pose a security risk to an application due to HTTP desync. Valid values are `monitor`, `defensive` (default), `strictest`.
