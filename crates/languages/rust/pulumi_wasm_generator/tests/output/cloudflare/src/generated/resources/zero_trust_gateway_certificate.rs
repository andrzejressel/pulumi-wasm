...
pub mod zero_trust_gateway_certificate {
    ...
    pub struct ZeroTrustGatewayCertificateArgs {
        ...
        #[builder(into, default)]
        pub custom: pulumi_wasm_rust::InputOrOutput<Option<bool>>,
        /// The type of certificate (custom or Gateway-managed). Must provide only one of `custom`, `gateway_managed`.
        #[builder(into, default)]
        pub gateway_managed: pulumi_wasm_rust::InputOrOutput<Option<bool>>,
        ...
        #[builder(into, default)]
        pub validity_period_days: pulumi_wasm_rust::InputOrOutput<Option<i32>>,
    }
    #[allow(dead_code)]
