...
pub mod rate_limit {
    ...
    pub struct RateLimitArgs {
        ...
        #[builder(into)]
        pub action: pulumi_wasm_rust::InputOrOutput<super::types::RateLimitAction>,
        #[builder(into, default)]
        pub bypass_url_patterns: pulumi_wasm_rust::InputOrOutput<Option<Vec<String>>>,
        /// Determines how rate limiting is applied. By default if not specified, rate limiting applies to the clients IP address.
        #[builder(into, default)]
        pub correlate: pulumi_wasm_rust::InputOrOutput<
        ...
        #[builder(into)]
        pub period: pulumi_wasm_rust::InputOrOutput<i32>,
        /// The threshold that triggers the rate limit mitigations, combine with period.
        #[builder(into)]
        pub threshold: pulumi_wasm_rust::InputOrOutput<i32>,
