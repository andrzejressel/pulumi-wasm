...
pub mod backup {
    ...
    pub struct BackupArgs {
        ...
        #[builder(into, default)]
        pub source_volume: pulumi_wasm_rust::InputOrOutput<Option<String>>,
    ...
    pub struct BackupResult {
        ...
        pub backup_type: pulumi_wasm_rust::Output<String>,
        ...
        pub chain_storage_bytes: pulumi_wasm_rust::Output<String>,
        ...
        /// ID of volumes this backup belongs to. Format: `projects/{{projects_id}}/locations/{{location}}/volumes/{{name}}``
        pub source_volume: pulumi_wasm_rust::Output<Option<String>>,
        ...
        pub volume_usage_bytes: pulumi_wasm_rust::Output<String>,
    }
    ///
