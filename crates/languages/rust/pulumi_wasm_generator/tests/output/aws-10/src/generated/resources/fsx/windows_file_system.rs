...
pub mod windows_file_system {
    ...
    pub struct WindowsFileSystemArgs {
        ...
        pub active_directory_id: pulumi_wasm_rust::InputOrOutput<Option<String>>,
        ...
        #[builder(into, default)]
        pub audit_log_configuration: pulumi_wasm_rust::InputOrOutput<
        ...
        #[builder(into, default)]
        pub self_managed_active_directory: pulumi_wasm_rust::InputOrOutput<
