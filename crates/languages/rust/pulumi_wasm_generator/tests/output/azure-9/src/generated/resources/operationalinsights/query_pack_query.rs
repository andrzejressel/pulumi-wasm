...
pub mod query_pack_query {
    ...
    pub struct QueryPackQueryArgs {
        ...
        pub additional_settings_json: pulumi_wasm_rust::InputOrOutput<Option<String>>,
        ...
        #[builder(into)]
        pub query_pack_id: pulumi_wasm_rust::InputOrOutput<String>,
        ...
        #[builder(into, default)]
        pub resource_types: pulumi_wasm_rust::InputOrOutput<Option<Vec<String>>>,
        ...
        #[builder(into, default)]
        pub solutions: pulumi_wasm_rust::InputOrOutput<Option<Vec<String>>>,
