    ...
    pub mod component {
        pub mod pulumi_wasm {
            ...
            pub mod output_interface {
                ...
                unsafe impl _rt::WasmResource for Output {
                    ...
                    unsafe fn drop(_handle: u32) {
                        ...
                        {
                            #[link(
                                wasm_import_module = "[export]component:pulumi-wasm/output-interface@25.1.13-aed91f7"
                            )]
                            extern "C" {
                ...
                #[doc(hidden)]
                macro_rules! __export_component_pulumi_wasm_output_interface_25_1_13_aed91f7_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[export_name =
                        "component:pulumi-wasm/output-interface@25.1.13-aed91f7#[constructor]output"]
                        ...
                        "component:pulumi-wasm/output-interface@25.1.13-aed91f7#[method]output.map"]
                        ...
                        "component:pulumi-wasm/output-interface@25.1.13-aed91f7#combine"]
                        ...
                        "component:pulumi-wasm/output-interface@25.1.13-aed91f7#[dtor]output"]
                ...
                #[doc(hidden)]
                pub(crate) use __export_component_pulumi_wasm_output_interface_25_1_13_aed91f7_cabi;
            }
            #[allow(dead_code, clippy::all)]
            pub mod register_interface {
                ...
                #[doc(hidden)]
                macro_rules! __export_component_pulumi_wasm_register_interface_25_1_13_aed91f7_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[export_name =
                        "component:pulumi-wasm/register-interface@25.1.13-aed91f7#register"]
                        ...
                        "cabi_post_component:pulumi-wasm/register-interface@25.1.13-aed91f7#register"]
                        unsafe extern "C" fn _post_return_register(arg0 : * mut u8,) {
                        $($path_to_types)*:: __post_return_register::<$ty > (arg0) }
                        #[export_name =
                        "component:pulumi-wasm/register-interface@25.1.13-aed91f7#invoke"]
                        ...
                        * mut u8 { $($path_to_types)*:: _export_invoke_cabi::<$ty >
                        ...
                        "cabi_post_component:pulumi-wasm/register-interface@25.1.13-aed91f7#invoke"]
                        unsafe extern "C" fn _post_return_invoke(arg0 : * mut u8,) {
                        $($path_to_types)*:: __post_return_invoke::<$ty > (arg0) } };
                    };
                }
                #[doc(hidden)]
                pub(crate) use __export_component_pulumi_wasm_register_interface_25_1_13_aed91f7_cabi;
                #[repr(align(4))]
            ...
            pub mod stack_interface {
                ...
                #[doc(hidden)]
                macro_rules! __export_component_pulumi_wasm_stack_interface_25_1_13_aed91f7_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[export_name =
                        "component:pulumi-wasm/stack-interface@25.1.13-aed91f7#add-export"]
                        ...
                        #[export_name =
                        "component:pulumi-wasm/stack-interface@25.1.13-aed91f7#finish"]
                        unsafe extern "C" fn export_finish(arg0 : * mut u8, arg1 :
                        usize,) -> * mut u8 { $($path_to_types)*::
                        _export_finish_cabi::<$ty > (arg0, arg1) } #[export_name =
                        "cabi_post_component:pulumi-wasm/stack-interface@25.1.13-aed91f7#finish"]
                        unsafe extern "C" fn _post_return_finish(arg0 : * mut u8,) {
                        $($path_to_types)*:: __post_return_finish::<$ty > (arg0) } };
                    };
                }
                #[doc(hidden)]
                pub(crate) use __export_component_pulumi_wasm_stack_interface_25_1_13_aed91f7_cabi;
                #[repr(align(4))]
                struct _RetArea([::core::mem::MaybeUninit<u8>; 8]);
                static mut _RET_AREA: _RetArea = _RetArea(
                    [::core::mem::MaybeUninit::uninit(); 8],
...
macro_rules! __export_pulumi_wasm_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*::
        exports::component::pulumi_wasm::output_interface::__export_component_pulumi_wasm_output_interface_25_1_13_aed91f7_cabi!($ty
        with_types_in $($path_to_types_root)*::
        exports::component::pulumi_wasm::output_interface); $($path_to_types_root)*::
        exports::component::pulumi_wasm::register_interface::__export_component_pulumi_wasm_register_interface_25_1_13_aed91f7_cabi!($ty
        with_types_in $($path_to_types_root)*::
        exports::component::pulumi_wasm::register_interface); $($path_to_types_root)*::
        exports::component::pulumi_wasm::stack_interface::__export_component_pulumi_wasm_stack_interface_25_1_13_aed91f7_cabi!($ty
        with_types_in $($path_to_types_root)*::
...
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.36.0:component:pulumi-wasm@25.1.13-aed91f7:pulumi-wasm:encoded world"]
#[doc(hidden)]
...
\x06\x04\06component:pulumi-wasm/output-interface@25.1.13-aed91f7\x05\x02\x02\x03\
...
\0\x06invoke\x01\x19\x04\08component:pulumi-wasm/register-interface@25.1.13-aed9\
1f7\x05\x04\x01B\x0e\x02\x03\x02\x01\x03\x04\0\x06output\x03\0\0\x01i\x01\x01r\x03\
...
lumi-wasm/stack-interface@25.1.13-aed91f7\x05\x05\x01B\x02\x01@\x01\x0ain-previe\
...
25.1.13-aed91f7\x04\0\x0b\x11\x01\0\x0bpulumi-wasm\x03\0\0\0G\x09producers\x01\x0c\
