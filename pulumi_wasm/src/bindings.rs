    ...
    pub mod component {
        ...
        pub mod pulumi_wasm {
            ...
            pub mod output_interface {
                ...
                unsafe impl _rt::WasmResource for Output {
                    ...
                    unsafe fn drop(_handle: u32) {
                        ...
                        {
                            #[link(
                                wasm_import_module = "[export]component:pulumi-wasm/output-interface@0.0.0-NIGHTLY-8983ae0"
                            )]
                            extern "C" {
                ...
                #[doc(hidden)]
                macro_rules! __export_component_pulumi_wasm_output_interface_0_0_0_nightly_8983ae0_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[export_name =
                        "component:pulumi-wasm/output-interface@0.0.0-NIGHTLY-8983ae0#[constructor]output"]
                        ...
                        "component:pulumi-wasm/output-interface@0.0.0-NIGHTLY-8983ae0#[method]output.map"]
                        ...
                        "component:pulumi-wasm/output-interface@0.0.0-NIGHTLY-8983ae0#combine"]
                        ...
                        "component:pulumi-wasm/output-interface@0.0.0-NIGHTLY-8983ae0#[dtor]output"]
                ...
                #[doc(hidden)]
                pub(crate) use __export_component_pulumi_wasm_output_interface_0_0_0_nightly_8983ae0_cabi;
            }
            #[allow(dead_code, clippy::all)]
            pub mod register_interface {
                ...
                #[doc(hidden)]
                macro_rules! __export_component_pulumi_wasm_register_interface_0_0_0_nightly_8983ae0_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[export_name =
                        "component:pulumi-wasm/register-interface@0.0.0-NIGHTLY-8983ae0#register"]
                        ...
                        "cabi_post_component:pulumi-wasm/register-interface@0.0.0-NIGHTLY-8983ae0#register"]
                        unsafe extern "C" fn _post_return_register(arg0 : * mut u8,) {
                        $($path_to_types)*:: __post_return_register::<$ty > (arg0) }
                        #[export_name =
                        "component:pulumi-wasm/register-interface@0.0.0-NIGHTLY-8983ae0#invoke"]
                        ...
                        * mut u8 { $($path_to_types)*:: _export_invoke_cabi::<$ty >
                        ...
                        "cabi_post_component:pulumi-wasm/register-interface@0.0.0-NIGHTLY-8983ae0#invoke"]
                        unsafe extern "C" fn _post_return_invoke(arg0 : * mut u8,) {
                        $($path_to_types)*:: __post_return_invoke::<$ty > (arg0) } };
                    };
                }
                #[doc(hidden)]
                pub(crate) use __export_component_pulumi_wasm_register_interface_0_0_0_nightly_8983ae0_cabi;
                #[repr(align(4))]
            ...
            pub mod stack_interface {
                ...
                #[doc(hidden)]
                macro_rules! __export_component_pulumi_wasm_stack_interface_0_0_0_nightly_8983ae0_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[export_name =
                        "component:pulumi-wasm/stack-interface@0.0.0-NIGHTLY-8983ae0#add-export"]
                        ...
                        #[export_name =
                        "component:pulumi-wasm/stack-interface@0.0.0-NIGHTLY-8983ae0#finish"]
                        unsafe extern "C" fn export_finish(arg0 : * mut u8, arg1 :
                        usize,) -> * mut u8 { $($path_to_types)*::
                        _export_finish_cabi::<$ty > (arg0, arg1) } #[export_name =
                        "cabi_post_component:pulumi-wasm/stack-interface@0.0.0-NIGHTLY-8983ae0#finish"]
                        unsafe extern "C" fn _post_return_finish(arg0 : * mut u8,) {
                        $($path_to_types)*:: __post_return_finish::<$ty > (arg0) } };
                    };
                }
                #[doc(hidden)]
                pub(crate) use __export_component_pulumi_wasm_stack_interface_0_0_0_nightly_8983ae0_cabi;
                #[repr(align(4))]
                struct _RetArea([::core::mem::MaybeUninit<u8>; 8]);
                static mut _RET_AREA: _RetArea = _RetArea(
                    [::core::mem::MaybeUninit::uninit(); 8],
...
macro_rules! __export_pulumi_wasm_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*::
        exports::component::pulumi_wasm::output_interface::__export_component_pulumi_wasm_output_interface_0_0_0_nightly_8983ae0_cabi!($ty
        with_types_in $($path_to_types_root)*::
        exports::component::pulumi_wasm::output_interface); $($path_to_types_root)*::
        exports::component::pulumi_wasm::register_interface::__export_component_pulumi_wasm_register_interface_0_0_0_nightly_8983ae0_cabi!($ty
        with_types_in $($path_to_types_root)*::
        exports::component::pulumi_wasm::register_interface); $($path_to_types_root)*::
        exports::component::pulumi_wasm::stack_interface::__export_component_pulumi_wasm_stack_interface_0_0_0_nightly_8983ae0_cabi!($ty
        with_types_in $($path_to_types_root)*::
...
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.35.0:component:pulumi-wasm@0.0.0-NIGHTLY-8983ae0:pulumi-wasm:encoded world"]
#[doc(hidden)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 1930] = *b"\
...
\x06\x04\0<component:pulumi-wasm/output-interface@0.0.0-NIGHTLY-8983ae0\x05\x02\x02\
\x03\0\x02\x06output\x01B\x1c\x02\x03\x02\x01\x03\x04\0\x06output\x03\0\0\x01h\x01\
...
\0\x17\x04\0\x06invoke\x01\x19\x04\0>component:pulumi-wasm/register-interface@0.\
0.0-NIGHTLY-8983ae0\x05\x04\x01B\x0e\x02\x03\x02\x01\x03\x04\0\x06output\x03\0\0\
\x01i\x01\x01r\x03\x02id\x02\x0bfunction-ids\x05values\x04\0\x1bfunction-invocat\
ion-request\x03\0\x03\x01h\x01\x01r\x02\x02id\x05\x05values\x04\0\x1afunction-in\
vocation-result\x03\0\x06\x01@\x02\x04names\x05value\x05\x01\0\x04\0\x0aadd-expo\
rt\x01\x08\x01p\x07\x01p\x04\x01@\x01\x09functions\x09\0\x0a\x04\0\x06finish\x01\
\x0b\x04\0;component:pulumi-wasm/stack-interface@0.0.0-NIGHTLY-8983ae0\x05\x05\x01\
B\x02\x01@\x01\x0ain-preview\x7f\x01\0\x04\0\x0eset-in-preview\x01\0\x04\0?compo\
nent:pulumi-wasm-external/pulumi-settings@0.0.0-STABLE-DEV\x05\x06\x04\07compone\
nt:pulumi-wasm/pulumi-wasm@0.0.0-NIGHTLY-8983ae0\x04\0\x0b\x11\x01\0\x0bpulumi-w\
asm\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0dwit-component\x070.220.0\x10\
