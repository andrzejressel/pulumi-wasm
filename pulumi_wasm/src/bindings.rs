...
pub mod exports {
          ...
          >(rep)
            ...
            pub mod register_interface {
                ...
                pub unsafe fn _export_invoke_cabi<T: Guest>(
                    ...
                    let len15 = vec15.len();
                    let layout15 =
                        _rt::alloc::Layout::from_size_align_unchecked(vec15.len() * 12, 4);
  ...
  ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {
    ...
    #[export_name = "component:pulumi-wasm/register-interface@0.0.0-DEV#invoke"]
    unsafe extern "C" fn export_invoke(arg0: *mut u8,arg1: usize,arg2: *mut u8,arg3: usize,arg4: *mut u8,arg5: usize,) -> *mut u8 {
      $($path_to_types)*::_export_invoke_cabi::<$ty>(arg0, arg1, arg2, arg3, arg4, arg5)
    }
    #[export_name = "cabi_post_component:pulumi-wasm/register-interface@0.0.0-DEV#invoke"]
  ...
  ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {
    ...
    ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {
      ...
      #[export_name = "component:pulumi-wasm-external/pulumi-settings@0.0.0-STABLE-DEV#set-in-preview"]
...
macro_rules! __export_pulumi_wasm_impl {
  ...
  $($path_to_types_root)*::exports::component::pulumi_wasm_external::pulumi_settings::__export_component_pulumi_wasm_external_pulumi_settings_0_0_0_stable_dev_cabi!($ty with_types_in $($path_to_types_root)*::exports::component::pulumi_wasm_external::pulumi_settings);
  )
}
#[doc(inline)]
