        ...
        pub mod log {
            ...
            pub fn log(content: &Content) {
                unsafe {
                    ...
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "component:pulumi-wasm/log@0.0.0-NIGHTLY-886e811")]
                    extern "C" {
                        #[link_name = "log"]
                        fn wit_import(
                            _: i32,
        ...
        pub mod external_world {
            ...
            pub fn is_in_preview() -> bool {
                unsafe {
                    #[cfg(target_arch = "wasm32")]
                    #[link(
                        wasm_import_module = "component:pulumi-wasm/external-world@0.0.0-NIGHTLY-886e811"
                    )]
                    extern "C" {
            ...
            pub mod output_interface {
                ...
                unsafe impl _rt::WasmResource for Output {
                    ...
                    unsafe fn drop(_handle: u32) {
                        ...
                        {
                            #[link(
                                wasm_import_module = "[export]component:pulumi-wasm/output-interface@0.0.0-NIGHTLY-886e811"
                            )]
                            extern "C" {
                ...
                macro_rules! __export_component_pulumi_wasm_output_interface_0_0_0_nightly_886e811_cabi{
  ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {

    #[export_name = "component:pulumi-wasm/output-interface@0.0.0-NIGHTLY-886e811#[constructor]output"]
    ...
    #[export_name = "component:pulumi-wasm/output-interface@0.0.0-NIGHTLY-886e811#[method]output.map"]
    ...
    #[export_name = "component:pulumi-wasm/output-interface@0.0.0-NIGHTLY-886e811#[method]output.duplicate"]
    ...
    #[export_name = "component:pulumi-wasm/output-interface@0.0.0-NIGHTLY-886e811#combine"]
    ...
    const _: () = {
      #[doc(hidden)]
      #[export_name = "component:pulumi-wasm/output-interface@0.0.0-NIGHTLY-886e811#[dtor]output"]
      #[allow(non_snake_case)]
      unsafe extern "C" fn dtor(rep: *mut u8) {
        ...
        >(rep)
                ...
                #[doc(hidden)]
                pub(crate) use __export_component_pulumi_wasm_output_interface_0_0_0_nightly_886e811_cabi;
            }
            ...
            pub mod register_interface {
                ...
                macro_rules! __export_component_pulumi_wasm_register_interface_0_0_0_nightly_886e811_cabi{
  ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {

    #[export_name = "component:pulumi-wasm/register-interface@0.0.0-NIGHTLY-886e811#register"]
    ...
    #[export_name = "cabi_post_component:pulumi-wasm/register-interface@0.0.0-NIGHTLY-886e811#register"]
    unsafe extern "C" fn _post_return_register(arg0: *mut u8,) {
      $($path_to_types)*::__post_return_register::<$ty>(arg0)
                ...
                #[doc(hidden)]
                pub(crate) use __export_component_pulumi_wasm_register_interface_0_0_0_nightly_886e811_cabi;
                #[repr(align(4))]
            ...
            pub mod stack_interface {
                ...
                macro_rules! __export_component_pulumi_wasm_stack_interface_0_0_0_nightly_886e811_cabi{
  ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {

    #[export_name = "component:pulumi-wasm/stack-interface@0.0.0-NIGHTLY-886e811#add-export"]
    ...
    #[export_name = "component:pulumi-wasm/stack-interface@0.0.0-NIGHTLY-886e811#finish"]
    unsafe extern "C" fn export_finish(arg0: *mut u8,arg1: usize,) -> *mut u8 {
      $($path_to_types)*::_export_finish_cabi::<$ty>(arg0, arg1)
    }
    #[export_name = "cabi_post_component:pulumi-wasm/stack-interface@0.0.0-NIGHTLY-886e811#finish"]
    unsafe extern "C" fn _post_return_finish(arg0: *mut u8,) {
      $($path_to_types)*::__post_return_finish::<$ty>(arg0)
                ...
                #[doc(hidden)]
                pub(crate) use __export_component_pulumi_wasm_stack_interface_0_0_0_nightly_886e811_cabi;
                #[repr(align(4))]
                struct _RetArea([::core::mem::MaybeUninit<u8>; 8]);
                static mut _RET_AREA: _RetArea = _RetArea([::core::mem::MaybeUninit::uninit(); 8]);
            }
...
macro_rules! __export_pulumi_wasm_impl {
  ...
  $($path_to_types_root)*::exports::component::pulumi_wasm::output_interface::__export_component_pulumi_wasm_output_interface_0_0_0_nightly_886e811_cabi!($ty with_types_in $($path_to_types_root)*::exports::component::pulumi_wasm::output_interface);
  $($path_to_types_root)*::exports::component::pulumi_wasm::register_interface::__export_component_pulumi_wasm_register_interface_0_0_0_nightly_886e811_cabi!($ty with_types_in $($path_to_types_root)*::exports::component::pulumi_wasm::register_interface);
  $($path_to_types_root)*::exports::component::pulumi_wasm::stack_interface::__export_component_pulumi_wasm_stack_interface_0_0_0_nightly_886e811_cabi!($ty with_types_in $($path_to_types_root)*::exports::component::pulumi_wasm::stack_interface);
  )
}
#[doc(inline)]
...
:pulumi-wasm/log@0.0.0-NIGHTLY-886e811\x05\0\x01B\x10\x01p}\x01r\x02\x09output-i\
...
886e811\x05\x01\x01B\x0c\x04\0\x06output\x03\x01\x01i\0\x01@\x01\x05values\0\x01\
...
combine\x01\x07\x04\x01<component:pulumi-wasm/output-interface@0.0.0-NIGHTLY-886\
e811\x05\x02\x02\x03\0\x02\x06output\x01B\x13\x02\x03\x02\x01\x03\x04\0\x06outpu\
...
mponent:pulumi-wasm/register-interface@0.0.0-NIGHTLY-886e811\x05\x04\x01B\x0e\x02\
...
terface@0.0.0-NIGHTLY-886e811\x05\x05\x04\x017component:pulumi-wasm/pulumi-wasm@\
0.0.0-NIGHTLY-886e811\x04\0\x0b\x11\x01\0\x0bpulumi-wasm\x03\0\0\0G\x09producers\
