    ...
    pub mod component {
        pub mod pulumi_wasm {
            ...
            pub mod pulumi_engine {
                ...
                unsafe impl _rt::WasmResource for Engine {
                    ...
                    unsafe fn drop(_handle: u32) {
                        ...
                        {
                            #[link(
                                wasm_import_module = "[export]component:pulumi-wasm/pulumi-engine@25.1.27-1db7e8e"
                            )]
                            extern "C" {
                ...
                #[doc(hidden)]
                macro_rules! __export_component_pulumi_wasm_pulumi_engine_25_1_27_1db7e8e_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[export_name =
                        "component:pulumi-wasm/pulumi-engine@25.1.27-1db7e8e#[constructor]engine"]
                        ...
                        "component:pulumi-wasm/pulumi-engine@25.1.27-1db7e8e#[dtor]engine"]
                ...
                #[doc(hidden)]
                pub(crate) use __export_component_pulumi_wasm_pulumi_engine_25_1_27_1db7e8e_cabi;
            }
            #[allow(dead_code, clippy::all)]
            pub mod output_interface {
                ...
                unsafe impl _rt::WasmResource for Output {
                    ...
                    unsafe fn drop(_handle: u32) {
                        ...
                        {
                            #[link(
                                wasm_import_module = "[export]component:pulumi-wasm/output-interface@25.1.27-1db7e8e"
                            )]
                            extern "C" {
                ...
                #[doc(hidden)]
                macro_rules! __export_component_pulumi_wasm_output_interface_25_1_27_1db7e8e_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[export_name =
                        "component:pulumi-wasm/output-interface@25.1.27-1db7e8e#[constructor]output"]
                        ...
                        * mut u8, arg2 : usize, arg3 : i32,) -> i32 {
                        ...
                        #[export_name =
                        "component:pulumi-wasm/output-interface@25.1.27-1db7e8e#[method]output.map"]
                        ...
                        "component:pulumi-wasm/output-interface@25.1.27-1db7e8e#combine"]
                        unsafe extern "C" fn export_combine(arg0 : * mut u8, arg1 :
                        usize,) -> i32 { $($path_to_types)*:: _export_combine_cabi::<$ty
                        > (arg0, arg1) } #[export_name =
                        "component:pulumi-wasm/output-interface@25.1.27-1db7e8e#[method]register-output.extract-field"]
                        unsafe extern "C" fn
                        ...
                        "component:pulumi-wasm/output-interface@25.1.27-1db7e8e#[dtor]output"]
                        #[allow(non_snake_case)] unsafe extern "C" fn dtor(rep : * mut
                        u8) { $($path_to_types)*:: Output::dtor::< <$ty as
                        $($path_to_types)*:: Guest >::Output > (rep) } }; const _ : () =
                        { #[doc(hidden)] #[export_name =
                        "component:pulumi-wasm/output-interface@25.1.27-1db7e8e#[dtor]register-output"]
                        #[allow(non_snake_case)] unsafe extern "C" fn dtor(rep : * mut
                ...
                #[doc(hidden)]
                pub(crate) use __export_component_pulumi_wasm_output_interface_25_1_27_1db7e8e_cabi;
            }
            #[allow(dead_code, clippy::all)]
            pub mod register_interface {
                ...
                #[doc(hidden)]
                macro_rules! __export_component_pulumi_wasm_register_interface_25_1_27_1db7e8e_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[export_name =
                        "component:pulumi-wasm/register-interface@25.1.27-1db7e8e#register"]
                        ...
                        "component:pulumi-wasm/register-interface@25.1.27-1db7e8e#invoke"]
                ...
                #[doc(hidden)]
                pub(crate) use __export_component_pulumi_wasm_register_interface_25_1_27_1db7e8e_cabi;
            }
            #[allow(dead_code, clippy::all)]
            pub mod stack_interface {
                ...
                #[doc(hidden)]
                macro_rules! __export_component_pulumi_wasm_stack_interface_25_1_27_1db7e8e_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[export_name =
                        "component:pulumi-wasm/stack-interface@25.1.27-1db7e8e#add-export"]
                        ...
                        #[export_name =
                        "component:pulumi-wasm/stack-interface@25.1.27-1db7e8e#finish"]
                        ...
                        "cabi_post_component:pulumi-wasm/stack-interface@25.1.27-1db7e8e#finish"]
                        unsafe extern "C" fn _post_return_finish(arg0 : * mut u8,) {
                        $($path_to_types)*:: __post_return_finish::<$ty > (arg0) } };
                    };
                }
                #[doc(hidden)]
                pub(crate) use __export_component_pulumi_wasm_stack_interface_25_1_27_1db7e8e_cabi;
                #[repr(align(4))]
...
macro_rules! __export_pulumi_wasm_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*::
        exports::component::pulumi_wasm::pulumi_engine::__export_component_pulumi_wasm_pulumi_engine_25_1_27_1db7e8e_cabi!($ty
        with_types_in $($path_to_types_root)*::
        exports::component::pulumi_wasm::pulumi_engine); $($path_to_types_root)*::
        exports::component::pulumi_wasm::output_interface::__export_component_pulumi_wasm_output_interface_25_1_27_1db7e8e_cabi!($ty
        with_types_in $($path_to_types_root)*::
        exports::component::pulumi_wasm::output_interface); $($path_to_types_root)*::
        exports::component::pulumi_wasm::register_interface::__export_component_pulumi_wasm_register_interface_25_1_27_1db7e8e_cabi!($ty
        with_types_in $($path_to_types_root)*::
        exports::component::pulumi_wasm::register_interface); $($path_to_types_root)*::
        exports::component::pulumi_wasm::stack_interface::__export_component_pulumi_wasm_stack_interface_25_1_27_1db7e8e_cabi!($ty
        with_types_in $($path_to_types_root)*::
...
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.36.0:component:pulumi-wasm@25.1.27-1db7e8e:pulumi-wasm:encoded world"]
#[doc(hidden)]
...
]engine\x01\x02\x04\03component:pulumi-wasm/pulumi-engine@25.1.27-1db7e8e\x05\x02\
...
combine\x01\x0c\x04\06component:pulumi-wasm/output-interface@25.1.27-1db7e8e\x05\
...
nent:pulumi-wasm/register-interface@25.1.27-1db7e8e\x05\x07\x01B\x11\x02\x03\x02\
...
\0\x06finish\x01\x0e\x04\05component:pulumi-wasm/stack-interface@25.1.27-1db7e8e\
\x05\x08\x04\01component:pulumi-wasm/pulumi-wasm@25.1.27-1db7e8e\x04\0\x0b\x11\x01\
