        ...
        pub mod pulumi_wasm {
            ...
            pub mod output_interface {
                ...
                unsafe impl _rt::WasmResource for Output {
                    ...
                    unsafe fn drop(_handle: u32) {
                        ...
                        {
                            #[link(
                                wasm_import_module = "[export]component:pulumi-wasm/output-interface@0.0.0-NIGHTLY-769a1e8"
                            )]
                            extern "C" {
                ...
                #[doc(hidden)]
                macro_rules! __export_component_pulumi_wasm_output_interface_0_0_0_nightly_769a1e8_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[export_name =
                        "component:pulumi-wasm/output-interface@0.0.0-NIGHTLY-769a1e8#[constructor]output"]
                        ...
                        "component:pulumi-wasm/output-interface@0.0.0-NIGHTLY-769a1e8#[method]output.map"]
                        ...
                        "component:pulumi-wasm/output-interface@0.0.0-NIGHTLY-769a1e8#combine"]
                        ...
                        "component:pulumi-wasm/output-interface@0.0.0-NIGHTLY-769a1e8#[dtor]output"]
                ...
                #[doc(hidden)]
                pub(crate) use __export_component_pulumi_wasm_output_interface_0_0_0_nightly_769a1e8_cabi;
            }
            #[allow(dead_code, clippy::all)]
            pub mod register_interface {
                ...
                macro_rules! __export_component_pulumi_wasm_register_interface_0_0_0_nightly_769a1e8_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[export_name =
                        "component:pulumi-wasm/register-interface@0.0.0-NIGHTLY-769a1e8#register"]
                        ...
                        "cabi_post_component:pulumi-wasm/register-interface@0.0.0-NIGHTLY-769a1e8#register"]
                        unsafe extern "C" fn _post_return_register(arg0 : * mut u8,) {
                        $($path_to_types)*:: __post_return_register::<$ty > (arg0) } };
                    };
                }
                #[doc(hidden)]
                pub(crate) use __export_component_pulumi_wasm_register_interface_0_0_0_nightly_769a1e8_cabi;
                #[repr(align(4))]
            ...
            pub mod stack_interface {
                ...
                #[doc(hidden)]
                macro_rules! __export_component_pulumi_wasm_stack_interface_0_0_0_nightly_769a1e8_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[export_name =
                        "component:pulumi-wasm/stack-interface@0.0.0-NIGHTLY-769a1e8#add-export"]
                        ...
                        #[export_name =
                        "component:pulumi-wasm/stack-interface@0.0.0-NIGHTLY-769a1e8#finish"]
                        unsafe extern "C" fn export_finish(arg0 : * mut u8, arg1 :
                        usize,) -> * mut u8 { $($path_to_types)*::
                        _export_finish_cabi::<$ty > (arg0, arg1) } #[export_name =
                        "cabi_post_component:pulumi-wasm/stack-interface@0.0.0-NIGHTLY-769a1e8#finish"]
                        unsafe extern "C" fn _post_return_finish(arg0 : * mut u8,) {
                        $($path_to_types)*:: __post_return_finish::<$ty > (arg0) } };
                    };
                }
                #[doc(hidden)]
                pub(crate) use __export_component_pulumi_wasm_stack_interface_0_0_0_nightly_769a1e8_cabi;
                #[repr(align(4))]
                struct _RetArea([::core::mem::MaybeUninit<u8>; 8]);
                static mut _RET_AREA: _RetArea = _RetArea([::core::mem::MaybeUninit::uninit(); 8]);
            }
...
macro_rules! __export_pulumi_wasm_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*::
        exports::component::pulumi_wasm::output_interface::__export_component_pulumi_wasm_output_interface_0_0_0_nightly_769a1e8_cabi!($ty
        with_types_in $($path_to_types_root)*::
        exports::component::pulumi_wasm::output_interface); $($path_to_types_root)*::
        exports::component::pulumi_wasm::register_interface::__export_component_pulumi_wasm_register_interface_0_0_0_nightly_769a1e8_cabi!($ty
        with_types_in $($path_to_types_root)*::
        exports::component::pulumi_wasm::register_interface); $($path_to_types_root)*::
        exports::component::pulumi_wasm::stack_interface::__export_component_pulumi_wasm_stack_interface_0_0_0_nightly_769a1e8_cabi!($ty
        with_types_in $($path_to_types_root)*::
...
face@0.0.0-NIGHTLY-769a1e8\x05\x02\x02\x03\0\x02\x06output\x01B\x13\x02\x03\x02\x01\
...
\x11\x04\x01>component:pulumi-wasm/register-interface@0.0.0-NIGHTLY-769a1e8\x05\x04\
...
sm/stack-interface@0.0.0-NIGHTLY-769a1e8\x05\x05\x04\x017component:pulumi-wasm/p\
ulumi-wasm@0.0.0-NIGHTLY-769a1e8\x04\0\x0b\x11\x01\0\x0bpulumi-wasm\x03\0\0\0G\x09\
