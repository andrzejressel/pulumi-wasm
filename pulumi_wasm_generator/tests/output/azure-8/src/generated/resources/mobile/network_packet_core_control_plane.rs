...
pub mod network_packet_core_control_plane {
    ...
    pub fn create(
        ...
        let control_plane_access_name_binding = args
            ...
            .get_inner();
        let core_network_technology_binding = args.core_network_technology.get_inner();
        let identity_binding = args.identity.get_inner();
        let interoperability_settings_json_binding = args
            .interoperability_settings_json
            .get_inner();
        let local_diagnostics_access_binding = args.local_diagnostics_access.get_inner();
        let location_binding = args.location.get_inner();
        let name_binding = args.name.get_inner();
        let platform_binding = args.platform.get_inner();
        let resource_group_name_binding = args.resource_group_name.get_inner();
        let site_ids_binding = args.site_ids.get_inner();
        let sku_binding = args.sku.get_inner();
        let software_version_binding = args.software_version.get_inner();
