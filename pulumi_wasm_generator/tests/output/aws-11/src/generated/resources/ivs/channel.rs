...
pub mod channel {
    ...
    pub struct ChannelArgs {
        ...
        pub authorized: pulumi_wasm_rust::Output<Option<bool>>,
        /// Channel latency mode. Valid values: `NORMAL`, `LOW`.
        #[builder(into, default)]
        pub latency_mode: pulumi_wasm_rust::Output<Option<String>>,
        /// Channel name.
        #[builder(into, default)]
        pub name: pulumi_wasm_rust::Output<Option<String>>,
        /// Recording configuration ARN.
        #[builder(into, default)]
        pub recording_configuration_arn: pulumi_wasm_rust::Output<Option<String>>,
    ...
    pub fn create(name: &str, args: ChannelArgs) -> ChannelResult {
        ...
        let authorized_binding = args.authorized.get_inner();
        let latency_mode_binding = args.latency_mode.get_inner();
