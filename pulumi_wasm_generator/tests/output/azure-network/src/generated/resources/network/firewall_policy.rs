...
pub mod firewall_policy {
    ...
    pub fn create(name: &str, args: FirewallPolicyArgs) -> FirewallPolicyResult {
        ...
        let auto_learn_private_ranges_enabled_binding = args
            ...
            .get_inner();
        let base_policy_id_binding = args.base_policy_id.get_inner();
        let dns_binding = args.dns.get_inner();
        let explicit_proxy_binding = args.explicit_proxy.get_inner();
        let identity_binding = args.identity.get_inner();
        let insights_binding = args.insights.get_inner();
        let intrusion_detection_binding = args.intrusion_detection.get_inner();
        ...
        let sql_redirect_allowed_binding = args.sql_redirect_allowed.get_inner();
        let tags_binding = args.tags.get_inner();
        let threat_intelligence_allowlist_binding = args
            .threat_intelligence_allowlist
            .get_inner();
        let threat_intelligence_mode_binding = args.threat_intelligence_mode.get_inner();
        let tls_certificate_binding = args.tls_certificate.get_inner();
