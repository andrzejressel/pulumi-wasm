pub mod get_service {
    ...
    pub struct GetServiceArgs {
        ...
        #[builder(into, default)]
        pub reverse_dns_name: pulumi_wasm_rust::Output<Option<String>>,
        /// Prefix of the service (_e.g.,_ `com.amazonaws` in AWS Commercial, `cn.com.amazonaws` in AWS China).
        #[builder(into, default)]
        pub reverse_dns_prefix: pulumi_wasm_rust::Output<Option<String>>,
        ...
        #[builder(into, default)]
        pub service_id: pulumi_wasm_rust::Output<Option<String>>,
    }
    #[allow(dead_code)]
    ...
    pub fn invoke(args: GetServiceArgs) -> GetServiceResult {
        ...
        let reverse_dns_name_binding = args.reverse_dns_name.get_inner();
        let reverse_dns_prefix_binding = args.reverse_dns_prefix.get_inner();
