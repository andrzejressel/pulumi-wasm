...
pub mod studio_session_mapping {
    ...
    pub struct StudioSessionMappingArgs {
        ...
        #[builder(into, default)]
        pub identity_name: pulumi_wasm_rust::InputOrOutput<Option<String>>,
        /// Specifies whether the identity to map to the Amazon EMR Studio is a `USER` or a `GROUP`.
        #[builder(into)]
        pub identity_type: pulumi_wasm_rust::InputOrOutput<String>,
        /// The Amazon Resource Name (ARN) for the session policy that will be applied to the user or group. You should specify the ARN for the session policy that you want to apply, not the ARN of your user role.
        #[builder(into)]
        pub session_policy_arn: pulumi_wasm_rust::InputOrOutput<String>,
        /// The ID of the Amazon EMR Studio to which the user or group will be mapped.
        #[builder(into)]
        pub studio_id: pulumi_wasm_rust::InputOrOutput<String>,
    }
    #[allow(dead_code)]
