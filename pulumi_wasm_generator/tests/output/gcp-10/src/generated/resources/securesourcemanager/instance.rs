    ...
    pub fn create(name: &str, args: InstanceArgs) -> InstanceResult {
        ...
        InstanceResult {
            ...
            host_configs: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("hostConfigs").unwrap(),
            ),
            ...
            private_config: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("privateConfig").unwrap(),
            ),
