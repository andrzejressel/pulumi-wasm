...
pub mod logger {
    ...
    pub fn create(name: &str, args: LoggerArgs) -> LoggerResult {
        use pulumi_wasm_rust::__private::pulumi_wasm_wit::client_bindings::component::pulumi_wasm::register_interface;
        use std::collections::HashMap;
        let api_management_name_binding = args.api_management_name.get_inner();
        let application_insights_binding = args.application_insights.get_inner();
        let buffered_binding = args.buffered.get_inner();
        let description_binding = args.description.get_inner();
        let eventhub_binding = args.eventhub.get_inner();
