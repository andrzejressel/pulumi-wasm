...
pub mod spring_cloud_new_relic_application_performance_monitoring {
    ...
    pub fn create(
        ...
        let agent_enabled_binding = args.agent_enabled.get_inner();
        let app_name_binding = args.app_name.get_inner();
        let app_server_port_binding = args.app_server_port.get_inner();
        let audit_mode_enabled_binding = args.audit_mode_enabled.get_inner();
        let auto_app_naming_enabled_binding = args.auto_app_naming_enabled.get_inner();
        let auto_transaction_naming_enabled_binding = args
            .auto_transaction_naming_enabled
            .get_inner();
        let custom_tracing_enabled_binding = args.custom_tracing_enabled.get_inner();
        let globally_enabled_binding = args.globally_enabled.get_inner();
        let labels_binding = args.labels.get_inner();
        let license_key_binding = args.license_key.get_inner();
