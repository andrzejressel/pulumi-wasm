...
pub mod service_plan {
    ...
    pub struct ServicePlanArgs {
        ...
        #[builder(into, default)]
        pub per_site_scaling_enabled: pulumi_wasm_rust::InputOrOutput<Option<bool>>,
        ...
        #[builder(into, default)]
        pub worker_count: pulumi_wasm_rust::InputOrOutput<Option<i32>>,
        ...
        #[builder(into, default)]
        pub zone_balancing_enabled: pulumi_wasm_rust::InputOrOutput<Option<bool>>,
    }
    #[allow(dead_code)]
