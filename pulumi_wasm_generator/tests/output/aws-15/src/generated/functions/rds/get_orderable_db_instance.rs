pub mod get_orderable_db_instance {
    ...
    pub struct GetOrderableDbInstanceArgs {
        ...
        pub availability_zone_group: pulumi_wasm_rust::Output<Option<String>>,
        ...
        #[builder(into, default)]
        pub read_replica_capable: pulumi_wasm_rust::Output<Option<bool>>,
        ...
        #[builder(into, default)]
        pub supported_engine_modes: pulumi_wasm_rust::Output<Option<Vec<String>>>,
        /// Use to limit results to network types `IPV4` or `DUAL`.
        #[builder(into, default)]
        pub supported_network_types: pulumi_wasm_rust::Output<Option<Vec<String>>>,
        /// Whether to limit results to instances that support clusters.
        #[builder(into, default)]
        pub supports_clusters: pulumi_wasm_rust::Output<Option<bool>>,
        /// Enable this to ensure a DB instance supports Enhanced Monitoring at intervals from 1 to 60 seconds.
        #[builder(into, default)]
        pub supports_enhanced_monitoring: pulumi_wasm_rust::Output<Option<bool>>,
        ...
        #[builder(into, default)]
        pub supports_global_databases: pulumi_wasm_rust::Output<Option<bool>>,
        /// Enable this to ensure a DB instance supports IAM database authentication.
        #[builder(into, default)]
        pub supports_iam_database_authentication: pulumi_wasm_rust::Output<Option<bool>>,
        /// Enable this to ensure a DB instance supports provisioned IOPS.
        #[builder(into, default)]
        pub supports_iops: pulumi_wasm_rust::Output<Option<bool>>,
        /// Enable this to ensure a DB instance supports Kerberos Authentication.
        #[builder(into, default)]
        pub supports_kerberos_authentication: pulumi_wasm_rust::Output<Option<bool>>,
        /// Whether to limit results to instances that are multi-AZ capable.
        #[builder(into, default)]
        pub supports_multi_az: pulumi_wasm_rust::Output<Option<bool>>,
        /// Enable this to ensure a DB instance supports Performance Insights.
        #[builder(into, default)]
        pub supports_performance_insights: pulumi_wasm_rust::Output<Option<bool>>,
        ...
        #[builder(into, default)]
        pub supports_storage_autoscaling: pulumi_wasm_rust::Output<Option<bool>>,
        /// Enable this to ensure a DB instance supports encrypted storage.
        #[builder(into, default)]
        pub supports_storage_encryption: pulumi_wasm_rust::Output<Option<bool>>,
    ...
    pub fn invoke(args: GetOrderableDbInstanceArgs) -> GetOrderableDbInstanceResult {
        ...
        let availability_zone_group_binding = args.availability_zone_group.get_inner();
        let engine_binding = args.engine.get_inner();
        let engine_latest_version_binding = args.engine_latest_version.get_inner();
        ...
        let preferred_instance_classes_binding = args
            ...
            .get_inner();
        let read_replica_capable_binding = args.read_replica_capable.get_inner();
        let storage_type_binding = args.storage_type.get_inner();
        let supported_engine_modes_binding = args.supported_engine_modes.get_inner();
        let supported_network_types_binding = args.supported_network_types.get_inner();
        let supports_clusters_binding = args.supports_clusters.get_inner();
        ...
        let supports_iam_database_authentication_binding = args
            ...
            .get_inner();
        let supports_iops_binding = args.supports_iops.get_inner();
        let supports_kerberos_authentication_binding = args
            .supports_kerberos_authentication
            .get_inner();
        let supports_multi_az_binding = args.supports_multi_az.get_inner();
