...
pub mod folder {
    ...
    pub fn create(name: &str, args: FolderArgs) -> FolderResult {
        ...
        let folder_type_binding = args.folder_type.get_inner();
        let name_binding = args.name.get_inner();
        let parent_folder_arn_binding = args.parent_folder_arn.get_inner();
