...
pub mod smsvoicev_2_phone_number {
    ...
    pub struct Smsvoicev2PhoneNumberArgs {
        ...
        #[builder(into)]
        pub iso_country_code: pulumi_wasm_rust::InputOrOutput<String>,
        /// The type of message. Valid values are `TRANSACTIONAL` for messages that are critical or time-sensitive and `PROMOTIONAL` for messages that aren’t critical or time-sensitive.
        #[builder(into)]
        pub message_type: pulumi_wasm_rust::InputOrOutput<String>,
        /// Describes if the origination identity can be used for text messages, voice calls or both. valid values are `SMS` and `VOICE`.
        #[builder(into)]
        pub number_capabilities: pulumi_wasm_rust::InputOrOutput<Vec<String>>,
        /// The type of phone number to request. Possible values are `LONG_CODE`, `TOLL_FREE`, `TEN_DLC`, or `SIMULATOR`.
        #[builder(into)]
        pub number_type: pulumi_wasm_rust::InputOrOutput<String>,
        /// The name of the opt-out list to associate with the phone number.
        #[builder(into, default)]
        pub opt_out_list_name: pulumi_wasm_rust::InputOrOutput<Option<String>>,
        /// Use this field to attach your phone number for an external registration process.
        #[builder(into, default)]
        pub registration_id: pulumi_wasm_rust::InputOrOutput<Option<String>>,
        ...
        #[builder(into, default)]
        pub self_managed_opt_outs_enabled: pulumi_wasm_rust::InputOrOutput<Option<bool>>,
        #[builder(into, default)]
        ...
        #[builder(into, default)]
        pub two_way_channel_arn: pulumi_wasm_rust::InputOrOutput<Option<String>>,
        /// By default this is set to `false`. When set to `true` you can receive incoming text messages from your end recipients.
        #[builder(into, default)]
        pub two_way_channel_enabled: pulumi_wasm_rust::InputOrOutput<Option<bool>>,
    }
    #[allow(dead_code)]
