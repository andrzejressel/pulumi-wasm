...
pub mod sms_channel {
    ...
    pub fn create(name: &str, args: SmsChannelArgs) -> SmsChannelResult {
        use pulumi_wasm_rust::__private::pulumi_wasm_wit::client_bindings::component::pulumi_wasm::register_interface;
        use std::collections::HashMap;
        let application_id_binding = args.application_id.get_inner();
        let enabled_binding = args.enabled.get_inner();
        let sender_id_binding = args.sender_id.get_inner();
        let short_code_binding = args.short_code.get_inner();
