pub mod get_contact_flow {
    ...
    pub struct GetContactFlowArgs {
        ...
        pub contact_flow_id: pulumi_wasm_rust::Output<Option<String>>,
    ...
    pub fn invoke(args: GetContactFlowArgs) -> GetContactFlowResult {
        use pulumi_wasm_rust::__private::pulumi_wasm_wit::client_bindings::component::pulumi_wasm::register_interface;
        use std::collections::HashMap;
        let contact_flow_id_binding = args.contact_flow_id.get_inner();
