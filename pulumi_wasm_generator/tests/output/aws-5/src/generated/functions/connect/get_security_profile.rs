pub mod get_security_profile {
    ...
    pub struct GetSecurityProfileArgs {
        ...
        #[builder(into, default)]
        pub security_profile_id: pulumi_wasm_rust::Output<Option<String>>,
    ...
    pub fn invoke(args: GetSecurityProfileArgs) -> GetSecurityProfileResult {
        use pulumi_wasm_rust::__private::pulumi_wasm_wit::client_bindings::component::pulumi_wasm::register_interface;
        use std::collections::HashMap;
        let instance_id_binding = args.instance_id.get_inner();
        let name_binding = args.name.get_inner();
        let security_profile_id_binding = args.security_profile_id.get_inner();
