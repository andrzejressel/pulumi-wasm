...
pub mod proxy {
    ...
    pub struct ProxyArgs {
        ...
        #[builder(into, default)]
        pub idle_client_timeout: pulumi_wasm_rust::Output<Option<i32>>,
    ...
    pub fn create(name: &str, args: ProxyArgs) -> ProxyResult {
        use pulumi_wasm_rust::__private::pulumi_wasm_wit::client_bindings::component::pulumi_wasm::register_interface;
        use std::collections::HashMap;
        let auths_binding = args.auths.get_inner();
        let debug_logging_binding = args.debug_logging.get_inner();
        let engine_family_binding = args.engine_family.get_inner();
        let idle_client_timeout_binding = args.idle_client_timeout.get_inner();
