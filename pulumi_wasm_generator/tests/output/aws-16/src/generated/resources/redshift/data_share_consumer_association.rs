...
pub mod data_share_consumer_association {
    ...
    pub struct DataShareConsumerAssociationArgs {
        ...
        #[builder(into, default)]
        pub associate_entire_account: pulumi_wasm_rust::InputOrOutput<Option<bool>>,
        ...
        #[builder(into, default)]
        pub consumer_arn: pulumi_wasm_rust::InputOrOutput<Option<String>>,
        ...
        #[builder(into, default)]
        pub consumer_region: pulumi_wasm_rust::InputOrOutput<Option<String>>,
