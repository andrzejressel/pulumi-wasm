...
pub mod cluster {
    ...
    pub struct ClusterArgs {
        ...
        /// Always returns `auto`.
        #[builder(into, default)]
        pub aqua_configuration_status: pulumi_wasm_rust::Output<Option<String>>,
        ...
        #[builder(into, default)]
        pub cluster_parameter_group_name: pulumi_wasm_rust::Output<Option<String>>,
        /// The public key for the cluster
        #[builder(into, default)]
        pub cluster_public_key: pulumi_wasm_rust::Output<Option<String>>,
        /// The specific revision number of the database in the cluster
        #[builder(into, default)]
        pub cluster_revision_number: pulumi_wasm_rust::Output<Option<String>>,
        /// The name of a cluster subnet group to be associated with this cluster. If this parameter is not provided the resulting cluster will be deployed outside virtual private cloud (VPC).
        #[builder(into, default)]
        pub cluster_subnet_group_name: pulumi_wasm_rust::Output<Option<String>>,
        ...
        #[builder(into, default)]
        pub master_password_secret_kms_key_id: pulumi_wasm_rust::Output<Option<String>>,
    ...
    pub fn create(name: &str, args: ClusterArgs) -> ClusterResult {
        ...
        let allow_version_upgrade_binding = args.allow_version_upgrade.get_inner();
        ...
        let cluster_parameter_group_name_binding = args
            ...
            .get_inner();
        let cluster_public_key_binding = args.cluster_public_key.get_inner();
        let cluster_revision_number_binding = args.cluster_revision_number.get_inner();
        ...
        let maintenance_track_name_binding = args.maintenance_track_name.get_inner();
        let manage_master_password_binding = args.manage_master_password.get_inner();
        ...
        let snapshot_arn_binding = args.snapshot_arn.get_inner();
        let snapshot_cluster_identifier_binding = args
            .snapshot_cluster_identifier
            .get_inner();
        let snapshot_copy_binding = args.snapshot_copy.get_inner();
        ...
        let request = register_interface::RegisterResourceRequest {
            ...
            results: Vec::from([
                ...
                register_interface::ResultField {
                    name: "masterPasswordSecretArn".into(),
                },
                register_interface::ResultField {
                    name: "masterPasswordSecretKmsKeyId".into(),
                },
        ...
        ClusterResult {
            ...
            manage_master_password: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("manageMasterPassword").unwrap(),
            ),
            ...
            master_password_secret_arn: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("masterPasswordSecretArn").unwrap(),
            ),
            master_password_secret_kms_key_id: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("masterPasswordSecretKmsKeyId").unwrap(),
            ),
