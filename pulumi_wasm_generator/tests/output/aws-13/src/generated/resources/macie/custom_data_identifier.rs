...
pub mod custom_data_identifier {
    ...
    pub struct CustomDataIdentifierArgs {
        ...
        #[builder(into, default)]
        pub maximum_match_distance: pulumi_wasm_rust::Output<Option<i32>>,
    ...
    pub fn create(
        ...
        let ignore_words_binding = args.ignore_words.get_inner();
        let keywords_binding = args.keywords.get_inner();
        let maximum_match_distance_binding = args.maximum_match_distance.get_inner();
