...
pub struct ServiceTemplate {
    ...
    pub r#containers: Box<Option<Vec<super::super::types::cloudrunv2::ServiceTemplateContainer>>>,
    ...
    pub r#volumes: Box<Option<Vec<super::super::types::cloudrunv2::ServiceTemplateVolume>>>,
