...
pub mod job {
    ...
    pub fn create(name: &str, args: JobArgs) -> JobResult {
        ...
        let app_engine_http_target_binding = args.app_engine_http_target.get_inner();
        let attempt_deadline_binding = args.attempt_deadline.get_inner();
        let description_binding = args.description.get_inner();
        let http_target_binding = args.http_target.get_inner();
        let name_binding = args.name.get_inner();
        let paused_binding = args.paused.get_inner();
        let project_binding = args.project.get_inner();
        let pubsub_target_binding = args.pubsub_target.get_inner();
