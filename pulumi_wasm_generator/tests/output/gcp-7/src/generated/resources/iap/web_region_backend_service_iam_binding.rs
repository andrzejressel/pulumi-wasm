...
pub mod web_region_backend_service_iam_binding {
    ...
    pub struct WebRegionBackendServiceIamBindingArgs {
        ...
        #[builder(into)]
        pub web_region_backend_service: pulumi_wasm_rust::InputOrOutput<String>,
    }
    #[allow(dead_code)]
    pub struct WebRegionBackendServiceIamBindingResult {
        ...
        /// Used to find the parent resource to bind the IAM policy to
        pub web_region_backend_service: pulumi_wasm_rust::Output<String>,
    }
    ///
    ...
    pub fn create(
        ...
        WebRegionBackendServiceIamBindingResult {
            ...
            web_region_backend_service: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("webRegionBackendService").unwrap(),
            ),
        }
    }
}
