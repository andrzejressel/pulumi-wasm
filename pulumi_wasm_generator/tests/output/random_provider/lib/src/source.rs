...
mod random_bytes {
    ...
    fn random_bytes<'a>(args: RandomBytesArgs<'a>) -> RandomBytesResult {
        ...
        let result = RandomBytesResult {
            ...
            keepers: crate::random_to_domain_mapper::<std::collections::HashMap<String, String>>(result.keepers),
...
mod random_id {
    ...
    fn random_id<'a>(args: RandomIdArgs<'a>) -> RandomIdResult {
        ...
        let result = RandomIdResult {
            b64Std: crate::random_to_domain_mapper::<String>(result.b64_std),
            b64Url: crate::random_to_domain_mapper::<String>(result.b64_url),
...
mod random_integer {
    ...
    fn random_integer<'a>(args: RandomIntegerArgs<'a>) -> RandomIntegerResult {
        ...
        let result = RandomIntegerResult {
            ...
            seed: crate::random_to_domain_mapper::<String>(result.seed),
        };
...
mod random_password {
    ...
    fn random_password<'a>(args: RandomPasswordArgs<'a>) -> RandomPasswordResult {
        ...
        let result = RandomPasswordResult {
            bcryptHash: crate::random_to_domain_mapper::<String>(result.bcrypt_hash),
            keepers: crate::random_to_domain_mapper::<std::collections::HashMap<String, String>>(result.keepers),
            length: crate::random_to_domain_mapper::<i32>(result.length),
            lower: crate::random_to_domain_mapper::<bool>(result.lower),
            minLower: crate::random_to_domain_mapper::<i32>(result.min_lower),
            minNumeric: crate::random_to_domain_mapper::<i32>(result.min_numeric),
            minSpecial: crate::random_to_domain_mapper::<i32>(result.min_special),
            minUpper: crate::random_to_domain_mapper::<i32>(result.min_upper),
            number: crate::random_to_domain_mapper::<bool>(result.number),
            numeric: crate::random_to_domain_mapper::<bool>(result.numeric),
            overrideSpecial: crate::random_to_domain_mapper::<String>(result.override_special),
...
mod random_shuffle {
    ...
    fn random_shuffle<'a>(args: RandomShuffleArgs<'a>) -> RandomShuffleResult {
        ...
        let result = RandomShuffleResult {
            ...
            keepers: crate::random_to_domain_mapper::<std::collections::HashMap<String, String>>(result.keepers),
            resultCount: crate::random_to_domain_mapper::<i32>(result.result_count),
