...
pub struct OrchestratedVirtualMachineScaleSetExtension {
    ...
    pub r#auto_upgrade_minor_version_enabled: Box<Option<bool>>,
    ...
    pub r#extensions_to_provision_after_vm_creations: Box<Option<Vec<String>>>,
    ...
    pub r#failure_suppression_enabled: Box<Option<bool>>,
    /// A value which, when different to the previous value can be used to force-run the Extension even if the Extension Configuration hasn't changed.
    #[builder(into, default)]
    #[serde(rename = "forceExtensionExecutionOnChange")]
    pub r#force_extension_execution_on_change: Box<Option<String>>,
