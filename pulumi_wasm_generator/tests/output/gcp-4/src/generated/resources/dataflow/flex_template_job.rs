...
pub mod flex_template_job {
    ...
    pub struct FlexTemplateJobArgs {
        ...
        #[builder(into, default)]
        pub autoscaling_algorithm: pulumi_wasm_rust::Output<Option<String>>,
        ...
        #[builder(into, default)]
        pub launcher_machine_type: pulumi_wasm_rust::Output<Option<String>>,
        ...
        #[builder(into, default)]
        pub num_workers: pulumi_wasm_rust::Output<Option<i32>>,
        ...
        #[builder(into, default)]
        pub sdk_container_image: pulumi_wasm_rust::Output<Option<String>>,
        ...
        #[builder(into, default)]
        pub staging_location: pulumi_wasm_rust::Output<Option<String>>,
        /// The subnetwork to which VMs will be assigned. Should be of the form "regions/REGION/subnetworks/SUBNETWORK".
        #[builder(into, default)]
        pub subnetwork: pulumi_wasm_rust::Output<Option<String>>,
        /// The Cloud Storage path to use for temporary files. Must be a valid Cloud Storage URL, beginning with gs://.
        #[builder(into, default)]
        pub temp_location: pulumi_wasm_rust::Output<Option<String>>,
    ...
    pub fn create(name: &str, args: FlexTemplateJobArgs) -> FlexTemplateJobResult {
        use pulumi_wasm_rust::__private::pulumi_wasm_wit::client_bindings::component::pulumi_wasm::register_interface;
        use std::collections::HashMap;
        let additional_experiments_binding = args.additional_experiments.get_inner();
        let autoscaling_algorithm_binding = args.autoscaling_algorithm.get_inner();
        let container_spec_gcs_path_binding = args.container_spec_gcs_path.get_inner();
        ...
        let launcher_machine_type_binding = args.launcher_machine_type.get_inner();
        ...
        FlexTemplateJobResult {
            ...
            autoscaling_algorithm: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("autoscalingAlgorithm").unwrap(),
            ),
            container_spec_gcs_path: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("containerSpecGcsPath").unwrap(),
            ),
            ...
            launcher_machine_type: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("launcherMachineType").unwrap(),
            ),
            ...
            num_workers: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("numWorkers").unwrap(),
            ),
            ...
            sdk_container_image: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("sdkContainerImage").unwrap(),
            ),
            ...
            staging_location: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("stagingLocation").unwrap(),
            ),
            ...
            temp_location: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("tempLocation").unwrap(),
            ),
