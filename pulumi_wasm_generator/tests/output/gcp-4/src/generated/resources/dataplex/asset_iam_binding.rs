...
pub mod asset_iam_binding {
    ...
    pub fn create(name: &str, args: AssetIamBindingArgs) -> AssetIamBindingResult {
        use pulumi_wasm_rust::__private::pulumi_wasm_wit::client_bindings::component::pulumi_wasm::register_interface;
        use std::collections::HashMap;
        let asset_binding = args.asset.get_inner();
        ...
        AssetIamBindingResult {
            asset: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("asset").unwrap(),
            ),
