...
pub mod external_access_rule {
    ...
    pub fn create(name: &str, args: ExternalAccessRuleArgs) -> ExternalAccessRuleResult {
        use pulumi_wasm_rust::__private::pulumi_wasm_wit::client_bindings::component::pulumi_wasm::register_interface;
        use std::collections::HashMap;
        let action_binding = args.action.get_inner();
        let description_binding = args.description.get_inner();
        let destination_ip_ranges_binding = args.destination_ip_ranges.get_inner();
        let destination_ports_binding = args.destination_ports.get_inner();
        ...
        let source_ports_binding = args.source_ports.get_inner();
