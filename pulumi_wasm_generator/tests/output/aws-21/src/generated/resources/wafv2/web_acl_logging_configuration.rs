...
pub mod web_acl_logging_configuration {
    ...
    pub fn create(
        ...
        let log_destination_configs_binding = args.log_destination_configs.get_inner();
        let logging_filter_binding = args.logging_filter.get_inner();
        let redacted_fields_binding = args.redacted_fields.get_inner();
