...
pub mod analytics_workspace {
    ...
    pub fn create(name: &str, args: AnalyticsWorkspaceArgs) -> AnalyticsWorkspaceResult {
        use pulumi_wasm_rust::__private::pulumi_wasm_wit::client_bindings::component::pulumi_wasm::register_interface;
        use std::collections::HashMap;
        let allow_resource_only_permissions_binding = args
            .allow_resource_only_permissions
            .get_inner();
        let cmk_for_query_forced_binding = args.cmk_for_query_forced.get_inner();
        let daily_quota_gb_binding = args.daily_quota_gb.get_inner();
