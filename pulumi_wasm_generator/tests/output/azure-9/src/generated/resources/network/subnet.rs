...
pub mod subnet {
    ...
    pub fn create(name: &str, args: SubnetArgs) -> SubnetResult {
        ...
        let address_prefixes_binding = args.address_prefixes.get_inner();
        let default_outbound_access_enabled_binding = args
            .default_outbound_access_enabled
            .get_inner();
        let delegations_binding = args.delegations.get_inner();
        ...
        let service_endpoint_policy_ids_binding = args
            ...
            .get_inner();
        let service_endpoints_binding = args.service_endpoints.get_inner();
