...
pub mod autonomous_database {
    ...
    pub fn create(name: &str, args: AutonomousDatabaseArgs) -> AutonomousDatabaseResult {
        ...
        let backup_retention_period_in_days_binding = args
            ...
            .get_inner();
        let character_set_binding = args.character_set.get_inner();
        let compute_count_binding = args.compute_count.get_inner();
        let compute_model_binding = args.compute_model.get_inner();
        ...
        let db_version_binding = args.db_version.get_inner();
        let db_workload_binding = args.db_workload.get_inner();
        let display_name_binding = args.display_name.get_inner();
        let license_model_binding = args.license_model.get_inner();
        let location_binding = args.location.get_inner();
        let mtls_connection_required_binding = args.mtls_connection_required.get_inner();
        let name_binding = args.name.get_inner();
        let national_character_set_binding = args.national_character_set.get_inner();
