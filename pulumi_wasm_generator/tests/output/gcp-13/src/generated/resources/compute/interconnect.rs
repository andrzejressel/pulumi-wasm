...
pub mod interconnect {
    ...
    pub struct InterconnectArgs {
        ...
        #[builder(into, default)]
        pub customer_name: pulumi_wasm_rust::InputOrOutput<Option<String>>,
        ...
        /// - - -
        #[builder(into)]
        pub interconnect_type: pulumi_wasm_rust::InputOrOutput<String>,
        ...
        #[builder(into)]
        pub link_type: pulumi_wasm_rust::InputOrOutput<String>,
        ...
        /// federation.
        #[builder(into, default)]
        pub noc_contact_email: pulumi_wasm_rust::InputOrOutput<Option<String>>,
        ...
        #[builder(into, default)]
        pub remote_location: pulumi_wasm_rust::InputOrOutput<Option<String>>,
        ...
        #[builder(into, default)]
        pub requested_features: pulumi_wasm_rust::InputOrOutput<Option<Vec<String>>>,
        /// Target number of physical links in the link bundle, as requested by the customer.
        #[builder(into)]
        pub requested_link_count: pulumi_wasm_rust::InputOrOutput<i32>,
    }
    #[allow(dead_code)]
