...
pub mod external_vpn_gateway {
    ...
    pub fn create(name: &str, args: ExternalVpnGatewayArgs) -> ExternalVpnGatewayResult {
        use pulumi_wasm_rust::__private::pulumi_wasm_wit::client_bindings::component::pulumi_wasm::register_interface;
        use std::collections::HashMap;
        let description_binding = args.description.get_inner();
        let interfaces_binding = args.interfaces.get_inner();
        let labels_binding = args.labels.get_inner();
        let name_binding = args.name.get_inner();
        let project_binding = args.project.get_inner();
        let redundancy_type_binding = args.redundancy_type.get_inner();
