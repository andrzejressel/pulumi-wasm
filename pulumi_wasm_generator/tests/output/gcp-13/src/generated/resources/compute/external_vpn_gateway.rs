...
pub mod external_vpn_gateway {
    ...
    pub struct ExternalVpnGatewayArgs {
        ...
        #[builder(into, default)]
        pub interfaces: pulumi_wasm_rust::InputOrOutput<
        ...
        #[builder(into, default)]
        pub redundancy_type: pulumi_wasm_rust::InputOrOutput<Option<String>>,
    }
    #[allow(dead_code)]
    pub struct ExternalVpnGatewayResult {
        ...
        /// A list of interfaces on this external VPN gateway.
        /// Structure is documented below.
        pub interfaces: pulumi_wasm_rust::Output<
            Option<Vec<super::super::types::compute::ExternalVpnGatewayInterface>>,
        >,
        ...
        /// Indicates the redundancy type of this external VPN gateway
        /// Possible values are: `FOUR_IPS_REDUNDANCY`, `SINGLE_IP_INTERNALLY_REDUNDANT`, `TWO_IPS_REDUNDANCY`.
        pub redundancy_type: pulumi_wasm_rust::Output<Option<String>>,
    ...
    pub fn create(
        ...
        let interfaces_binding = args.interfaces.get_output(context).get_inner();
        let labels_binding = args.labels.get_output(context).get_inner();
        let name_binding = args.name.get_output(context).get_inner();
        let project_binding = args.project.get_output(context).get_inner();
        let redundancy_type_binding = args
            .redundancy_type
            .get_output(context)
            .get_inner();
        ...
        ExternalVpnGatewayResult {
            ...
            interfaces: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("interfaces").unwrap(),
            ),
            ...
            redundancy_type: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("redundancyType").unwrap(),
            ),
