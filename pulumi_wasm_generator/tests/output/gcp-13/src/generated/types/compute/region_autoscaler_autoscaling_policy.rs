...
pub struct RegionAutoscalerAutoscalingPolicy {
    ...
    pub r#metrics: Box<Option<Vec<super::super::types::compute::RegionAutoscalerAutoscalingPolicyMetric>>>,
    ...
    pub r#scaling_schedules: Box<Option<Vec<super::super::types::compute::RegionAutoscalerAutoscalingPolicyScalingSchedule>>>,
}
