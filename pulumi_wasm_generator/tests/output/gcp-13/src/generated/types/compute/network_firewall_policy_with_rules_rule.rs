...
pub struct NetworkFirewallPolicyWithRulesRule {
    ...
    #[builder(into)]
    #[serde(rename = "match")]
    pub r#match: Box<super::super::types::compute::NetworkFirewallPolicyWithRulesRuleMatch>,
    ...
    pub r#target_secure_tags: Box<Option<Vec<super::super::types::compute::NetworkFirewallPolicyWithRulesRuleTargetSecureTag>>>,
