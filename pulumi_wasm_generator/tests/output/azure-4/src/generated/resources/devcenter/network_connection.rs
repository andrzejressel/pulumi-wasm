...
pub mod network_connection {
    ...
    pub fn create(name: &str, args: NetworkConnectionArgs) -> NetworkConnectionResult {
        use pulumi_wasm_rust::__private::pulumi_wasm_wit::client_bindings::component::pulumi_wasm::register_interface;
        use std::collections::HashMap;
        let domain_join_type_binding = args.domain_join_type.get_inner();
        let domain_name_binding = args.domain_name.get_inner();
        let domain_password_binding = args.domain_password.get_inner();
        let domain_username_binding = args.domain_username.get_inner();
        let location_binding = args.location.get_inner();
        let name_binding = args.name.get_inner();
        let organization_unit_binding = args.organization_unit.get_inner();
