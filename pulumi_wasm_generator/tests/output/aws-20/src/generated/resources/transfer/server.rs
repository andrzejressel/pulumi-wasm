...
pub mod server {
    ...
    pub struct ServerArgs {
        ...
        #[builder(into, default)]
        pub sftp_authentication_methods: pulumi_wasm_rust::Output<Option<String>>,
    ...
    pub fn create(name: &str, args: ServerArgs) -> ServerResult {
        ...
        let endpoint_details_binding = args.endpoint_details.get_inner();
        ...
        let host_key_binding = args.host_key.get_inner();
        let identity_provider_type_binding = args.identity_provider_type.get_inner();
        let invocation_role_binding = args.invocation_role.get_inner();
        ...
        let pre_authentication_login_banner_binding = args
            ...
            .get_inner();
        let protocol_details_binding = args.protocol_details.get_inner();
        let protocols_binding = args.protocols.get_inner();
        let s3_storage_options_binding = args.s3_storage_options.get_inner();
        ...
        let workflow_details_binding = args.workflow_details.get_inner();
