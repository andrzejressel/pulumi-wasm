...
pub mod language_model {
    ...
    pub fn create(name: &str, args: LanguageModelArgs) -> LanguageModelResult {
        use pulumi_wasm_rust::__private::pulumi_wasm_wit::client_bindings::component::pulumi_wasm::register_interface;
        use std::collections::HashMap;
        let base_model_name_binding = args.base_model_name.get_inner();
        let input_data_config_binding = args.input_data_config.get_inner();
        let language_code_binding = args.language_code.get_inner();
        let model_name_binding = args.model_name.get_inner();
