...
pub mod v_2_models_slot {
    ...
    pub struct V2modelsSlotArgs {
        ...
        #[builder(into, default)]
        pub slot_type_id: pulumi_wasm_rust::Output<Option<String>>,
    ...
    pub fn create(name: &str, args: V2modelsSlotArgs) -> V2modelsSlotResult {
        ...
        let intent_id_binding = args.intent_id.get_inner();
        let locale_id_binding = args.locale_id.get_inner();
        let multiple_values_settings_binding = args.multiple_values_settings.get_inner();
        let name_binding = args.name.get_inner();
        let obfuscation_settings_binding = args.obfuscation_settings.get_inner();
        let slot_type_id_binding = args.slot_type_id.get_inner();
        let sub_slot_settings_binding = args.sub_slot_settings.get_inner();
