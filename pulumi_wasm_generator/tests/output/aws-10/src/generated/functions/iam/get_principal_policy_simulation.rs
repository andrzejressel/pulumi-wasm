pub mod get_principal_policy_simulation {
    ...
    pub struct GetPrincipalPolicySimulationArgs {
        ...
        #[builder(into)]
        pub action_names: pulumi_wasm_rust::InputOrOutput<Vec<String>>,
        ...
        pub additional_policies_jsons: pulumi_wasm_rust::InputOrOutput<
            Option<Vec<String>>,
        >,
        ...
        #[builder(into, default)]
        pub caller_arn: pulumi_wasm_rust::InputOrOutput<Option<String>>,
        ...
        #[builder(into, default)]
        pub contexts: pulumi_wasm_rust::InputOrOutput<
            Option<
        ...
        #[builder(into, default)]
        pub permissions_boundary_policies_jsons: pulumi_wasm_rust::InputOrOutput<
            Option<Vec<String>>,
        >,
        ...
        #[builder(into)]
        pub policy_source_arn: pulumi_wasm_rust::InputOrOutput<String>,
        ...
        #[builder(into, default)]
        pub resource_arns: pulumi_wasm_rust::InputOrOutput<Option<Vec<String>>>,
        ...
        #[builder(into, default)]
        pub resource_handling_option: pulumi_wasm_rust::InputOrOutput<Option<String>>,
        ...
        #[builder(into, default)]
        pub resource_owner_account_id: pulumi_wasm_rust::InputOrOutput<Option<String>>,
        ...
        #[builder(into, default)]
        pub resource_policy_json: pulumi_wasm_rust::InputOrOutput<Option<String>>,
    }
    #[allow(dead_code)]
