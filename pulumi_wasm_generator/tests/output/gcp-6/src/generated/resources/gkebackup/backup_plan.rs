...
pub mod backup_plan {
    ...
    pub struct BackupPlanArgs {
        ...
        #[builder(into, default)]
        pub deactivated: pulumi_wasm_rust::Output<Option<bool>>,
    ...
    pub fn create(name: &str, args: BackupPlanArgs) -> BackupPlanResult {
        ...
        let backup_schedule_binding = args.backup_schedule.get_inner();
        let cluster_binding = args.cluster.get_inner();
        let deactivated_binding = args.deactivated.get_inner();
