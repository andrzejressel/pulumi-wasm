...
pub mod snapshot {
    ...
    pub struct SnapshotResult {
        ...
        pub filesystem_used_bytes: pulumi_wasm_rust::Output<String>,
        /// The resource name of the filestore instance.
        ///
        ///
        /// - - -
    ...
    pub fn create(name: &str, args: SnapshotArgs) -> SnapshotResult {
        ...
        SnapshotResult {
            ...
            filesystem_used_bytes: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("filesystemUsedBytes").unwrap(),
            ),
