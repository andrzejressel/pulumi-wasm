...
pub mod object_copy {
    ...
    pub struct ObjectCopyArgs {
        ...
        #[builder(into, default)]
        pub copy_if_match: pulumi_wasm_rust::InputOrOutput<Option<String>>,
        ...
        #[builder(into, default)]
        pub copy_if_modified_since: pulumi_wasm_rust::InputOrOutput<Option<String>>,
        /// Copies the object if its entity tag (ETag) is different than the specified ETag.
        #[builder(into, default)]
        pub copy_if_none_match: pulumi_wasm_rust::InputOrOutput<Option<String>>,
        ...
        #[builder(into, default)]
        pub copy_if_unmodified_since: pulumi_wasm_rust::InputOrOutput<Option<String>>,
        /// Specifies the algorithm to use to when encrypting the object (for example, AES256).
        #[builder(into, default)]
        pub customer_algorithm: pulumi_wasm_rust::InputOrOutput<Option<String>>,
        /// Specifies the customer-provided encryption key for Amazon S3 to use in encrypting data. This value is used to store the object and then it is discarded; Amazon S3 does not store the encryption key. The key must be appropriate for use with the algorithm specified in the x-amz-server-side-encryption-customer-algorithm header.
        #[builder(into, default)]
        pub customer_key: pulumi_wasm_rust::InputOrOutput<Option<String>>,
        /// Specifies the 128-bit MD5 digest of the encryption key according to RFC 1321. Amazon S3 uses this header for a message integrity check to ensure that the encryption key was transmitted without error.
        #[builder(into, default)]
        pub customer_key_md5: pulumi_wasm_rust::InputOrOutput<Option<String>>,
        ...
        #[builder(into, default)]
        pub expected_source_bucket_owner: pulumi_wasm_rust::InputOrOutput<
            Option<String>,
        >,
        ...
        #[builder(into, default)]
        pub kms_encryption_context: pulumi_wasm_rust::InputOrOutput<Option<String>>,
        ...
        #[builder(into, default)]
        pub metadata_directive: pulumi_wasm_rust::InputOrOutput<Option<String>>,
        ...
        #[builder(into, default)]
        pub source_customer_algorithm: pulumi_wasm_rust::InputOrOutput<Option<String>>,
        /// Specifies the customer-provided encryption key for Amazon S3 to use to decrypt the source object. The encryption key provided in this header must be one that was used when the source object was created.
        #[builder(into, default)]
        pub source_customer_key: pulumi_wasm_rust::InputOrOutput<Option<String>>,
        /// Specifies the 128-bit MD5 digest of the encryption key according to RFC 1321. Amazon S3 uses this header for a message integrity check to ensure that the encryption key was transmitted without error.
        #[builder(into, default)]
        pub source_customer_key_md5: pulumi_wasm_rust::InputOrOutput<Option<String>>,
        ...
        #[builder(into, default)]
        pub tagging_directive: pulumi_wasm_rust::InputOrOutput<Option<String>>,
