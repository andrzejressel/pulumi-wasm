    ...
    pub fn create(
        ...
        let request = register_interface::RegisterResourceRequest {
            ...
            results: Vec::from([
                register_interface::ResultField {
                    name: "authorizationKeyPrimary".into(),
                },
                register_interface::ResultField {
                    name: "authorizationKeySecondary".into(),
                },
                register_interface::ResultField {
                    name: "description".into(),
                },
        ...
        IntegrationRuntimeSelfHostedResult {
            authorization_key_primary: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("authorizationKeyPrimary").unwrap(),
            ),
            authorization_key_secondary: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("authorizationKeySecondary").unwrap(),
            ),
