pub mod get_kubernetes_node_pool_snapshot {
    ...
    pub struct GetKubernetesNodePoolSnapshotResult {
        ...
        pub source_node_pool_id: pulumi_wasm_rust::Output<String>,
    ...
    pub fn invoke(
        ...
        GetKubernetesNodePoolSnapshotResult {
            ...
            source_node_pool_id: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("sourceNodePoolId").unwrap(),
            ),
