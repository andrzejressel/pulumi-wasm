...
pub struct JobTemplateInitContainer {
    ...
    #[builder(into, default)]
    #[serde(rename = "envs")]
    pub r#envs: Box<Option<Vec<super::super::types::containerapp::JobTemplateInitContainerEnv>>>,
    ...
    pub r#volume_mounts: Box<Option<Vec<super::super::types::containerapp::JobTemplateInitContainerVolumeMount>>>,
}
