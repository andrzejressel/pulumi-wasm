...
pub mod sql_container {
    ...
    pub fn create(name: &str, args: SqlContainerArgs) -> SqlContainerResult {
        ...
        let indexing_policy_binding = args.indexing_policy.get_inner();
        let name_binding = args.name.get_inner();
        let partition_key_kind_binding = args.partition_key_kind.get_inner();
        let partition_key_paths_binding = args.partition_key_paths.get_inner();
