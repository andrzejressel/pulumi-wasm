...
pub mod cassandra_datacenter {
    ...
    pub fn create(
        ...
        let base64_encoded_yaml_fragment_binding = args
            ...
            .get_inner();
        let cassandra_cluster_id_binding = args.cassandra_cluster_id.get_inner();
        let delegated_management_subnet_id_binding = args
            .delegated_management_subnet_id
            .get_inner();
        let disk_count_binding = args.disk_count.get_inner();
        let disk_sku_binding = args.disk_sku.get_inner();
