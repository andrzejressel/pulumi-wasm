pub mod get_event_integration {
    ...
    pub struct GetEventIntegrationResult {
        ...
        pub event_filters: pulumi_wasm_rust::Output<
            Vec<
    ...
    pub fn invoke(args: GetEventIntegrationArgs) -> GetEventIntegrationResult {
        ...
        GetEventIntegrationResult {
            ...
            event_filters: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("eventFilters").unwrap(),
            ),
