...
pub mod cluster {
    ...
    pub fn create(name: &str, args: ClusterArgs) -> ClusterResult {
        ...
        let acl_name_binding = args.acl_name.get_inner();
        let auto_minor_version_upgrade_binding = args
            .auto_minor_version_upgrade
            .get_inner();
        let data_tiering_binding = args.data_tiering.get_inner();
        ...
        let num_replicas_per_shard_binding = args.num_replicas_per_shard.get_inner();
