...
///                     .identifiers(vec!["timestream-influxdb.amazonaws.com",]). type
///                     ("Service").build_struct(),])
///                     .resources(vec!["${exampleBucketV2.arn}/*",]).build_struct(),
///                 ],
///             )
///             .build_struct(),
///     );
...
///         "exampleBucketV2",
///         BucketV2Args::builder().bucket("example-s3-bucket").build_struct(),
///     );
///     let exampleDbInstance = db_instance::create(
///         "exampleDbInstance",
///         DbInstanceArgs::builder()
...
///                 DbInstanceLogDeliveryConfiguration::builder()
///                     .s3Configuration(
///                         DbInstanceLogDeliveryConfigurationS3Configuration::builder()
...
///             .username("admin")
///             .vpc_security_group_ids(vec!["${exampleAwsSecurityGroup.id}",])
///             .vpc_subnet_ids(vec!["${exampleAwsSubnet.id}",])
///             .build_struct(),
///     );
/// }
/// ```
