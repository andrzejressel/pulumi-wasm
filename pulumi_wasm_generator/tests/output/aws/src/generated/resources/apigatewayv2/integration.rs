...
pub mod integration {
    ...
    pub fn create(name: &str, args: IntegrationArgs) -> IntegrationResult {
        ...
        let integration_method_binding = args.integration_method.get_inner();
        let integration_subtype_binding = args.integration_subtype.get_inner();
        let integration_type_binding = args.integration_type.get_inner();
        let integration_uri_binding = args.integration_uri.get_inner();
        let passthrough_behavior_binding = args.passthrough_behavior.get_inner();
        let payload_format_version_binding = args.payload_format_version.get_inner();
