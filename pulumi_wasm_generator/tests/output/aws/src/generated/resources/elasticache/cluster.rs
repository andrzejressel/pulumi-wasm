...
pub mod cluster {
    ...
    pub struct ClusterArgs {
        ...
        #[builder(into, default)]
        pub num_cache_nodes: pulumi_wasm_rust::Output<Option<i32>>,
        ...
        #[builder(into, default)]
        pub preferred_outpost_arn: pulumi_wasm_rust::Output<Option<String>>,
    ...
    pub fn create(name: &str, args: ClusterArgs) -> ClusterResult {
        ...
        let num_cache_nodes_binding = args.num_cache_nodes.get_inner();
        let outpost_mode_binding = args.outpost_mode.get_inner();
        ...
        let preferred_availability_zones_binding = args
            ...
            .get_inner();
        let preferred_outpost_arn_binding = args.preferred_outpost_arn.get_inner();
        ...
        ClusterResult {
            ...
            outpost_mode: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("outpostMode").unwrap(),
            ),
            ...
            preferred_availability_zones: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("preferredAvailabilityZones").unwrap(),
            ),
