...
pub mod topic {
    ...
    pub struct TopicArgs {
        ...
        #[builder(into, default)]
        pub signature_version: pulumi_wasm_rust::Output<Option<i32>>,
        /// IAM role for failure feedback
        #[builder(into, default)]
        ...
        #[builder(into, default)]
        pub tracing_config: pulumi_wasm_rust::Output<Option<String>>,
    }
    #[allow(dead_code)]
    ...
    pub fn create(name: &str, args: TopicArgs) -> TopicResult {
        ...
        let signature_version_binding = args.signature_version.get_inner();
