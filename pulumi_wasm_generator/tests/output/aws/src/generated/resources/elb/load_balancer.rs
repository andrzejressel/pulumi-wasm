...
pub mod load_balancer {
    ...
    pub struct LoadBalancerArgs {
        ...
        #[builder(into, default)]
        pub source_security_group: pulumi_wasm_rust::Output<Option<String>>,
    ...
    pub fn create(name: &str, args: LoadBalancerArgs) -> LoadBalancerResult {
        ...
        let connection_draining_binding = args.connection_draining.get_inner();
        ...
        let listeners_binding = args.listeners.get_inner();
        let name_binding = args.name.get_inner();
        let name_prefix_binding = args.name_prefix.get_inner();
        let security_groups_binding = args.security_groups.get_inner();
        let source_security_group_binding = args.source_security_group.get_inner();
