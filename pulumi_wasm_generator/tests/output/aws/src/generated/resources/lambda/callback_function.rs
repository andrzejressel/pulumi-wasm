...
pub mod callback_function {
    ...
    pub struct CallbackFunctionArgs {
        ...
        #[builder(into, default)]
        pub callback: pulumi_wasm_rust::Output<Option<String>>,
        ...
        #[builder(into, default)]
        pub callback_factory: pulumi_wasm_rust::Output<Option<String>>,
        ...
        #[builder(into, default)]
        pub code_path_options: pulumi_wasm_rust::Output<
    ...
    pub fn create(name: &str, args: CallbackFunctionArgs) -> CallbackFunctionResult {
        use pulumi_wasm_rust::__private::pulumi_wasm_wit::client_bindings::component::pulumi_wasm::register_interface;
        use std::collections::HashMap;
        let architectures_binding = args.architectures.get_inner();
        let callback_binding = args.callback.get_inner();
        let callback_factory_binding = args.callback_factory.get_inner();
        let code_path_options_binding = args.code_path_options.get_inner();
