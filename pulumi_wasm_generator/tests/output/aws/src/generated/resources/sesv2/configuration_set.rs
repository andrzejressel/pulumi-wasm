...
pub mod configuration_set {
    ...
    pub fn create(name: &str, args: ConfigurationSetArgs) -> ConfigurationSetResult {
        ...
        let reputation_options_binding = args.reputation_options.get_inner();
        let sending_options_binding = args.sending_options.get_inner();
        let suppression_options_binding = args.suppression_options.get_inner();
        let tags_binding = args.tags.get_inner();
        let tracking_options_binding = args.tracking_options.get_inner();
        let vdm_options_binding = args.vdm_options.get_inner();
