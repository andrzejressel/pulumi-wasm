...
pub mod collaboration {
    ...
    pub fn create(name: &str, args: CollaborationArgs) -> CollaborationResult {
        use pulumi_wasm_rust::__private::pulumi_wasm_wit::client_bindings::component::pulumi_wasm::register_interface;
        use std::collections::HashMap;
        let creator_display_name_binding = args.creator_display_name.get_inner();
        let creator_member_abilities_binding = args.creator_member_abilities.get_inner();
        let data_encryption_metadata_binding = args.data_encryption_metadata.get_inner();
        let description_binding = args.description.get_inner();
        let members_binding = args.members.get_inner();
        let name_binding = args.name.get_inner();
        let query_log_status_binding = args.query_log_status.get_inner();
        ...
        CollaborationResult {
            ...
            creator_display_name: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("creatorDisplayName").unwrap(),
            ),
            creator_member_abilities: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("creatorMemberAbilities").unwrap(),
            ),
            data_encryption_metadata: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("dataEncryptionMetadata").unwrap(),
            ),
            ...
            query_log_status: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("queryLogStatus").unwrap(),
            ),
