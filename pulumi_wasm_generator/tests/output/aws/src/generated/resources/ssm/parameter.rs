...
pub mod parameter {
    ...
    pub struct ParameterArgs {
        ...
        #[builder(into, default)]
        pub data_type: pulumi_wasm_rust::Output<Option<String>>,
        ...
        #[builder(into, default)]
        pub insecure_value: pulumi_wasm_rust::Output<Option<String>>,
    ...
    pub fn create(name: &str, args: ParameterArgs) -> ParameterResult {
        use pulumi_wasm_rust::__private::pulumi_wasm_wit::client_bindings::component::pulumi_wasm::register_interface;
        use std::collections::HashMap;
        let allowed_pattern_binding = args.allowed_pattern.get_inner();
        let arn_binding = args.arn.get_inner();
        let data_type_binding = args.data_type.get_inner();
        let description_binding = args.description.get_inner();
        let insecure_value_binding = args.insecure_value.get_inner();
        let key_id_binding = args.key_id.get_inner();
        let name_binding = args.name.get_inner();
        let overwrite_binding = args.overwrite.get_inner();
