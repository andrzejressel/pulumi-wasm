...
pub mod rails_app_layer {
    ...
    pub fn create(name: &str, args: RailsAppLayerArgs) -> RailsAppLayerResult {
        use pulumi_wasm_rust::__private::pulumi_wasm_wit::client_bindings::component::pulumi_wasm::register_interface;
        use std::collections::HashMap;
        let app_server_binding = args.app_server.get_inner();
        ...
        let bundler_version_binding = args.bundler_version.get_inner();
        ...
        let manage_bundler_binding = args.manage_bundler.get_inner();
        let name_binding = args.name.get_inner();
        let passenger_version_binding = args.passenger_version.get_inner();
        let ruby_version_binding = args.ruby_version.get_inner();
        let rubygems_version_binding = args.rubygems_version.get_inner();
        ...
        let request = register_interface::RegisterResourceRequest {
            ...
            object: Vec::from([
                ...
                register_interface::ObjectField {
                    ...
                    value: &passenger_version_binding,
                },
                register_interface::ObjectField {
                    name: "rubyVersion".into(),
                    value: &ruby_version_binding,
                },
                register_interface::ObjectField {
                    name: "rubygemsVersion".into(),
                    value: &rubygems_version_binding,
                },
                register_interface::ObjectField {
                    name: "stackId".into(),
        ...
        RailsAppLayerResult {
            ...
            bundler_version: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("bundlerVersion").unwrap(),
            ),
