...
pub mod haproxy_layer {
    ...
    pub fn create(name: &str, args: HaproxyLayerArgs) -> HaproxyLayerResult {
        ...
        let healthcheck_method_binding = args.healthcheck_method.get_inner();
        let healthcheck_url_binding = args.healthcheck_url.get_inner();
        ...
        let stats_enabled_binding = args.stats_enabled.get_inner();
        let stats_password_binding = args.stats_password.get_inner();
        let stats_url_binding = args.stats_url.get_inner();
        let stats_user_binding = args.stats_user.get_inner();
