...
pub mod ca_pool {
    ...
    pub fn create(
        ...
        CaPoolResult {
            ...
            issuance_policy: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("issuancePolicy").unwrap(),
            ),
            ...
            publishing_options: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("publishingOptions").unwrap(),
            ),
