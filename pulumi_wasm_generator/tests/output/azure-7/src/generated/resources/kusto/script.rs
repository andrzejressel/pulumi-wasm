...
pub mod script {
    ...
    pub struct ScriptArgs {
        ...
        pub continue_on_errors_enabled: pulumi_wasm_rust::InputOrOutput<Option<bool>>,
        ...
        #[builder(into, default)]
        pub force_an_update_when_value_changed: pulumi_wasm_rust::InputOrOutput<
            Option<String>,
        >,
        ...
        #[builder(into, default)]
        pub sas_token: pulumi_wasm_rust::InputOrOutput<Option<String>>,
