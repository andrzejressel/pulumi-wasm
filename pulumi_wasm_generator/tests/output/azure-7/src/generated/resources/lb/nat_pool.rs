...
pub mod nat_pool {
    ...
    pub fn create(name: &str, args: NatPoolArgs) -> NatPoolResult {
        use pulumi_wasm_rust::__private::pulumi_wasm_wit::client_bindings::component::pulumi_wasm::register_interface;
        use std::collections::HashMap;
        let backend_port_binding = args.backend_port.get_inner();
        let floating_ip_enabled_binding = args.floating_ip_enabled.get_inner();
        ...
        let tcp_reset_enabled_binding = args.tcp_reset_enabled.get_inner();
        ...
        NatPoolResult {
            ...
            floating_ip_enabled: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("floatingIpEnabled").unwrap(),
            ),
