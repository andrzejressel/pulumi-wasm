...
pub mod standard {
    ...
    pub struct StandardArgs {
        ...
        #[builder(into, default)]
        pub storage_account_share_name: pulumi_wasm_rust::Output<Option<String>>,
    ...
    pub fn create(name: &str, args: StandardArgs) -> StandardResult {
        ...
        let bundle_version_binding = args.bundle_version.get_inner();
        ...
        let use_extension_bundle_binding = args.use_extension_bundle.get_inner();
