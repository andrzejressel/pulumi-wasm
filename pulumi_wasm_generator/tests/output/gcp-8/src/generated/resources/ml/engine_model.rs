...
pub mod engine_model {
    ...
    pub struct EngineModelArgs {
        ...
        pub default_version: pulumi_wasm_rust::InputOrOutput<
        ...
        #[builder(into, default)]
        pub online_prediction_console_logging: pulumi_wasm_rust::InputOrOutput<
            Option<bool>,
        >,
        /// If true, online prediction access logs are sent to StackDriver Logging.
        #[builder(into, default)]
        pub online_prediction_logging: pulumi_wasm_rust::InputOrOutput<Option<bool>>,
        ...
        #[builder(into, default)]
        pub regions: pulumi_wasm_rust::InputOrOutput<Option<String>>,
    }
    #[allow(dead_code)]
