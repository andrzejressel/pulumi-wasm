...
pub mod client_tls_policy {
    ...
    pub fn create(name: &str, args: ClientTlsPolicyArgs) -> ClientTlsPolicyResult {
        ...
        let server_validation_cas_binding = args.server_validation_cas.get_inner();
        let sni_binding = args.sni.get_inner();
        ...
        ClientTlsPolicyResult {
            ...
            server_validation_cas: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("serverValidationCas").unwrap(),
            ),
            sni: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("sni").unwrap(),
            ),
