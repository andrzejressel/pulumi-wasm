...
pub mod server_tls_policy {
    ...
    pub struct ServerTlsPolicyArgs {
        ...
        pub allow_open: pulumi_wasm_rust::Output<Option<bool>>,
        ...
        #[builder(into, default)]
        pub mtls_policy: pulumi_wasm_rust::Output<
        ...
        /// Structure is documented below.
        #[builder(into, default)]
        pub server_certificate: pulumi_wasm_rust::Output<
            Option<
    ...
    pub fn create(name: &str, args: ServerTlsPolicyArgs) -> ServerTlsPolicyResult {
        use pulumi_wasm_rust::__private::pulumi_wasm_wit::client_bindings::component::pulumi_wasm::register_interface;
        use std::collections::HashMap;
        let allow_open_binding = args.allow_open.get_inner();
        let description_binding = args.description.get_inner();
        let labels_binding = args.labels.get_inner();
        let location_binding = args.location.get_inner();
        let mtls_policy_binding = args.mtls_policy.get_inner();
        ...
        ServerTlsPolicyResult {
            allow_open: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("allowOpen").unwrap(),
            ),
            ...
            mtls_policy: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("mtlsPolicy").unwrap(),
            ),
