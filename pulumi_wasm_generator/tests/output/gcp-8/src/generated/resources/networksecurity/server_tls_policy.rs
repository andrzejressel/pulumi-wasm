...
pub mod server_tls_policy {
    ...
    pub struct ServerTlsPolicyArgs {
        ...
        pub allow_open: pulumi_wasm_rust::InputOrOutput<Option<bool>>,
        ...
        #[builder(into, default)]
        pub mtls_policy: pulumi_wasm_rust::InputOrOutput<
        ...
        /// Structure is documented below.
        #[builder(into, default)]
        pub server_certificate: pulumi_wasm_rust::InputOrOutput<
            Option<
