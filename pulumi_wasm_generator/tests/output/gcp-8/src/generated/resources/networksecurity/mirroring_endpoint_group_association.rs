...
pub mod mirroring_endpoint_group_association {
    ...
    pub fn create(
        ...
        let mirroring_endpoint_group_binding = args.mirroring_endpoint_group.get_inner();
