...
pub mod connectivity_test {
    ...
    pub fn create(name: &str, args: ConnectivityTestArgs) -> ConnectivityTestResult {
        ...
        let related_projects_binding = args.related_projects.get_inner();
        ...
        let request = register_interface::RegisterResourceRequest {
            ...
            object: Vec::from([
                ...
                register_interface::ObjectField {
                    ...
                    value: &related_projects_binding,
                },
                register_interface::ObjectField {
                    name: "source".into(),
        ...
        ConnectivityTestResult {
            ...
            related_projects: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("relatedProjects").unwrap(),
            ),
