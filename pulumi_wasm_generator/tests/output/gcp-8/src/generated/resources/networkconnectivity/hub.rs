...
pub mod hub {
    ...
    pub struct HubArgs {
        ...
        #[builder(into, default)]
        pub export_psc: pulumi_wasm_rust::Output<Option<bool>>,
    ...
    pub struct HubResult {
        ...
        >,
        /// Whether Private Service Connect transitivity is enabled for the hub. If true, Private Service Connect endpoints in VPC spokes attached to the hub are made accessible to other VPC spokes attached to the hub. The default value is false.
        pub export_psc: pulumi_wasm_rust::Output<bool>,
        /// Optional labels in key:value format. For more information about labels, see [Requirements for labels](https://cloud.google.com/resource-manager/docs/creating-managing-labels#requirements).
        /// **Note**: This field is non-authoritative, and will only manage the labels present in your configuration.
        /// Please refer to the field `effective_labels` for all of the labels present on the resource.
        pub labels: pulumi_wasm_rust::Output<
        ...
        pub routing_vpcs: pulumi_wasm_rust::Output<
    ...
    pub fn create(name: &str, args: HubArgs) -> HubResult {
        ...
        let export_psc_binding = args.export_psc.get_inner();
        ...
        HubResult {
            ...
            export_psc: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("exportPsc").unwrap(),
            ),
            ...
            routing_vpcs: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("routingVpcs").unwrap(),
            ),
