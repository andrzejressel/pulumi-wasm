pub mod get_capacity_block_offering {
    ...
    pub struct GetCapacityBlockOfferingArgs {
        ...
        pub end_date_range: pulumi_wasm_rust::Output<Option<String>>,
        ...
        #[builder(into, default)]
        pub start_date_range: pulumi_wasm_rust::Output<Option<String>>,
    }
    #[allow(dead_code)]
    ...
    pub fn invoke(args: GetCapacityBlockOfferingArgs) -> GetCapacityBlockOfferingResult {
        use pulumi_wasm_rust::__private::pulumi_wasm_wit::client_bindings::component::pulumi_wasm::register_interface;
        use std::collections::HashMap;
        let capacity_duration_hours_binding = args.capacity_duration_hours.get_inner();
        let end_date_range_binding = args.end_date_range.get_inner();
