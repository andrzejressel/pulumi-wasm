...
pub mod launch_template {
    ...
    pub struct LaunchTemplateArgs {
        ...
        #[builder(into, default)]
        pub default_version: pulumi_wasm_rust::InputOrOutput<Option<i32>>,
        ...
        #[builder(into, default)]
        pub ebs_optimized: pulumi_wasm_rust::InputOrOutput<Option<String>>,
        /// The elastic GPU to attach to the instance. See Elastic GPU
        /// below for more details.
        #[builder(into, default)]
        pub elastic_gpu_specifications: pulumi_wasm_rust::InputOrOutput<
            Option<Vec<super::super::types::ec2::LaunchTemplateElasticGpuSpecification>>,
        >,
        /// Configuration block containing an Elastic Inference Accelerator to attach to the instance. See Elastic Inference Accelerator below for more details.
        #[builder(into, default)]
        pub elastic_inference_accelerator: pulumi_wasm_rust::InputOrOutput<
        ...
        #[builder(into, default)]
        pub hibernation_options: pulumi_wasm_rust::InputOrOutput<
            Option<super::super::types::ec2::LaunchTemplateHibernationOptions>,
        >,
        /// The IAM Instance Profile to launch the instance with. See Instance Profile
        /// below for more details.
        #[builder(into, default)]
        pub iam_instance_profile: pulumi_wasm_rust::InputOrOutput<
        ...
        #[builder(into, default)]
        pub instance_requirements: pulumi_wasm_rust::InputOrOutput<
        ...
        #[builder(into, default)]
        pub license_specifications: pulumi_wasm_rust::InputOrOutput<
        ...
        #[builder(into, default)]
        pub ram_disk_id: pulumi_wasm_rust::InputOrOutput<Option<String>>,
        ...
        #[builder(into, default)]
        pub tag_specifications: pulumi_wasm_rust::InputOrOutput<
        ...
        #[builder(into, default)]
        pub update_default_version: pulumi_wasm_rust::InputOrOutput<Option<bool>>,
    ...
    pub fn create(
        ...
        LaunchTemplateResult {
            ...
            elastic_inference_accelerator: pulumi_wasm_rust::__private::into_domain(
                o.extract_field("elasticInferenceAccelerator"),
            ),
            ...
            update_default_version: pulumi_wasm_rust::__private::into_domain(
                o.extract_field("updateDefaultVersion"),
            ),
