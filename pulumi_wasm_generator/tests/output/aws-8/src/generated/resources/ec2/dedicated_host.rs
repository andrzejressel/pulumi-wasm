...
pub mod dedicated_host {
    ...
    pub struct DedicatedHostArgs {
        ...
        pub asset_id: pulumi_wasm_rust::Output<Option<String>>,
    ...
    pub fn create(name: &str, args: DedicatedHostArgs) -> DedicatedHostResult {
        use pulumi_wasm_rust::__private::pulumi_wasm_wit::client_bindings::component::pulumi_wasm::register_interface;
        use std::collections::HashMap;
        let asset_id_binding = args.asset_id.get_inner();
        let auto_placement_binding = args.auto_placement.get_inner();
        let availability_zone_binding = args.availability_zone.get_inner();
        let host_recovery_binding = args.host_recovery.get_inner();
        let instance_family_binding = args.instance_family.get_inner();
