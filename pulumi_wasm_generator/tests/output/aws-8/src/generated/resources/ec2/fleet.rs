...
pub mod fleet {
    ...
    pub struct FleetArgs {
        ...
        #[builder(into, default)]
        pub fleet_state: pulumi_wasm_rust::Output<Option<String>>,
        /// The number of units fulfilled by this request compared to the set target capacity.
        #[builder(into, default)]
        pub fulfilled_capacity: pulumi_wasm_rust::Output<Option<f64>>,
        /// The number of units fulfilled by this request compared to the set target On-Demand capacity.
        #[builder(into, default)]
        pub fulfilled_on_demand_capacity: pulumi_wasm_rust::Output<Option<f64>>,
    ...
    pub fn create(name: &str, args: FleetArgs) -> FleetResult {
        ...
        let excess_capacity_termination_policy_binding = args
            ...
            .get_inner();
        let fleet_instance_sets_binding = args.fleet_instance_sets.get_inner();
        let fleet_state_binding = args.fleet_state.get_inner();
        let fulfilled_capacity_binding = args.fulfilled_capacity.get_inner();
        ...
        let on_demand_options_binding = args.on_demand_options.get_inner();
        let replace_unhealthy_instances_binding = args
            .replace_unhealthy_instances
            .get_inner();
        let spot_options_binding = args.spot_options.get_inner();
        let tags_binding = args.tags.get_inner();
        let target_capacity_specification_binding = args
            .target_capacity_specification
            .get_inner();
        let terminate_instances_binding = args.terminate_instances.get_inner();
