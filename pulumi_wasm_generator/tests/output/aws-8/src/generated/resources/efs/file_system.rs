...
pub mod file_system {
    ...
    pub struct FileSystemArgs {
        ...
        pub availability_zone_name: pulumi_wasm_rust::Output<Option<String>>,
        ...
        #[builder(into, default)]
        pub performance_mode: pulumi_wasm_rust::Output<Option<String>>,
    ...
    pub fn create(name: &str, args: FileSystemArgs) -> FileSystemResult {
        ...
        let availability_zone_name_binding = args.availability_zone_name.get_inner();
        ...
        let lifecycle_policies_binding = args.lifecycle_policies.get_inner();
        let performance_mode_binding = args.performance_mode.get_inner();
        let protection_binding = args.protection.get_inner();
        let provisioned_throughput_in_mibps_binding = args
            .provisioned_throughput_in_mibps
            .get_inner();
        let tags_binding = args.tags.get_inner();
        let throughput_mode_binding = args.throughput_mode.get_inner();
