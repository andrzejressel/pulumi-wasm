...
pub fn invoke(args: GetLogsArgs) -> GetLogsResult {
    ...
    let request = register_interface::ResourceInvokeRequest {
        ...
        results: vec![
            register_interface::ResultField { name : "details".into() },
            register_interface::ResultField { name : "discardHeaders".into() },
            register_interface::ResultField { name : "follow".into() },
            register_interface::ResultField { name : "id".into() },
            register_interface::ResultField { name : "logsListStringEnabled".into() },
            register_interface::ResultField { name : "logsListStrings".into() },
            register_interface::ResultField { name : "name".into() },
            register_interface::ResultField { name : "showStderr".into() },
            register_interface::ResultField { name : "showStdout".into() },
            register_interface::ResultField { name : "since".into() },
            register_interface::ResultField { name : "tail".into() },
            register_interface::ResultField { name : "timestamps".into() },
            register_interface::ResultField { name : "until".into() },
        ],
    };
    ...
    let mut hashmap: HashMap<String, _> = o
        ...
        .collect();
    GetLogsResult {
        details: into_domain(hashmap.remove("details").unwrap()),
        discard_headers: into_domain(hashmap.remove("discardHeaders").unwrap()),
        follow: into_domain(hashmap.remove("follow").unwrap()),
        id: into_domain(hashmap.remove("id").unwrap()),
        logs_list_string_enabled: into_domain(
            hashmap.remove("logsListStringEnabled").unwrap(),
        ),
        logs_list_strings: into_domain(hashmap.remove("logsListStrings").unwrap()),
        name: into_domain(hashmap.remove("name").unwrap()),
        show_stderr: into_domain(hashmap.remove("showStderr").unwrap()),
        show_stdout: into_domain(hashmap.remove("showStdout").unwrap()),
        since: into_domain(hashmap.remove("since").unwrap()),
        tail: into_domain(hashmap.remove("tail").unwrap()),
        timestamps: into_domain(hashmap.remove("timestamps").unwrap()),
        until: into_domain(hashmap.remove("until").unwrap()),
    }
}
