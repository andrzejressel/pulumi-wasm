...
pub struct RegionUrlMapDefaultRouteActionWeightedBackendServiceHeaderAction {
    ...
    pub r#request_headers_to_adds: Box<Option<Vec<super::super::types::compute::RegionUrlMapDefaultRouteActionWeightedBackendServiceHeaderActionRequestHeadersToAdd>>>,
    ...
    pub r#response_headers_to_adds: Box<Option<Vec<super::super::types::compute::RegionUrlMapDefaultRouteActionWeightedBackendServiceHeaderActionResponseHeadersToAdd>>>,
