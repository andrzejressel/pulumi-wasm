...
pub struct GetEnvironmentConfigPrivateEnvironmentConfig {
    ...
    pub r#cloud_composer_connection_subnetwork: Box<String>,
    ...
    pub r#cloud_composer_network_ipv_4_cidr_block: Box<String>,
    /// The CIDR block from which IP range in tenant project will be reserved for Cloud SQL. Needs to be disjoint from web_server_ipv4_cidr_block.
    #[builder(into)]
    #[serde(rename = "cloudSqlIpv4CidrBlock")]
    pub r#cloud_sql_ipv_4_cidr_block: Box<String>,
    ...
    pub r#connection_type: Box<String>,
    ...
    pub r#enable_privately_used_public_ips: Box<bool>,
    ...
    pub r#web_server_ipv_4_cidr_block: Box<String>,
}
