pub mod get_cloud_vm_clusters {
    ...
    pub struct GetCloudVmClustersResult {
        pub cloud_vm_clusters: pulumi_wasm_rust::Output<
            Vec<
    ...
    pub fn invoke(args: GetCloudVmClustersArgs) -> GetCloudVmClustersResult {
        ...
        GetCloudVmClustersResult {
            cloud_vm_clusters: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("cloudVmClusters").unwrap(),
            ),
