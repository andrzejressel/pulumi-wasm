...
pub mod instance_config {
    ...
    pub struct InstanceConfigResult {
        ...
        /// configurations. baseConfig must refer to a configuration of type GOOGLE_MANAGED in the same project as this
        /// configuration.
        pub base_config: pulumi_wasm_rust::Output<String>,
        /// Output only. Whether this instance config is a Google or User Managed Configuration.
        pub config_type: pulumi_wasm_rust::Output<String>,
        /// The name of this instance configuration as it appears in UIs.
        pub display_name: pulumi_wasm_rust::Output<String>,
    ...
    pub fn create(name: &str, args: InstanceConfigArgs) -> InstanceConfigResult {
        ...
        InstanceConfigResult {
            base_config: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("baseConfig").unwrap(),
            ),
            config_type: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("configType").unwrap(),
            ),
