...
pub mod v_2_queued_resource {
    ...
    pub fn create(name: &str, args: V2QueuedResourceArgs) -> V2QueuedResourceResult {
        use pulumi_wasm_rust::__private::pulumi_wasm_wit::client_bindings::component::pulumi_wasm::register_interface;
        use std::collections::HashMap;
        let name_binding = args.name.get_inner();
        let project_binding = args.project.get_inner();
        let tpu_binding = args.tpu.get_inner();
        ...
        V2QueuedResourceResult {
            ...
            tpu: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("tpu").unwrap(),
            ),
