...
pub mod custom_service {
    ...
    pub struct CustomServiceArgs {
        ...
        #[builder(into, default)]
        pub telemetry: pulumi_wasm_rust::Output<
    ...
    pub fn create(name: &str, args: CustomServiceArgs) -> CustomServiceResult {
        use pulumi_wasm_rust::__private::pulumi_wasm_wit::client_bindings::component::pulumi_wasm::register_interface;
        use std::collections::HashMap;
        let display_name_binding = args.display_name.get_inner();
        let project_binding = args.project.get_inner();
        let service_id_binding = args.service_id.get_inner();
        let telemetry_binding = args.telemetry.get_inner();
        ...
        CustomServiceResult {
            ...
            telemetry: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("telemetry").unwrap(),
            ),
