...
pub mod ai_endpoint {
    ...
    pub struct AiEndpointArgs {
        ...
        #[builder(into, default)]
        pub traffic_split: pulumi_wasm_rust::Output<Option<String>>,
    }
    #[allow(dead_code)]
    ...
    pub fn create(name: &str, args: AiEndpointArgs) -> AiEndpointResult {
        ...
        let traffic_split_binding = args.traffic_split.get_inner();
