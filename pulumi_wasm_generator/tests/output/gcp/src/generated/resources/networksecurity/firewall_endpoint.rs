...
pub mod firewall_endpoint {
    ...
    pub fn create(name: &str, args: FirewallEndpointArgs) -> FirewallEndpointResult {
        use pulumi_wasm_rust::__private::pulumi_wasm_wit::client_bindings::component::pulumi_wasm::register_interface;
        use std::collections::HashMap;
        let billing_project_id_binding = args.billing_project_id.get_inner();
        ...
        FirewallEndpointResult {
            associated_networks: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("associatedNetworks").unwrap(),
            ),
            billing_project_id: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("billingProjectId").unwrap(),
            ),
