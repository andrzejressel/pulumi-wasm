...
pub mod location_hdfs {
    ...
    pub fn create(name: &str, args: LocationHdfsArgs) -> LocationHdfsResult {
        ...
        let block_size_binding = args.block_size.get_inner();
        let kerberos_keytab_binding = args.kerberos_keytab.get_inner();
        let kerberos_keytab_base64_binding = args.kerberos_keytab_base64.get_inner();
        let kerberos_krb5_conf_binding = args.kerberos_krb5_conf.get_inner();
        let kerberos_krb5_conf_base64_binding = args
            .kerberos_krb5_conf_base64
            .get_inner();
        let kerberos_principal_binding = args.kerberos_principal.get_inner();
        let kms_key_provider_uri_binding = args.kms_key_provider_uri.get_inner();
        let name_nodes_binding = args.name_nodes.get_inner();
        let qop_configuration_binding = args.qop_configuration.get_inner();
        let replication_factor_binding = args.replication_factor.get_inner();
        let simple_user_binding = args.simple_user.get_inner();
