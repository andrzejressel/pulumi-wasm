pub mod get_database_instance_latest_recovery_time {
    ...
    pub struct GetDatabaseInstanceLatestRecoveryTimeResult {
        ...
        pub latest_recovery_time: pulumi_wasm_rust::Output<String>,
        /// The ID of the project in which the resource belongs.
    ...
    pub fn invoke(
        ...
        GetDatabaseInstanceLatestRecoveryTimeResult {
            ...
            latest_recovery_time: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("latestRecoveryTime").unwrap(),
            ),
