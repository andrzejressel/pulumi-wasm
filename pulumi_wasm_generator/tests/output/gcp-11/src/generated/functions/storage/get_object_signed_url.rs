pub mod get_object_signed_url {
    ...
    pub struct GetObjectSignedUrlArgs {
        ...
        #[builder(into, default)]
        pub credentials: pulumi_wasm_rust::InputOrOutput<Option<String>>,
        ...
        #[builder(into, default)]
        pub extension_headers: pulumi_wasm_rust::InputOrOutput<
            Option<std::collections::HashMap<String, String>>,
        >,
        /// What HTTP Method will the signed URL allow (defaults to `GET`)
        #[builder(into, default)]
        pub http_method: pulumi_wasm_rust::InputOrOutput<Option<String>>,
    ...
    pub struct GetObjectSignedUrlResult {
        ...
        pub extension_headers: pulumi_wasm_rust::Output<
            Option<std::collections::HashMap<String, String>>,
        >,
        pub http_method: pulumi_wasm_rust::Output<Option<String>>,
        /// The provider-assigned unique ID for this managed resource.
        pub id: pulumi_wasm_rust::Output<String>,
        pub path: pulumi_wasm_rust::Output<String>,
        /// The signed URL that can be used to access the storage object without authentication.
        pub signed_url: pulumi_wasm_rust::Output<String>,
    }
    ///
