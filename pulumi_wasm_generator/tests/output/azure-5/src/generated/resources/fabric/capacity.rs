...
pub mod capacity {
    ...
    pub fn create(name: &str, args: CapacityArgs) -> CapacityResult {
        use pulumi_wasm_rust::__private::pulumi_wasm_wit::client_bindings::component::pulumi_wasm::register_interface;
        use std::collections::HashMap;
        let administration_members_binding = args.administration_members.get_inner();
        ...
        CapacityResult {
            administration_members: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("administrationMembers").unwrap(),
            ),
