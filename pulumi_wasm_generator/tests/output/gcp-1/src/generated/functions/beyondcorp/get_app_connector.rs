pub mod get_app_connector {
    ...
    pub struct GetAppConnectorResult {
        ...
        pub name: pulumi_wasm_rust::Output<String>,
        pub principal_infos: pulumi_wasm_rust::Output<
    ...
    pub fn invoke(args: GetAppConnectorArgs) -> GetAppConnectorResult {
        ...
        GetAppConnectorResult {
            ...
            principal_infos: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("principalInfos").unwrap(),
            ),
