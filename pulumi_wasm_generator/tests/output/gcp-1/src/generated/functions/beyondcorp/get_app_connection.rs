pub mod get_app_connection {
    ...
    pub struct GetAppConnectionResult {
        pub application_endpoints: pulumi_wasm_rust::Output<
            Vec<
                super::super::super::types::beyondcorp::GetAppConnectionApplicationEndpoint,
            >,
        >,
        pub connectors: pulumi_wasm_rust::Output<Vec<String>>,
    ...
    pub fn invoke(args: GetAppConnectionArgs) -> GetAppConnectionResult {
        ...
        let request = register_interface::ResourceInvokeRequest {
            ...
            results: Vec::from([
                register_interface::ResultField {
                    name: "applicationEndpoints".into(),
                },
                register_interface::ResultField {
        ...
        GetAppConnectionResult {
            application_endpoints: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("applicationEndpoints").unwrap(),
            ),
