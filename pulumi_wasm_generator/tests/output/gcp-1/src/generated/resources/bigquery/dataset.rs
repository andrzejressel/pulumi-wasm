...
pub mod dataset {
    ...
    pub fn create(
        ...
        DatasetResult {
            ...
            default_encryption_configuration: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("defaultEncryptionConfiguration").unwrap(),
            ),
            ...
            external_dataset_reference: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("externalDatasetReference").unwrap(),
            ),
