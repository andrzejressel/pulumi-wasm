...
pub mod response_headers_policy {
    ...
    pub fn create(
        ...
        let cors_config_binding = args.cors_config.get_inner();
        let custom_headers_config_binding = args.custom_headers_config.get_inner();
        let etag_binding = args.etag.get_inner();
        let name_binding = args.name.get_inner();
        let remove_headers_config_binding = args.remove_headers_config.get_inner();
        let security_headers_config_binding = args.security_headers_config.get_inner();
        ...
        ResponseHeadersPolicyResult {
            ...
            cors_config: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("corsConfig").unwrap(),
            ),
            custom_headers_config: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("customHeadersConfig").unwrap(),
            ),
            ...
            remove_headers_config: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("removeHeadersConfig").unwrap(),
            ),
            security_headers_config: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("securityHeadersConfig").unwrap(),
            ),
            server_timing_headers_config: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("serverTimingHeadersConfig").unwrap(),
            ),
        }
    }
}
