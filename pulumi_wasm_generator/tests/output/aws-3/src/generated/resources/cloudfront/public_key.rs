...
pub mod public_key {
    ...
    pub struct PublicKeyArgs {
        ...
        #[builder(into)]
        pub encoded_key: pulumi_wasm_rust::Output<String>,
    ...
    pub fn create(name: &str, args: PublicKeyArgs) -> PublicKeyResult {
        use pulumi_wasm_rust::__private::pulumi_wasm_wit::client_bindings::component::pulumi_wasm::register_interface;
        use std::collections::HashMap;
        let comment_binding = args.comment.get_inner();
        let encoded_key_binding = args.encoded_key.get_inner();
        ...
        PublicKeyResult {
            ...
            encoded_key: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("encodedKey").unwrap(),
            ),
