...
pub mod response_plan {
    ...
    pub struct ResponsePlanArgs {
        ...
        >,
        #[builder(into, default)]
        pub chat_channels: pulumi_wasm_rust::InputOrOutput<Option<Vec<String>>>,
        #[builder(into, default)]
        pub display_name: pulumi_wasm_rust::InputOrOutput<Option<String>>,
        #[builder(into, default)]
        pub engagements: pulumi_wasm_rust::InputOrOutput<Option<Vec<String>>>,
        #[builder(into)]
        pub incident_template: pulumi_wasm_rust::InputOrOutput<
            super::super::types::ssmincidents::ResponsePlanIncidentTemplate,
        >,
        #[builder(into, default)]
        pub integration: pulumi_wasm_rust::InputOrOutput<
