...
pub mod file_upload {
    ...
    pub struct FileUploadArgs {
        ...
        #[builder(into, default)]
        pub default_ttl: pulumi_wasm_rust::InputOrOutput<Option<String>>,
        ...
        #[builder(into, default)]
        pub notifications_enabled: pulumi_wasm_rust::InputOrOutput<Option<bool>>,
        ...
        #[builder(into, default)]
        pub sas_ttl: pulumi_wasm_rust::InputOrOutput<Option<String>>,
    }
    #[allow(dead_code)]
