...
pub mod cache_nfs_target {
    ...
    pub fn create(name: &str, args: CacheNfsTargetArgs) -> CacheNfsTargetResult {
        use pulumi_wasm_rust::__private::pulumi_wasm_wit::client_bindings::component::pulumi_wasm::register_interface;
        use std::collections::HashMap;
        let cache_name_binding = args.cache_name.get_inner();
        let name_binding = args.name.get_inner();
        let namespace_junctions_binding = args.namespace_junctions.get_inner();
        let resource_group_name_binding = args.resource_group_name.get_inner();
        let target_host_name_binding = args.target_host_name.get_inner();
        let usage_model_binding = args.usage_model.get_inner();
