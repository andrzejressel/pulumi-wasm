...
pub mod kafka_cluster {
    ...
    pub struct KafkaClusterArgs {
        ...
        #[builder(into, default)]
        pub rest_proxy: pulumi_wasm_rust::InputOrOutput<
    ...
    pub struct KafkaClusterResult {
        ...
        /// A `rest_proxy` block as defined below.
        pub rest_proxy: pulumi_wasm_rust::Output<
            Option<super::super::types::hdinsight::KafkaClusterRestProxy>,
        >,
        /// A `roles` block as defined below.
    ...
    pub fn create(
        ...
        let resource_group_name_binding = args
            ...
            .get_output(context)
            .get_inner();
        let rest_proxy_binding = args.rest_proxy.get_output(context).get_inner();
        ...
        KafkaClusterResult {
            ...
            rest_proxy: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("restProxy").unwrap(),
            ),
