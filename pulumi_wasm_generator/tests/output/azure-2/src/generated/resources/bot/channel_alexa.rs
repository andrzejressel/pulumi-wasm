...
pub mod channel_alexa {
    ...
    pub struct ChannelAlexaArgs {
        ...
        #[builder(into)]
        pub skill_id: pulumi_wasm_rust::InputOrOutput<String>,
    }
    #[allow(dead_code)]
    pub struct ChannelAlexaResult {
        ...
        /// The Alexa skill ID for the Alexa Channel.
        pub skill_id: pulumi_wasm_rust::Output<String>,
    }
    ///
    ...
    pub fn create(
        ...
        let resource_group_name_binding = args
            ...
            .get_output(context)
            .get_inner();
        let skill_id_binding = args.skill_id.get_output(context).get_inner();
        ...
        ChannelAlexaResult {
            ...
            skill_id: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("skillId").unwrap(),
            ),
        }
    }
}
