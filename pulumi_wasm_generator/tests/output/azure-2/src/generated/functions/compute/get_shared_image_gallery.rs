pub mod get_shared_image_gallery {
    ...
    pub struct GetSharedImageGalleryResult {
        ...
        pub image_names: pulumi_wasm_rust::Output<Vec<String>>,
    ...
    pub fn invoke(args: GetSharedImageGalleryArgs) -> GetSharedImageGalleryResult {
        ...
        GetSharedImageGalleryResult {
            ...
            image_names: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("imageNames").unwrap(),
            ),
