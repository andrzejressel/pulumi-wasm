pub mod get_virtual_machine {
    ...
    pub struct GetVirtualMachineResult {
        ...
        pub power_state: pulumi_wasm_rust::Output<String>,
    ...
    pub fn invoke(args: GetVirtualMachineArgs) -> GetVirtualMachineResult {
        ...
        GetVirtualMachineResult {
            ...
            power_state: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("powerState").unwrap(),
            ),
