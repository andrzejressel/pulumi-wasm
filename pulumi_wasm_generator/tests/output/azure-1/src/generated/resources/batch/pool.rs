...
pub mod pool {
    ...
    pub fn create(name: &str, args: PoolArgs) -> PoolResult {
        ...
        let container_configuration_binding = args.container_configuration.get_inner();
        ...
        let fixed_scale_binding = args.fixed_scale.get_inner();
        let identity_binding = args.identity.get_inner();
        let inter_node_communication_binding = args.inter_node_communication.get_inner();
        let license_type_binding = args.license_type.get_inner();
        let max_tasks_per_node_binding = args.max_tasks_per_node.get_inner();
        ...
        let node_agent_sku_id_binding = args.node_agent_sku_id.get_inner();
        let node_placements_binding = args.node_placements.get_inner();
        let os_disk_placement_binding = args.os_disk_placement.get_inner();
        let resource_group_name_binding = args.resource_group_name.get_inner();
        let start_task_binding = args.start_task.get_inner();
        ...
        let target_node_communication_mode_binding = args
            ...
            .get_inner();
        let task_scheduling_policies_binding = args.task_scheduling_policies.get_inner();
        let user_accounts_binding = args.user_accounts.get_inner();
