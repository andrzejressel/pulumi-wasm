...
pub mod configuration {
    ...
    pub fn create(name: &str, args: ConfigurationArgs) -> ConfigurationResult {
        ...
        let antimalware_binding = args.antimalware.get_inner();
        let automation_account_enabled_binding = args
            .automation_account_enabled
            .get_inner();
        let azure_security_baseline_binding = args.azure_security_baseline.get_inner();
        let backup_binding = args.backup.get_inner();
        let boot_diagnostics_enabled_binding = args.boot_diagnostics_enabled.get_inner();
        ...
        let log_analytics_enabled_binding = args.log_analytics_enabled.get_inner();
