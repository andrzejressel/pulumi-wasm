...
pub mod job_schedule {
    ...
    pub struct JobScheduleArgs {
        ...
        pub job_schedule_id: pulumi_wasm_rust::Output<Option<String>>,
    ...
    pub fn create(name: &str, args: JobScheduleArgs) -> JobScheduleResult {
        ...
        let job_schedule_id_binding = args.job_schedule_id.get_inner();
        let parameters_binding = args.parameters.get_inner();
        let resource_group_name_binding = args.resource_group_name.get_inner();
        let run_on_binding = args.run_on.get_inner();
        let runbook_name_binding = args.runbook_name.get_inner();
        let schedule_name_binding = args.schedule_name.get_inner();
