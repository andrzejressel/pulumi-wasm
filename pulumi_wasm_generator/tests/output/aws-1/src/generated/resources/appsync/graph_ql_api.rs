pub mod graph_ql_api {
    ...
    pub fn create(name: &str, args: GraphQLApiArgs) -> GraphQLApiResult {
        ...
        let enhanced_metrics_config_binding = args.enhanced_metrics_config.get_inner();
        let introspection_config_binding = args.introspection_config.get_inner();
        let lambda_authorizer_config_binding = args.lambda_authorizer_config.get_inner();
        let log_config_binding = args.log_config.get_inner();
        let merged_api_execution_role_arn_binding = args
            .merged_api_execution_role_arn
            .get_inner();
        let name_binding = args.name.get_inner();
        let openid_connect_config_binding = args.openid_connect_config.get_inner();
        let query_depth_limit_binding = args.query_depth_limit.get_inner();
        let resolver_count_limit_binding = args.resolver_count_limit.get_inner();
        let schema_binding = args.schema.get_inner();
        let tags_binding = args.tags.get_inner();
        let user_pool_config_binding = args.user_pool_config.get_inner();
        let visibility_binding = args.visibility.get_inner();
        let xray_enabled_binding = args.xray_enabled.get_inner();
