...
pub mod stack {
    ...
    pub struct StackArgs {
        ...
        #[builder(into, default)]
        pub embed_host_domains: pulumi_wasm_rust::Output<Option<Vec<String>>>,
        /// URL that users are redirected to after they click the Send Feedback link. If no URL is specified, no Send Feedback link is displayed. .
        #[builder(into, default)]
        pub feedback_url: pulumi_wasm_rust::Output<Option<String>>,
    ...
    pub fn create(name: &str, args: StackArgs) -> StackResult {
        ...
        let embed_host_domains_binding = args.embed_host_domains.get_inner();
        let feedback_url_binding = args.feedback_url.get_inner();
        let name_binding = args.name.get_inner();
        let redirect_url_binding = args.redirect_url.get_inner();
        let storage_connectors_binding = args.storage_connectors.get_inner();
