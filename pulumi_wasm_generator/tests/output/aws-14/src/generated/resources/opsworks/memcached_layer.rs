...
pub mod memcached_layer {
    ...
    pub struct MemcachedLayerArgs {
        ...
        pub allocated_memory: pulumi_wasm_rust::Output<Option<i32>>,
    ...
    pub fn create(name: &str, args: MemcachedLayerArgs) -> MemcachedLayerResult {
        use pulumi_wasm_rust::__private::pulumi_wasm_wit::client_bindings::component::pulumi_wasm::register_interface;
        use std::collections::HashMap;
        let allocated_memory_binding = args.allocated_memory.get_inner();
        ...
        let request = register_interface::RegisterResourceRequest {
            ...
            object: Vec::from([
                register_interface::ObjectField {
                    ...
                    value: &allocated_memory_binding,
                },
                register_interface::ObjectField {
        ...
        MemcachedLayerResult {
            allocated_memory: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("allocatedMemory").unwrap(),
            ),
