...
pub mod haproxy_layer {
    ...
    pub struct HaproxyLayerArgs {
        ...
        #[builder(into, default)]
        pub healthcheck_method: pulumi_wasm_rust::InputOrOutput<Option<String>>,
        /// URL path to use for instance healthchecks. Defaults to "/".
        #[builder(into, default)]
        pub healthcheck_url: pulumi_wasm_rust::InputOrOutput<Option<String>>,
        ...
        #[builder(into, default)]
        pub stats_enabled: pulumi_wasm_rust::InputOrOutput<Option<bool>>,
        /// The password to use for HAProxy stats.
        #[builder(into)]
        pub stats_password: pulumi_wasm_rust::InputOrOutput<String>,
        /// The HAProxy stats URL. Defaults to "/haproxy?stats".
        #[builder(into, default)]
        pub stats_url: pulumi_wasm_rust::InputOrOutput<Option<String>>,
        /// The username for HAProxy stats. Defaults to "opsworks".
        #[builder(into, default)]
        pub stats_user: pulumi_wasm_rust::InputOrOutput<Option<String>>,
    ...
    pub struct HaproxyLayerResult {
        ...
        /// HTTP method to use for instance healthchecks. Defaults to "OPTIONS".
        pub healthcheck_method: pulumi_wasm_rust::Output<Option<String>>,
        /// URL path to use for instance healthchecks. Defaults to "/".
        pub healthcheck_url: pulumi_wasm_rust::Output<Option<String>>,
        /// Whether to install OS and package updates on each instance when it boots.
        ...
        /// Whether to enable HAProxy stats.
        pub stats_enabled: pulumi_wasm_rust::Output<Option<bool>>,
        /// The password to use for HAProxy stats.
        pub stats_password: pulumi_wasm_rust::Output<String>,
        /// The HAProxy stats URL. Defaults to "/haproxy?stats".
        pub stats_url: pulumi_wasm_rust::Output<Option<String>>,
        /// The username for HAProxy stats. Defaults to "opsworks".
        pub stats_user: pulumi_wasm_rust::Output<Option<String>>,
        /// Names of a set of system packages to install on the layer's instances.
    ...
    pub fn create(
        ...
        let elastic_load_balancer_binding = args
            ...
            .get_output(context)
            .get_inner();
        let healthcheck_method_binding = args
            .healthcheck_method
            .get_output(context)
            .get_inner();
        let healthcheck_url_binding = args
            .healthcheck_url
            .get_output(context)
            .get_inner();
        ...
        let stats_enabled_binding = args.stats_enabled.get_output(context).get_inner();
        let stats_password_binding = args.stats_password.get_output(context).get_inner();
        let stats_url_binding = args.stats_url.get_output(context).get_inner();
        let stats_user_binding = args.stats_user.get_output(context).get_inner();
        ...
        let request = register_interface::RegisterResourceRequest {
            ...
            object: Vec::from([
                ...
                register_interface::ObjectField {
                    ...
                    value: &healthcheck_method_binding,
                },
                register_interface::ObjectField {
                    name: "healthcheckUrl".into(),
                    value: &healthcheck_url_binding,
                },
                register_interface::ObjectField {
                ...
                register_interface::ObjectField {
                    ...
                    value: &stats_enabled_binding,
                },
                register_interface::ObjectField {
                    name: "statsPassword".into(),
                    value: &stats_password_binding,
                },
                register_interface::ObjectField {
                    name: "statsUrl".into(),
                    value: &stats_url_binding,
                },
                register_interface::ObjectField {
                    name: "statsUser".into(),
                    value: &stats_user_binding,
                },
                register_interface::ObjectField {
        ...
        HaproxyLayerResult {
            ...
            healthcheck_method: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("healthcheckMethod").unwrap(),
            ),
            healthcheck_url: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("healthcheckUrl").unwrap(),
            ),
            ...
            stats_enabled: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("statsEnabled").unwrap(),
            ),
            stats_password: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("statsPassword").unwrap(),
            ),
            stats_url: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("statsUrl").unwrap(),
            ),
            stats_user: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("statsUser").unwrap(),
            ),
