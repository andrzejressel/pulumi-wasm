...
pub mod java_app_layer {
    ...
    pub fn create(name: &str, args: JavaAppLayerArgs) -> JavaAppLayerResult {
        use pulumi_wasm_rust::__private::pulumi_wasm_wit::client_bindings::component::pulumi_wasm::register_interface;
        use std::collections::HashMap;
        let app_server_binding = args.app_server.get_inner();
        let app_server_version_binding = args.app_server_version.get_inner();
        ...
        let jvm_type_binding = args.jvm_type.get_inner();
        let jvm_version_binding = args.jvm_version.get_inner();
