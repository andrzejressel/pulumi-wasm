...
pub mod java_app_layer {
    ...
    pub struct JavaAppLayerArgs {
        ...
        #[builder(into, default)]
        pub app_server_version: pulumi_wasm_rust::InputOrOutput<Option<String>>,
        ...
        #[builder(into, default)]
        pub jvm_type: pulumi_wasm_rust::InputOrOutput<Option<String>>,
        /// Version of JVM to use. Defaults to "7".
        #[builder(into, default)]
        pub jvm_version: pulumi_wasm_rust::InputOrOutput<Option<String>>,
        #[builder(into, default)]
    ...
    pub struct JavaAppLayerResult {
        ...
        /// Version of the selected application container to use. Defaults to "7".
        pub app_server_version: pulumi_wasm_rust::Output<Option<String>>,
        ...
        /// Keyword for the type of JVM to use. Defaults to `openjdk`.
        pub jvm_type: pulumi_wasm_rust::Output<Option<String>>,
        /// Version of JVM to use. Defaults to "7".
        pub jvm_version: pulumi_wasm_rust::Output<Option<String>>,
    ...
    pub fn create(
        ...
        let jvm_type_binding = args.jvm_type.get_output(context).get_inner();
        let jvm_version_binding = args.jvm_version.get_output(context).get_inner();
        ...
        JavaAppLayerResult {
            app_server: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("appServer").unwrap(),
            ),
            app_server_version: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("appServerVersion").unwrap(),
            ),
            ...
            jvm_type: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("jvmType").unwrap(),
            ),
            jvm_version: pulumi_wasm_rust::__private::into_domain(
                hashmap.remove("jvmVersion").unwrap(),
            ),
