...
pub struct AccessPolicyInclude {
    ...
    pub r#auth_contexts: Box<Option<Vec<super::types::AccessPolicyIncludeAuthContext>>>,
    ...
    #[builder(into, default)]
    #[serde(rename = "azures")]
    pub r#azures: Box<Option<Vec<super::types::AccessPolicyIncludeAzure>>>,
    ...
    pub r#githubs: Box<Option<Vec<super::types::AccessPolicyIncludeGithub>>>,
    ...
    pub r#gsuites: Box<Option<Vec<super::types::AccessPolicyIncludeGsuite>>>,
    ...
    #[builder(into, default)]
    #[serde(rename = "oktas")]
    pub r#oktas: Box<Option<Vec<super::types::AccessPolicyIncludeOkta>>>,
    /// Matches a SAML group. Requires a SAML identity provider.
    #[builder(into, default)]
    #[serde(rename = "samls")]
    pub r#samls: Box<Option<Vec<super::types::AccessPolicyIncludeSaml>>>,
