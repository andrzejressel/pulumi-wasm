...
pub struct AccessGroupExclude {
    ...
    pub r#auth_contexts: Box<Option<Vec<super::types::AccessGroupExcludeAuthContext>>>,
    ...
    #[builder(into, default)]
    #[serde(rename = "azures")]
    pub r#azures: Box<Option<Vec<super::types::AccessGroupExcludeAzure>>>,
    ...
    pub r#githubs: Box<Option<Vec<super::types::AccessGroupExcludeGithub>>>,
    ...
    pub r#gsuites: Box<Option<Vec<super::types::AccessGroupExcludeGsuite>>>,
    ...
    #[builder(into, default)]
    #[serde(rename = "oktas")]
    pub r#oktas: Box<Option<Vec<super::types::AccessGroupExcludeOkta>>>,
    /// Matches a SAML group. Requires a SAML identity provider.
    #[builder(into, default)]
    #[serde(rename = "samls")]
    pub r#samls: Box<Option<Vec<super::types::AccessGroupExcludeSaml>>>,
