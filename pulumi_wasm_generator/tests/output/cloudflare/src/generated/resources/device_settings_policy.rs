...
pub fn create(name: &str, args: DeviceSettingsPolicyArgs) -> DeviceSettingsPolicyResult {
    ...
    let request = register_interface::RegisterResourceRequest {
        ...
        results: vec![
            ...
            register_interface::ResultField { name : "allowModeSwitch".into() },
            register_interface::ResultField { name : "allowUpdates".into() },
            register_interface::ResultField { name : "allowedToLeave".into() },
            register_interface::ResultField { name : "autoConnect".into() },
            register_interface::ResultField { name : "captivePortal".into() },
            register_interface::ResultField { name : "default".into() },
            register_interface::ResultField { name : "description".into() },
            register_interface::ResultField { name : "disableAutoFallback".into() },
            register_interface::ResultField { name : "enabled".into() },
            register_interface::ResultField { name : "excludeOfficeIps".into() },
            register_interface::ResultField { name : "match".into() },
            register_interface::ResultField { name : "name".into() },
            register_interface::ResultField { name : "precedence".into() },
            register_interface::ResultField { name : "serviceModeV2Mode".into() },
            register_interface::ResultField { name : "serviceModeV2Port".into() },
            register_interface::ResultField { name : "supportUrl".into() },
            register_interface::ResultField { name : "switchLocked".into() },
            register_interface::ResultField { name : "tunnelProtocol".into() },
        ],
    };
    ...
    DeviceSettingsPolicyResult {
        ...
        allow_mode_switch: into_domain(hashmap.remove("allowModeSwitch").unwrap()),
        allow_updates: into_domain(hashmap.remove("allowUpdates").unwrap()),
        allowed_to_leave: into_domain(hashmap.remove("allowedToLeave").unwrap()),
        auto_connect: into_domain(hashmap.remove("autoConnect").unwrap()),
        captive_portal: into_domain(hashmap.remove("captivePortal").unwrap()),
        default: into_domain(hashmap.remove("default").unwrap()),
        description: into_domain(hashmap.remove("description").unwrap()),
        disable_auto_fallback: into_domain(
            hashmap.remove("disableAutoFallback").unwrap(),
        ),
        enabled: into_domain(hashmap.remove("enabled").unwrap()),
        exclude_office_ips: into_domain(hashmap.remove("excludeOfficeIps").unwrap()),
        match_: into_domain(hashmap.remove("match").unwrap()),
        name: into_domain(hashmap.remove("name").unwrap()),
        precedence: into_domain(hashmap.remove("precedence").unwrap()),
        service_mode_v2_mode: into_domain(hashmap.remove("serviceModeV2Mode").unwrap()),
        service_mode_v2_port: into_domain(hashmap.remove("serviceModeV2Port").unwrap()),
        support_url: into_domain(hashmap.remove("supportUrl").unwrap()),
        switch_locked: into_domain(hashmap.remove("switchLocked").unwrap()),
        tunnel_protocol: into_domain(hashmap.remove("tunnelProtocol").unwrap()),
    }
}
