...
pub mod logpush_job {
    ...
    pub struct LogpushJobArgs {
        ...
        #[builder(into, default)]
        pub logpull_options: pulumi_wasm_rust::InputOrOutput<Option<String>>,
        /// The maximum uncompressed file size of a batch of logs. Value must be between 5MB and 1GB.
        #[builder(into, default)]
        pub max_upload_bytes: pulumi_wasm_rust::InputOrOutput<Option<i32>>,
        /// The maximum interval in seconds for log batches. Value must be between 30 and 300.
        #[builder(into, default)]
        pub max_upload_interval_seconds: pulumi_wasm_rust::InputOrOutput<Option<i32>>,
        /// The maximum number of log lines per batch. Value must be between 1000 and 1,000,000.
        #[builder(into, default)]
        pub max_upload_records: pulumi_wasm_rust::InputOrOutput<Option<i32>>,
        ...
        #[builder(into, default)]
        pub output_options: pulumi_wasm_rust::InputOrOutput<
        ...
        #[builder(into, default)]
        pub ownership_challenge: pulumi_wasm_rust::InputOrOutput<Option<String>>,
