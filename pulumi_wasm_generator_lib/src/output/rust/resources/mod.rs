...
mod source_code_resource_mod;

use crate::output::rust::resources::source_code_resource_code::generate_single_resource_source_code;
use crate::output::rust::resources::source_code_resource_mod::generate_mod;
...
pub(crate) fn generate_resources_code(
    ...
    let root = result_path.join("src").join("resource");
...
fn generate_files(
    ...
    match tree_node {
        ...
        TreeNode::Leaf(ref leaf) => {
            ...
            let content = generate_single_resource_source_code(package, leaf);
