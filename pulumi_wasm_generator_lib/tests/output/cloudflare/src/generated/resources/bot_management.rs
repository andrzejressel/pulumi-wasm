...
pub fn create(name: &str, args: BotManagementArgs) -> BotManagementResult {
    ...
    let sbfm_definitely_automated_binding = args.sbfm_definitely_automated.get_inner();
    ...
    let request = register_interface::RegisterResourceRequest {
        ...
        results: vec![
            register_interface::ResultField { name : "aiBotsProtection".into() },
            register_interface::ResultField { name : "autoUpdateModel".into() },
            register_interface::ResultField { name : "enableJs".into() },
            register_interface::ResultField { name : "fightMode".into() },
            register_interface::ResultField { name : "optimizeWordpress".into() },
            register_interface::ResultField { name : "sbfmDefinitelyAutomated".into() },
            register_interface::ResultField { name : "sbfmLikelyAutomated".into() },
            register_interface::ResultField { name : "sbfmStaticResourceProtection"
            .into() }, register_interface::ResultField { name : "sbfmVerifiedBots".into()
            }, register_interface::ResultField { name : "suppressSessionScore".into() },
            register_interface::ResultField { name : "usingLatestModel".into() },
    ...
    let mut hashmap: HashMap<String, _> = o
        ...
        .collect();
    BotManagementResult {
        ai_bots_protection: into_domain(hashmap.remove("aiBotsProtection").unwrap()),
        auto_update_model: into_domain(hashmap.remove("autoUpdateModel").unwrap()),
        enable_js: into_domain(hashmap.remove("enableJs").unwrap()),
        fight_mode: into_domain(hashmap.remove("fightMode").unwrap()),
        optimize_wordpress: into_domain(hashmap.remove("optimizeWordpress").unwrap()),
        sbfm_definitely_automated: into_domain(
            hashmap.remove("sbfmDefinitelyAutomated").unwrap(),
        ),
        sbfm_likely_automated: into_domain(
            hashmap.remove("sbfmLikelyAutomated").unwrap(),
        ),
        sbfm_static_resource_protection: into_domain(
            hashmap.remove("sbfmStaticResourceProtection").unwrap(),
        ),
        sbfm_verified_bots: into_domain(hashmap.remove("sbfmVerifiedBots").unwrap()),
        suppress_session_score: into_domain(
            hashmap.remove("suppressSessionScore").unwrap(),
        ),
        using_latest_model: into_domain(hashmap.remove("usingLatestModel").unwrap()),
