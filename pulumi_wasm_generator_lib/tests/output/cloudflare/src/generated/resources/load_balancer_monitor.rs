...
pub fn create(name: &str, args: LoadBalancerMonitorArgs) -> LoadBalancerMonitorResult {
    ...
    let request = register_interface::RegisterResourceRequest {
        ...
        results: vec![
            ...
            register_interface::ResultField { name : "consecutiveDown".into() },
            register_interface::ResultField { name : "consecutiveUp".into() },
            ...
            register_interface::ResultField { name : "probeZone".into() },
    ...
    LoadBalancerMonitorResult {
        ...
        consecutive_down: into_domain(hashmap.remove("consecutiveDown").unwrap()),
        consecutive_up: into_domain(hashmap.remove("consecutiveUp").unwrap()),
        ...
        probe_zone: into_domain(hashmap.remove("probeZone").unwrap()),
