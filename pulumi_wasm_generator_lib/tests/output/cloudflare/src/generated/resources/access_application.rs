...
pub fn create(name: &str, args: AccessApplicationArgs) -> AccessApplicationResult {
    ...
    let auto_redirect_to_identity_binding = args.auto_redirect_to_identity.get_inner();
    ...
    let http_only_cookie_attribute_binding = args.http_only_cookie_attribute.get_inner();
    ...
    let same_site_cookie_attribute_binding = args.same_site_cookie_attribute.get_inner();
    ...
    let request = register_interface::RegisterResourceRequest {
        ...
        results: vec![
            ...
            register_interface::ResultField { name : "allowAuthenticateViaWarp".into() },
            register_interface::ResultField { name : "allowedIdps".into() },
            register_interface::ResultField { name : "appLauncherLogoUrl".into() },
            register_interface::ResultField { name : "appLauncherVisible".into() },
            register_interface::ResultField { name : "aud".into() },
            register_interface::ResultField { name : "autoRedirectToIdentity".into() },
            register_interface::ResultField { name : "bgColor".into() },
            register_interface::ResultField { name : "corsHeaders".into() },
            register_interface::ResultField { name : "customDenyMessage".into() },
            register_interface::ResultField { name : "customDenyUrl".into() },
            register_interface::ResultField { name : "customNonIdentityDenyUrl".into() },
            register_interface::ResultField { name : "customPages".into() },
            register_interface::ResultField { name : "domain".into() },
            register_interface::ResultField { name : "enableBindingCookie".into() },
            register_interface::ResultField { name : "footerLinks".into() },
            register_interface::ResultField { name : "headerBgColor".into() },
            register_interface::ResultField { name : "httpOnlyCookieAttribute".into() },
            register_interface::ResultField { name : "landingPageDesign".into() },
            register_interface::ResultField { name : "logoUrl".into() },
            register_interface::ResultField { name : "name".into() },
            register_interface::ResultField { name : "optionsPreflightBypass".into() },
            register_interface::ResultField { name : "policies".into() },
            register_interface::ResultField { name : "saasApp".into() },
            register_interface::ResultField { name : "sameSiteCookieAttribute".into() },
            register_interface::ResultField { name : "scimConfig".into() },
            register_interface::ResultField { name : "selfHostedDomains".into() },
            register_interface::ResultField { name : "serviceAuth401Redirect".into() },
            register_interface::ResultField { name : "sessionDuration".into() },
            register_interface::ResultField { name : "skipAppLauncherLoginPage".into() },
            register_interface::ResultField { name : "skipInterstitial".into() },
            register_interface::ResultField { name : "tags".into() },
            register_interface::ResultField { name : "targetCriterias".into() },
    ...
    AccessApplicationResult {
        ...
        allow_authenticate_via_warp: into_domain(
            hashmap.remove("allowAuthenticateViaWarp").unwrap(),
        ),
        allowed_idps: into_domain(hashmap.remove("allowedIdps").unwrap()),
        app_launcher_logo_url: into_domain(
            hashmap.remove("appLauncherLogoUrl").unwrap(),
        ),
        app_launcher_visible: into_domain(hashmap.remove("appLauncherVisible").unwrap()),
        aud: into_domain(hashmap.remove("aud").unwrap()),
        auto_redirect_to_identity: into_domain(
            hashmap.remove("autoRedirectToIdentity").unwrap(),
        ),
        bg_color: into_domain(hashmap.remove("bgColor").unwrap()),
        cors_headers: into_domain(hashmap.remove("corsHeaders").unwrap()),
        custom_deny_message: into_domain(hashmap.remove("customDenyMessage").unwrap()),
        custom_deny_url: into_domain(hashmap.remove("customDenyUrl").unwrap()),
        custom_non_identity_deny_url: into_domain(
            hashmap.remove("customNonIdentityDenyUrl").unwrap(),
        ),
        custom_pages: into_domain(hashmap.remove("customPages").unwrap()),
        domain: into_domain(hashmap.remove("domain").unwrap()),
        enable_binding_cookie: into_domain(
            hashmap.remove("enableBindingCookie").unwrap(),
        ),
        footer_links: into_domain(hashmap.remove("footerLinks").unwrap()),
        header_bg_color: into_domain(hashmap.remove("headerBgColor").unwrap()),
        http_only_cookie_attribute: into_domain(
            hashmap.remove("httpOnlyCookieAttribute").unwrap(),
        ),
        landing_page_design: into_domain(hashmap.remove("landingPageDesign").unwrap()),
        logo_url: into_domain(hashmap.remove("logoUrl").unwrap()),
        name: into_domain(hashmap.remove("name").unwrap()),
        options_preflight_bypass: into_domain(
            hashmap.remove("optionsPreflightBypass").unwrap(),
        ),
        policies: into_domain(hashmap.remove("policies").unwrap()),
        saas_app: into_domain(hashmap.remove("saasApp").unwrap()),
        same_site_cookie_attribute: into_domain(
            hashmap.remove("sameSiteCookieAttribute").unwrap(),
        ),
        scim_config: into_domain(hashmap.remove("scimConfig").unwrap()),
        self_hosted_domains: into_domain(hashmap.remove("selfHostedDomains").unwrap()),
        service_auth401_redirect: into_domain(
            hashmap.remove("serviceAuth401Redirect").unwrap(),
        ),
        session_duration: into_domain(hashmap.remove("sessionDuration").unwrap()),
        skip_app_launcher_login_page: into_domain(
            hashmap.remove("skipAppLauncherLoginPage").unwrap(),
        ),
        skip_interstitial: into_domain(hashmap.remove("skipInterstitial").unwrap()),
        tags: into_domain(hashmap.remove("tags").unwrap()),
        target_criterias: into_domain(hashmap.remove("targetCriterias").unwrap()),
