...
pub fn create(
    ...
    let request = register_interface::RegisterResourceRequest {
        ...
        results: vec![
            ...
            register_interface::ResultField { name : "active".into() },
            register_interface::ResultField { name : "integrationType".into() },
            register_interface::ResultField { name : "referenceId".into() },
            register_interface::ResultField { name : "tenantUrl".into() },
            register_interface::ResultField { name : "wellKnownUrl".into() },
        ],
    };
    ...
    ZeroTrustRiskScoreIntegrationResult {
        ...
        active: into_domain(hashmap.remove("active").unwrap()),
        integration_type: into_domain(hashmap.remove("integrationType").unwrap()),
        reference_id: into_domain(hashmap.remove("referenceId").unwrap()),
        tenant_url: into_domain(hashmap.remove("tenantUrl").unwrap()),
        well_known_url: into_domain(hashmap.remove("wellKnownUrl").unwrap()),
    }
}
