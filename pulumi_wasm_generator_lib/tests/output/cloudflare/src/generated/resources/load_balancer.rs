...
pub fn create(name: &str, args: LoadBalancerArgs) -> LoadBalancerResult {
    ...
    let request = register_interface::RegisterResourceRequest {
        ...
        results: vec![
            register_interface::ResultField { name : "adaptiveRoutings".into() },
            register_interface::ResultField { name : "countryPools".into() },
            register_interface::ResultField { name : "createdOn".into() },
            register_interface::ResultField { name : "defaultPoolIds".into() },
            register_interface::ResultField { name : "description".into() },
            register_interface::ResultField { name : "enabled".into() },
            register_interface::ResultField { name : "fallbackPoolId".into() },
            register_interface::ResultField { name : "locationStrategies".into() },
            register_interface::ResultField { name : "modifiedOn".into() },
            register_interface::ResultField { name : "name".into() },
            register_interface::ResultField { name : "popPools".into() },
            register_interface::ResultField { name : "proxied".into() },
            register_interface::ResultField { name : "randomSteerings".into() },
            register_interface::ResultField { name : "regionPools".into() },
            register_interface::ResultField { name : "rules".into() },
            register_interface::ResultField { name : "sessionAffinity".into() },
            register_interface::ResultField { name : "sessionAffinityAttributes".into()
            }, register_interface::ResultField { name : "sessionAffinityTtl".into() },
            register_interface::ResultField { name : "steeringPolicy".into() },
    ...
    let mut hashmap: HashMap<String, _> = o
        ...
        .collect();
    LoadBalancerResult {
        adaptive_routings: into_domain(hashmap.remove("adaptiveRoutings").unwrap()),
        country_pools: into_domain(hashmap.remove("countryPools").unwrap()),
        created_on: into_domain(hashmap.remove("createdOn").unwrap()),
        default_pool_ids: into_domain(hashmap.remove("defaultPoolIds").unwrap()),
        description: into_domain(hashmap.remove("description").unwrap()),
        enabled: into_domain(hashmap.remove("enabled").unwrap()),
        fallback_pool_id: into_domain(hashmap.remove("fallbackPoolId").unwrap()),
        location_strategies: into_domain(hashmap.remove("locationStrategies").unwrap()),
        modified_on: into_domain(hashmap.remove("modifiedOn").unwrap()),
        name: into_domain(hashmap.remove("name").unwrap()),
        pop_pools: into_domain(hashmap.remove("popPools").unwrap()),
        proxied: into_domain(hashmap.remove("proxied").unwrap()),
        random_steerings: into_domain(hashmap.remove("randomSteerings").unwrap()),
        region_pools: into_domain(hashmap.remove("regionPools").unwrap()),
        rules: into_domain(hashmap.remove("rules").unwrap()),
        session_affinity: into_domain(hashmap.remove("sessionAffinity").unwrap()),
        session_affinity_attributes: into_domain(
            hashmap.remove("sessionAffinityAttributes").unwrap(),
        ),
        session_affinity_ttl: into_domain(hashmap.remove("sessionAffinityTtl").unwrap()),
        steering_policy: into_domain(hashmap.remove("steeringPolicy").unwrap()),
