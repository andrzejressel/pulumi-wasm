...
pub fn create(name: &str, args: AccessOrganizationArgs) -> AccessOrganizationResult {
    ...
    let ui_read_only_toggle_reason_binding = args.ui_read_only_toggle_reason.get_inner();
    let user_seat_expiration_inactive_time_binding = args
        .user_seat_expiration_inactive_time
        .get_inner();
    let warp_auth_session_duration_binding = args.warp_auth_session_duration.get_inner();
    ...
    let request = register_interface::RegisterResourceRequest {
        ...
        results: vec![
            ...
            register_interface::ResultField { name : "authDomain".into() },
            register_interface::ResultField { name : "autoRedirectToIdentity".into() },
            register_interface::ResultField { name : "customPages".into() },
            register_interface::ResultField { name : "isUiReadOnly".into() },
            register_interface::ResultField { name : "loginDesigns".into() },
            register_interface::ResultField { name : "name".into() },
            register_interface::ResultField { name : "sessionDuration".into() },
            register_interface::ResultField { name : "uiReadOnlyToggleReason".into() },
            register_interface::ResultField { name : "userSeatExpirationInactiveTime"
            .into() }, register_interface::ResultField { name : "warpAuthSessionDuration"
            .into() }, register_interface::ResultField { name : "zoneId".into() },
        ],
    };
    ...
    AccessOrganizationResult {
        ...
        auth_domain: into_domain(hashmap.remove("authDomain").unwrap()),
        ...
        is_ui_read_only: into_domain(hashmap.remove("isUiReadOnly").unwrap()),
        login_designs: into_domain(hashmap.remove("loginDesigns").unwrap()),
        name: into_domain(hashmap.remove("name").unwrap()),
        session_duration: into_domain(hashmap.remove("sessionDuration").unwrap()),
        ui_read_only_toggle_reason: into_domain(
            hashmap.remove("uiReadOnlyToggleReason").unwrap(),
        ),
        user_seat_expiration_inactive_time: into_domain(
            hashmap.remove("userSeatExpirationInactiveTime").unwrap(),
        ),
        warp_auth_session_duration: into_domain(
