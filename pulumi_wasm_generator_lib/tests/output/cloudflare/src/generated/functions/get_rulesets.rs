...
pub struct GetRulesetsArgs {
    ...
    #[builder(into, default)]
    pub filter: pulumi_wasm_rust::Output<Option<super::super::types::GetRulesetsFilter>>,
...
pub struct GetRulesetsResult {
    ...
    /// Include rule data in response.
    pub include_rules: pulumi_wasm_rust::Output<Option<bool>>,
    pub rulesets: pulumi_wasm_rust::Output<Vec<super::super::types::GetRulesetsRuleset>>,
    /// The zone identifier to target for the resource. Must provide only one of `zone_id`, `account_id`.
    pub zone_id: pulumi_wasm_rust::Output<Option<String>>,
}
///
...
pub fn invoke(args: GetRulesetsArgs) -> GetRulesetsResult {
    ...
    let request = register_interface::ResourceInvokeRequest {
        ...
        results: vec![
            ...
            register_interface::ResultField { name : "includeRules".into() },
            register_interface::ResultField { name : "rulesets".into() },
    ...
    GetRulesetsResult {
        ...
        include_rules: into_domain(hashmap.remove("includeRules").unwrap()),
        rulesets: into_domain(hashmap.remove("rulesets").unwrap()),
