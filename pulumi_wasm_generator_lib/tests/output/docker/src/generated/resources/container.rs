...
pub struct ContainerArgs {
    ...
    #[builder(into, default)]
    pub devices: pulumi_wasm_rust::Output<Option<Vec<super::types::ContainerDevice>>>,
    /// DNS servers to use.
    #[builder(into, default)]
    ...
    #[builder(into, default)]
    pub ulimits: pulumi_wasm_rust::Output<Option<Vec<super::types::ContainerUlimit>>>,
    ...
    #[builder(into, default)]
    pub uploads: pulumi_wasm_rust::Output<Option<Vec<super::types::ContainerUpload>>>,
    ...
    #[builder(into, default)]
    pub volumes: pulumi_wasm_rust::Output<Option<Vec<super::types::ContainerVolume>>>,
...
pub struct ContainerResult {
    ...
    pub network_datas: pulumi_wasm_rust::Output<Vec<super::types::ContainerNetworkData>>,
    /// Network mode of the container.
    pub network_mode: pulumi_wasm_rust::Output<Option<String>>,
    /// The networks the container is attached to
    pub networks_advanced: pulumi_wasm_rust::Output<
...
pub fn create(name: &str, args: ContainerArgs) -> ContainerResult {
    ...
    let request = register_interface::RegisterResourceRequest {
        ...
        results: vec![
            register_interface::ResultField { name : "attach".into() },
            register_interface::ResultField { name : "bridge".into() },
            register_interface::ResultField { name : "capabilities".into() },
            register_interface::ResultField { name : "cgroupnsMode".into() },
            register_interface::ResultField { name : "command".into() },
            register_interface::ResultField { name : "containerLogs".into() },
            register_interface::ResultField { name :
            "containerReadRefreshTimeoutMilliseconds".into() },
            register_interface::ResultField { name : "cpuSet".into() },
            register_interface::ResultField { name : "cpuShares".into() },
            register_interface::ResultField { name : "destroyGraceSeconds".into() },
            register_interface::ResultField { name : "devices".into() },
            register_interface::ResultField { name : "dns".into() },
            register_interface::ResultField { name : "dnsOpts".into() },
            register_interface::ResultField { name : "dnsSearches".into() },
            register_interface::ResultField { name : "domainname".into() },
            register_interface::ResultField { name : "entrypoints".into() },
            register_interface::ResultField { name : "envs".into() },
            register_interface::ResultField { name : "exitCode".into() },
            register_interface::ResultField { name : "gpus".into() },
            register_interface::ResultField { name : "groupAdds".into() },
            register_interface::ResultField { name : "healthcheck".into() },
            register_interface::ResultField { name : "hostname".into() },
            register_interface::ResultField { name : "hosts".into() },
            register_interface::ResultField { name : "image".into() },
            register_interface::ResultField { name : "init".into() },
            register_interface::ResultField { name : "ipcMode".into() },
            register_interface::ResultField { name : "labels".into() },
            register_interface::ResultField { name : "logDriver".into() },
            register_interface::ResultField { name : "logOpts".into() },
            register_interface::ResultField { name : "logs".into() },
            register_interface::ResultField { name : "maxRetryCount".into() },
            register_interface::ResultField { name : "memory".into() },
            register_interface::ResultField { name : "memorySwap".into() },
            register_interface::ResultField { name : "mounts".into() },
            register_interface::ResultField { name : "mustRun".into() },
            register_interface::ResultField { name : "name".into() },
            register_interface::ResultField { name : "networkDatas".into() },
            register_interface::ResultField { name : "networkMode".into() },
            register_interface::ResultField { name : "networksAdvanced".into() },
            register_interface::ResultField { name : "pidMode".into() },
            register_interface::ResultField { name : "ports".into() },
            register_interface::ResultField { name : "privileged".into() },
            register_interface::ResultField { name : "publishAllPorts".into() },
            register_interface::ResultField { name : "readOnly".into() },
            register_interface::ResultField { name : "removeVolumes".into() },
            register_interface::ResultField { name : "restart".into() },
            register_interface::ResultField { name : "rm".into() },
            register_interface::ResultField { name : "runtime".into() },
            register_interface::ResultField { name : "securityOpts".into() },
            register_interface::ResultField { name : "shmSize".into() },
            register_interface::ResultField { name : "start".into() },
            register_interface::ResultField { name : "stdinOpen".into() },
            register_interface::ResultField { name : "stopSignal".into() },
            register_interface::ResultField { name : "stopTimeout".into() },
            register_interface::ResultField { name : "storageOpts".into() },
            register_interface::ResultField { name : "sysctls".into() },
            register_interface::ResultField { name : "tmpfs".into() },
            register_interface::ResultField { name : "tty".into() },
            register_interface::ResultField { name : "ulimits".into() },
            register_interface::ResultField { name : "uploads".into() },
            register_interface::ResultField { name : "user".into() },
            register_interface::ResultField { name : "usernsMode".into() },
            register_interface::ResultField { name : "volumes".into() },
            register_interface::ResultField { name : "wait".into() },
            register_interface::ResultField { name : "waitTimeout".into() },
            register_interface::ResultField { name : "workingDir".into() },
        ],
    };
    ...
    let mut hashmap: HashMap<String, _> = o
        ...
        .collect();
    ContainerResult {
        attach: into_domain(hashmap.remove("attach").unwrap()),
        bridge: into_domain(hashmap.remove("bridge").unwrap()),
        capabilities: into_domain(hashmap.remove("capabilities").unwrap()),
        cgroupns_mode: into_domain(hashmap.remove("cgroupnsMode").unwrap()),
        command: into_domain(hashmap.remove("command").unwrap()),
        container_logs: into_domain(hashmap.remove("containerLogs").unwrap()),
        container_read_refresh_timeout_milliseconds: into_domain(
            hashmap.remove("containerReadRefreshTimeoutMilliseconds").unwrap(),
        ),
        cpu_set: into_domain(hashmap.remove("cpuSet").unwrap()),
        cpu_shares: into_domain(hashmap.remove("cpuShares").unwrap()),
        destroy_grace_seconds: into_domain(
        ...
        dns_opts: into_domain(hashmap.remove("dnsOpts").unwrap()),
        dns_searches: into_domain(hashmap.remove("dnsSearches").unwrap()),
        domainname: into_domain(hashmap.remove("domainname").unwrap()),
        entrypoints: into_domain(hashmap.remove("entrypoints").unwrap()),
        envs: into_domain(hashmap.remove("envs").unwrap()),
        exit_code: into_domain(hashmap.remove("exitCode").unwrap()),
        gpus: into_domain(hashmap.remove("gpus").unwrap()),
        group_adds: into_domain(hashmap.remove("groupAdds").unwrap()),
        healthcheck: into_domain(hashmap.remove("healthcheck").unwrap()),
        hostname: into_domain(hashmap.remove("hostname").unwrap()),
        hosts: into_domain(hashmap.remove("hosts").unwrap()),
        image: into_domain(hashmap.remove("image").unwrap()),
        init: into_domain(hashmap.remove("init").unwrap()),
        ipc_mode: into_domain(hashmap.remove("ipcMode").unwrap()),
        labels: into_domain(hashmap.remove("labels").unwrap()),
        log_driver: into_domain(hashmap.remove("logDriver").unwrap()),
        log_opts: into_domain(hashmap.remove("logOpts").unwrap()),
        logs: into_domain(hashmap.remove("logs").unwrap()),
        max_retry_count: into_domain(hashmap.remove("maxRetryCount").unwrap()),
        memory: into_domain(hashmap.remove("memory").unwrap()),
        memory_swap: into_domain(hashmap.remove("memorySwap").unwrap()),
        mounts: into_domain(hashmap.remove("mounts").unwrap()),
        must_run: into_domain(hashmap.remove("mustRun").unwrap()),
        name: into_domain(hashmap.remove("name").unwrap()),
        network_datas: into_domain(hashmap.remove("networkDatas").unwrap()),
        network_mode: into_domain(hashmap.remove("networkMode").unwrap()),
        networks_advanced: into_domain(hashmap.remove("networksAdvanced").unwrap()),
        pid_mode: into_domain(hashmap.remove("pidMode").unwrap()),
        ports: into_domain(hashmap.remove("ports").unwrap()),
        privileged: into_domain(hashmap.remove("privileged").unwrap()),
        publish_all_ports: into_domain(hashmap.remove("publishAllPorts").unwrap()),
        read_only: into_domain(hashmap.remove("readOnly").unwrap()),
        remove_volumes: into_domain(hashmap.remove("removeVolumes").unwrap()),
        restart: into_domain(hashmap.remove("restart").unwrap()),
        rm: into_domain(hashmap.remove("rm").unwrap()),
        runtime: into_domain(hashmap.remove("runtime").unwrap()),
        security_opts: into_domain(hashmap.remove("securityOpts").unwrap()),
        shm_size: into_domain(hashmap.remove("shmSize").unwrap()),
        start: into_domain(hashmap.remove("start").unwrap()),
        stdin_open: into_domain(hashmap.remove("stdinOpen").unwrap()),
        stop_signal: into_domain(hashmap.remove("stopSignal").unwrap()),
        stop_timeout: into_domain(hashmap.remove("stopTimeout").unwrap()),
        storage_opts: into_domain(hashmap.remove("storageOpts").unwrap()),
        sysctls: into_domain(hashmap.remove("sysctls").unwrap()),
        tmpfs: into_domain(hashmap.remove("tmpfs").unwrap()),
        tty: into_domain(hashmap.remove("tty").unwrap()),
        ulimits: into_domain(hashmap.remove("ulimits").unwrap()),
        uploads: into_domain(hashmap.remove("uploads").unwrap()),
        user: into_domain(hashmap.remove("user").unwrap()),
        userns_mode: into_domain(hashmap.remove("usernsMode").unwrap()),
        volumes: into_domain(hashmap.remove("volumes").unwrap()),
        wait: into_domain(hashmap.remove("wait").unwrap()),
        wait_timeout: into_domain(hashmap.remove("waitTimeout").unwrap()),
        working_dir: into_domain(hashmap.remove("workingDir").unwrap()),
    }
}
