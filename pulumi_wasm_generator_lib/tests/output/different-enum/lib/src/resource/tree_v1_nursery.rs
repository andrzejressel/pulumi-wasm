...
pub struct NurseryArgs {
    ...
    pub sizes: pulumi_wasm_rust::Output<Option<std::collections::HashMap<String, crate::types::tree::v1::TreeSize>>>,
    /// The varieties available
    #[builder(into)]
    pub varieties: pulumi_wasm_rust::Output<Vec<crate::types::tree::v1::RubberTreeVariety>>,
}
