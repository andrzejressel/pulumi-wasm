...
use crate::bindings::exports::pulumi::mypkg::func_with_dict_param;
use crate::bindings::component::pulumi_wasm::register_interface::{ObjectField, invoke, ResourceInvokeRequest, ResultField};
use crate::Component;

impl func_with_dict_param::Guest for Component {
    fn invoke(
        args: func_with_dict_param::Args
    ) -> func_with_dict_param::Res {
